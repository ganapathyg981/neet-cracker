...
export const gravitationTopics = [
      {
        ...
        formulas: [
          {
            ...
            variables: [
              ...
              },
              {
                ...
                unit: "N·m²/kg²",
                typical_values: "6.67 × 10⁻¹¹"
              },
              {
                symbol: "m₁, m₂",
                meaning: "Masses",
                unit: "kg",
                typical_values: "kg to 10³⁰ kg"
              },
              {
                symbol: "r",
                meaning: "Distance between centers",
                unit: "m",
                typical_values: "m to 10¹¹ m"
              }
            ],
            derivedFrom: null,
            applications: [],
            specialCases: ["Force on surface: F = mg where g = GM/R²", "Inverse square: double distance → 1/4 force"],
          ...
          },
          {
            ...
            variables: [
              ...
              },
              {
                ...
                meaning: "Source mass",
                unit: "kg",
                typical_values: "Planetary masses"
              },
              {
                symbol: "r",
                meaning: "Distance from center",
                unit: "m",
                typical_values: "Radius or more"
              }
            ],
            derivedFrom: "gravitational-force",
            applications: [],
            specialCases: ["g ∝ 1/r² outside Earth", "g ∝ r inside uniform Earth"],
            dimensionalCheck: "[g] = m/s²",
          },
          {
            id: "weight-at-surface",
            name: "Weight at surface",
            category: "derived",
            formula: "W = \\frac{GMm}{R^2} = mg",
            latex: "W = \\frac{GMm}{R^2} = mg",
            description: "M is Earth mass, R is radius",
            variables: [],
            derivedFrom: "gravitational-force",
            applications: [],
            specialCases: [],
          ...
          {
            id: "force-on-satellite",
            name: "Force on satellite",
            category: "derived",
            formula: "F = \\frac{GMm}{(R+h)^2}",
            latex: "F = \\frac{GMm}{(R+h)^2}",
            description: "At height h above surface",
            variables: [],
            derivedFrom: "gravitational-force",
            applications: [],
            specialCases: [],
          ...
          {
            id: "at-earth-surface",
            name: "At Earth surface",
            category: "derived",
            formula: "g_0 = \\frac{GM}{R^2} \\approx 9.8 m/s^2",
            latex: "g_0 = \\frac{GM}{R^2} \\approx 9.8 m/s^2",
          ...
          },
          {
            ...
            name: "At height h",
            category: "derived",
            formula: "g_h = \\frac{GM}{(R+h)^2} = g_0\\left(\\frac{R}{R+h}\\right)^2",
            latex: "g_h = \\frac{GM}{(R+h)^2} = g_0\\left(\\frac{R}{R+h}\\right)^2",
            description: "Decreases with height",
            variables: [],
            derivedFrom: "gravitational-field",
            applications: [],
            specialCases: [],
        ...
        variations: [
          ...
          {
            type: "numerical",
            description: "g at different distances",
            difficulty: "medium"
          },
          {
            type: "conceptual",
            description: "Effect of mass/distance on force",
            difficulty: "easy"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "Gravitational force calculation",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
      ...
      },
      {
        ...
        formulas: [
          {
            ...
            variables: [
              {
                symbol: "g_h",
                meaning: "g at height h",
                unit: "m/s²",
                typical_values: "Less than g₀"
              },
              {
                symbol: "g₀",
                meaning: "g at surface",
                unit: "m/s²",
                typical_values: "9.8 m/s²"
              },
              {
                symbol: "R",
                meaning: "Earth radius",
                unit: "m",
                typical_values: "6.4 × 10⁶ m"
              },
              {
                symbol: "h",
                meaning: "Height above surface",
                unit: "m",
                typical_values: "km to 1000s km"
              }
            ],
            derivedFrom: "gravitational-field",
            applications: [],
            specialCases: ["g decreases with height", "At infinite height: g → 0"],
            dimensionalCheck: "[g] = m/s²",
          },
          {
            id: "g-at-depth",
            ...
            derivedFrom: "gravitational-field",
            applications: [],
            specialCases: ["Linear decrease with depth", "Assumes uniform density Earth"],
            dimensionalCheck: "[g] = m/s²",
          },
          {
            id: "g-latitude",
            ...
            variables: [
              {
                ...
                meaning: "Latitude",
                unit: "degrees",
                typical_values: "0° (equator) to 90° (pole)"
              },
              {
                symbol: "ω",
                meaning: "Angular velocity of Earth",
                unit: "rad/s",
                typical_values: "7.3 × 10⁻⁵ rad/s"
              }
            ],
            derivedFrom: null,
            applications: [],
            specialCases: ["Equator: g minimum", "Poles: g maximum", "Difference ≈ 0.034 m/s²"],
            dimensionalCheck: "[g'] = m/s²",
          },
          {
            id: "approximate-h-r",
            name: "Approximate (h << R)",
            category: "derived",
            formula: "g_h \\approx g_0\\left(1 - \\frac{2h}{R}\\right)",
            latex: "g_h \\approx g_0\\left(1 - \\frac{2h}{R}\\right)",
            description: "Linear approximation",
            variables: [],
            derivedFrom: "g-at-height",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[g] = m/s²",
            neet_frequency: "high",
          },
          {
            ...
            name: "At h = R",
            category: "derived",
            formula: "g_h = \\frac{g_0}{4}",
            latex: "g_h = \\frac{g_0}{4}",
            description: "Height equals radius",
            variables: [],
            derivedFrom: "g-at-height",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "At center",
            category: "derived",
            formula: "g = 0 \\text{ (at } d = R\\text{)}",
            latex: "g = 0 \\text{ (at } d = R\\text{)}",
            description: "No gravity at Earth center",
            variables: [],
            derivedFrom: "g-at-depth",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[g] = m/s²",
            neet_frequency: "high",
          },
          {
            ...
            name: "At half depth",
            category: "derived",
            formula: "g_{R/2} = \\frac{g_0}{2}",
            latex: "g_{R/2} = \\frac{g_0}{2}",
            description: "d = R/2",
            variables: [],
            derivedFrom: "g-at-depth",
            applications: [],
          ...
          },
          {
            ...
            name: "At equator",
            category: "derived",
            formula: "g' = g - R\\omega^2",
            latex: "g' = g - R\\omega^2",
            description: "φ = 0, maximum reduction",
            variables: [],
            derivedFrom: "g-latitude",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[g'] = m/s²",
            neet_frequency: "high",
          },
          {
            ...
            formula: "g' = g",
            latex: "g' = g",
            description: "φ = 90°, no centrifugal effect",
            variables: [],
            derivedFrom: "g-latitude",
            applications: [],
            specialCases: [],
        ...
        variations: [
          {
            type: "numerical",
            description: "g at given height",
            difficulty: "medium"
          },
          {
            type: "numerical",
            description: "g at given depth",
            difficulty: "medium"
          },
          {
            type: "numerical",
            description: "Compare height and depth effects",
            difficulty: "hard"
          },
          {
            type: "conceptual",
            description: "Effect of rotation on g",
            difficulty: "medium"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "g at height problems",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "Height-depth comparison",
            frequency: "medium",
      ...
      },
      {
        ...
        formulas: [
            ...
            variables: [
              {
                ...
                unit: "m/s",
                typical_values: "11.2 km/s for Earth"
              },
              {
                symbol: "M",
                meaning: "Mass of planet",
                unit: "kg",
                typical_values: "5.97 × 10²⁴ kg (Earth)"
              },
              {
                symbol: "R",
                meaning: "Radius of planet",
                unit: "m",
                typical_values: "6.4 × 10⁶ m (Earth)"
              }
            ],
            derivedFrom: "gravitational-potential-energy",
            applications: [],
            specialCases: ["v_e ∝ √M, v_e ∝ 1/√R", "Independent of mass of escaping body"],
          ...
          },
          {
            ...
            latex: "v_e = \\sqrt{2gR}",
            description: "Using g = GM/R²",
            variables: [],
            derivedFrom: "escape-velocity",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[v] = √([G][M]/[R]) = √((N·m²/kg²)(kg)/m) = m/s",
            neet_frequency: "high",
          },
          {
            ...
            name: "From height h",
            category: "derived",
            formula: "v_e = \\sqrt{\\frac{2GM}{R+h}}",
            latex: "v_e = \\sqrt{\\frac{2GM}{R+h}}",
            description: "At height h above surface",
            variables: [],
            derivedFrom: "escape-velocity",
            applications: [],
          ...
          {
            id: "relation-to-orbital",
            name: "Relation to orbital",
            category: "derived",
            formula: "v_e = \\sqrt{2} \\times v_{orbital}",
            latex: "v_e = \\sqrt{2} \\times v_{orbital}",
            description: "v_e is √2 times orbital velocity",
            variables: [],
            derivedFrom: "escape-velocity",
            applications: [],
            specialCases: [],
        ...
        variations: [
          ...
          {
            type: "numerical",
            description: "v_e from different heights",
            difficulty: "medium"
          },
          {
            type: "numerical",
            description: "Compare v_e for different planets",
            difficulty: "medium"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "Escape velocity calculation",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "v_e and v_orbital relation",
            frequency: "high",
      ...
      },
      {
        ...
        formulas: [
            ...
            variables: [
              {
                ...
                unit: "J",
                typical_values: "Negative values"
              },
              {
                symbol: "G",
              ...
              {
                symbol: "M",
                meaning: "Source mass (planet)",
                unit: "kg",
                typical_values: "5.97 × 10²⁴ kg"
              },
              {
                symbol: "m",
                meaning: "Object mass",
              ...
              },
              {
                ...
                meaning: "Distance from center",
                unit: "m",
                typical_values: "R or more"
              }
            ],
            derivedFrom: null,
            applications: [],
            specialCases: ["Negative sign: system is bound (needs energy to escape)", "U → 0 as r → ∞"],
          ...
          },
          {
            ...
            applications: [],
            specialCases: ["V is scalar (no direction)", "V = U/m (potential energy per unit mass)"],
            ...
            variables: [
              {
                ...
                unit: "J",
                typical_values: "Positive value"
              }
            ],
            derivedFrom: "gpe-formula",
            applications: [],
            specialCases: ["BE = |U| for object at rest", "BE = |E_total| for orbiting satellite"],
          ...
          },
          {
            ...
            name: "Change in PE",
            category: "derived",
            formula: "\\Delta U = GMm\\left(\\frac{1}{r_1} - \\frac{1}{r_2}\\right)",
            latex: "\\Delta U = GMm\\left(\\frac{1}{r_1} - \\frac{1}{r_2}\\right)",
            description: "Moving between two points",
            variables: [],
            derivedFrom: "gpe-formula",
            applications: [],
            specialCases: [],
          ...
          {
            id: "near-surface-approx",
            name: "Near surface approx",
            category: "derived",
            formula: "U \\approx mgh",
            latex: "U \\approx mgh",
            description: "For h << R, ΔU = mgh",
            variables: [],
            derivedFrom: "gpe-formula",
            applications: [],
            specialCases: [],
          ...
          {
            id: "pe-from-potential",
            name: "PE from potential",
            category: "derived",
            formula: "U = mV",
            latex: "U = mV",
            description: "PE = mass × potential",
            variables: [],
            derivedFrom: "gravitational-potential",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[V] = J/kg = m²/s²",
            neet_frequency: "medium",
          },
          {
            ...
            name: "At surface",
            category: "derived",
            formula: "V = -\\frac{GM}{R} = -gR",
            latex: "V = -\\frac{GM}{R} = -gR",
            description: "Using g = GM/R²",
            variables: [],
            derivedFrom: "gravitational-potential",
            applications: [],
          ...
          {
            id: "energy-to-escape",
            name: "Energy to escape",
            category: "derived",
            formula: "E_{escape} = \\frac{GMm}{R} = \\frac{1}{2}mv_e^2",
            latex: "E_{escape} = \\frac{GMm}{R} = \\frac{1}{2}mv_e^2",
            description: "From surface",
            variables: [],
            derivedFrom: "binding-energy",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[BE] = J",
            neet_frequency: "high",
          },
          {
            ...
            name: "For satellite",
            category: "derived",
            formula: "BE = \\frac{GMm}{2r}",
            latex: "BE = \\frac{GMm}{2r}",
            description: "Orbiting satellite",
            variables: [],
            derivedFrom: "binding-energy",
            applications: [],
            specialCases: [],
        ...
        variations: [
          {
            type: "numerical",
            description: "Calculate PE at given distance",
            difficulty: "easy"
          },
          {
            type: "numerical",
            description: "Work done to move mass between points",
            difficulty: "medium"
          },
          {
            type: "numerical",
          ...
          {
            type: "conceptual",
            description: "Why PE is negative",
            difficulty: "easy"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "PE at height problems",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "Work done against gravity",
            frequency: "medium",
            yearAsked: [2019, 2021, 2022]
          },
          {
            pattern: "Gravitational potential calculation",
            frequency: "medium",
      ...
      },
      {
        ...
        formulas: [
          {
            ...
            derivedFrom: null,
            applications: [],
            specialCases: ["v₀ ∝ 1/√r (higher orbit = slower)", "Independent of satellite mass"],
          ...
          },
          {
            ...
            variables: [
              {
                symbol: "T",
                meaning: "Orbital time period",
                unit: "s",
                typical_values: "Hours to days"
              },
              {
                symbol: "r",
                meaning: "Orbital radius",
            ...
            applications: [],
            specialCases: ["T² ∝ r³ (Kepler's 3rd law)", "Higher orbit = longer period"],
          ...
          },
          {
            ...
            derivedFrom: "orbital-velocity-formula",
            applications: [],
            specialCases: ["KE = GMm/2r (positive)", "PE = -GMm/r (negative, twice KE in magnitude)", "E < 0 means bound orbit"],
            dimensionalCheck: "[E] = J",
          },
          {
            id: "close-to-surface",
            name: "Close to surface",
            category: "derived",
            formula: "v_0 = \\sqrt{gR} \\approx 7.9 \\text{ km/s}",
            latex: "v_0 = \\sqrt{gR} \\approx 7.9 \\text{ km/s}",
            description: "r ≈ R",
            variables: [],
            derivedFrom: "orbital-velocity-formula",
            applications: [],
          ...
          },
          {
            ...
            name: "At height h",
            category: "derived",
            formula: "v_0 = \\sqrt{\\frac{gR^2}{R+h}}",
            latex: "v_0 = \\sqrt{\\frac{gR^2}{R+h}}",
          ...
          {
            id: "relation-to-escape",
            name: "Relation to escape",
            category: "derived",
            formula: "v_e = \\sqrt{2} \\times v_0",
            latex: "v_e = \\sqrt{2} \\times v_0",
            description: "At same radius",
            variables: [],
            derivedFrom: "orbital-velocity-formula",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Close to Earth",
            category: "derived",
            formula: "T \\approx 84 \\text{ min}",
            latex: "T \\approx 84 \\text{ min}",
            description: "Minimum period for Earth satellite",
            variables: [],
          ...
          },
          {
            ...
            category: "derived",
            formula: "E = \\frac{U}{2} = -KE",
            latex: "E = \\frac{U}{2} = -KE",
            description: "KE = -E, PE = 2E",
            variables: [],
          ...
          {
            id: "energy-to-change-orbit",
            name: "Energy to change orbit",
            category: "derived",
            formula: "\\Delta E = \\frac{GMm}{2}\\left(\\frac{1}{r_1} - \\frac{1}{r_2}\\right)",
            latex: "\\Delta E = \\frac{GMm}{2}\\left(\\frac{1}{r_1} - \\frac{1}{r_2}\\right)",
            description: "Moving to higher orbit needs energy",
            variables: [],
            derivedFrom: "orbital-energy",
            applications: [],
            specialCases: [],
        ...
        variations: [
          {
            type: "numerical",
            description: "Calculate orbital velocity at given height",
            difficulty: "easy"
          },
          {
            type: "numerical",
            description: "Time period of satellite",
            difficulty: "medium"
          },
          {
            type: "numerical",
            description: "Energy of satellite in orbit",
            difficulty: "medium"
          },
          {
            type: "conceptual",
            description: "Effect of altitude on v₀ and T",
            difficulty: "easy"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "Orbital velocity calculation",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "Time period of satellite",
            frequency: "high",
            yearAsked: [
              2019,
              2020,
      ...
      },
      {
        ...
        formulas: [
            ...
            variables: [
              {
                ...
                meaning: "Height above surface",
                unit: "km",
                typical_values: "≈ 36,000 km"
              },
              {
                symbol: "T",
                meaning: "Time period",
                unit: "hours",
                typical_values: "24 hours"
              }
            ],
            derivedFrom: "time-period-orbit",
            applications: [],
            specialCases: ["Must be in equatorial plane", "Only one possible height for T = 24h", "Angular velocity = Earth's rotation"],
          ...
          },
          {
            ...
            derivedFrom: "orbital-energy",
            applications: [],
            specialCases: ["E = BE_surface - BE_orbit = GMm/R - GMm/2r", "Need to overcome binding + give orbital KE"],
            dimensionalCheck: "[E] = J",
          },
          {
            id: "parking-orbit",
            ...
            variables: [
              {
                symbol: "ΔE",
                meaning: "Energy change",
                unit: "J",
                typical_values: "Positive to go higher"
              },
              {
                symbol: "r₁",
                meaning: "Initial orbital radius",
                unit: "m",
                typical_values: "Lower orbit"
              },
              {
                symbol: "r₂",
                meaning: "Final orbital radius",
                unit: "m",
                typical_values: "Higher orbit"
              }
            ],
            derivedFrom: "orbital-energy",
            applications: [],
            specialCases: ["Higher orbit has more negative total E", "Counterintuitive: moving to slower orbit needs energy"],
          ...
          },
          {
            ...
            formula: "",
            latex: "",
            description: "TV, phone relay",
            variables: [],
            derivedFrom: "geostationary-orbit",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[r] = m, [T] = s",
            neet_frequency: "medium",
          },
          {
            ...
            formula: "",
            latex: "",
            description: "Stationary view of region",
            variables: [],
            derivedFrom: "geostationary-orbit",
            applications: [],
            specialCases: [],
          ...
          {
            id: "close-orbit-r-r",
            name: "Close orbit (r ≈ R)",
            category: "derived",
            formula: "E = \\frac{GMm}{2R} = \\frac{mgR}{2}",
            latex: "E = \\frac{GMm}{2R} = \\frac{mgR}{2}",
            description: "Minimum energy",
            variables: [],
            derivedFrom: "energy-to-orbit",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[E] = J",
            neet_frequency: "high",
          },
          {
            ...
            name: "Work breakdown",
            category: "derived",
            formula: "E = KE_{orbit} + |\\Delta PE|",
            latex: "E = KE_{orbit} + |\\Delta PE|",
            description: "Energy for velocity + height",
            variables: [],
            derivedFrom: "energy-to-orbit",
            applications: [],
            specialCases: [],
          ...
          {
            id: "move-to-higher-orbit",
            name: "Move to higher orbit",
            category: "derived",
            formula: "\\Delta E > 0",
            latex: "\\Delta E > 0",
            description: "Energy must be added",
            variables: [],
            derivedFrom: "parking-orbit",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[ΔE] = J",
            neet_frequency: "medium",
          },
          {
            ...
            formula: "\\Delta E < 0",
            latex: "\\Delta E < 0",
            description: "Energy released/removed",
            variables: [],
            derivedFrom: "parking-orbit",
            applications: [],
            specialCases: [],
        ...
        variations: [
          {
            type: "numerical",
            description: "Height of geostationary orbit",
            difficulty: "medium"
          },
          {
            type: "numerical",
            description: "Energy to place satellite in orbit",
            difficulty: "hard"
          },
          {
            type: "numerical",
            description: "Energy to change orbit",
            difficulty: "hard"
          },
          {
            type: "conceptual",
            description: "Properties of geostationary vs polar satellites",
            difficulty: "easy"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "Geostationary orbit properties",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "Energy to launch satellite",
            frequency: "medium",
            yearAsked: [2019, 2021, 2023]
          },
          {
            pattern: "Satellite binding energy",
            frequency: "medium",
            yearAsked: [2018, 2020, 2022]
          }
        ],
      ...
      },
      {
        ...
        formulas: [
            ...
            variables: [
              {
                ...
                meaning: "Orbital time period",
                unit: "s",
                typical_values: "Days to years"
              },
              {
                symbol: "a",
                meaning: "Semi-major axis of ellipse",
                unit: "m",
                typical_values: "AU or km"
              },
              {
                symbol: "M",
                meaning: "Central body mass",
                unit: "kg",
                typical_values: "Sun or planet mass"
              }
            ],
            derivedFrom: null,
            applications: [],
            specialCases: ["T² ∝ r³ (period increases with distance)", "Independent of orbiting body mass"],
            dimensionalCheck: "[T²] = [r³]/[GM] = s²",
          },
          {
            id: "areal-velocity",
            ...
            variables: [
              {
                ...
                unit: "m²/s",
                typical_values: "Constant for orbit"
              },
              {
                symbol: "L",
                meaning: "Angular momentum",
                unit: "kg·m²/s",
                typical_values: "Conserved"
              },
              {
                symbol: "m",
                meaning: "Planet mass",
                unit: "kg",
                typical_values: "Planet mass"
              }
            ],
            derivedFrom: null,
            applications: [],
            specialCases: ["Faster at perihelion (closest), slower at aphelion (farthest)", "Consequence of angular momentum conservation"],
          ...
          },
          {
            ...
            variables: [
              {
                symbol: "rₚ",
                meaning: "Perihelion distance",
                unit: "m",
                typical_values: "Closest approach"
              },
              {
                symbol: "rₐ",
                meaning: "Aphelion distance",
                unit: "m",
                typical_values: "Farthest distance"
              },
              {
                symbol: "vₚ",
                meaning: "Speed at perihelion",
                unit: "m/s",
                typical_values: "Maximum speed"
              },
              {
                symbol: "vₐ",
                meaning: "Speed at aphelion",
                unit: "m/s",
                typical_values: "Minimum speed"
              }
            ],
            derivedFrom: "areal-velocity",
            applications: [],
            specialCases: ["vₚ > vₐ always", "Product rv = constant throughout orbit"],
          ...
          },
          {
            ...
            category: "derived",
            formula: "T^2 = \\frac{4\\pi^2 r^3}{GM}",
            latex: "T^2 = \\frac{4\\pi^2 r^3}{GM}",
            description: "a = r for circle",
            variables: [],
            derivedFrom: "keplers-third-law",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[T²] = [r³]/[GM] = s²",
            neet_frequency: "high",
          },
          {
            ...
            latex: "\\frac{T_1^2}{T_2^2} = \\frac{r_1^3}{r_2^3}",
            description: "Compare two orbits",
            variables: [],
            derivedFrom: "keplers-third-law",
            applications: [],
            specialCases: [],
          ...
          {
            id: "find-planet-mass",
            name: "Find planet mass",
            category: "derived",
            formula: "M = \\frac{4\\pi^2 r^3}{GT^2}",
            latex: "M = \\frac{4\\pi^2 r^3}{GT^2}",
            description: "From satellite orbit data",
            variables: [],
            derivedFrom: "keplers-third-law",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Circular orbit",
            category: "derived",
            formula: "\\frac{dA}{dt} = \\frac{r \\cdot v}{2} = \\frac{\\pi r^2}{T}",
            latex: "\\frac{dA}{dt} = \\frac{r \\cdot v}{2} = \\frac{\\pi r^2}{T}",
          ...
          {
            id: "perihelion-vs-aphelion",
            name: "Perihelion vs Aphelion",
            category: "derived",
            formula: "r_1 v_1 = r_2 v_2",
            latex: "r_1 v_1 = r_2 v_2",
            description: "From L = mvr = constant",
            variables: [],
            derivedFrom: "areal-velocity",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Velocity ratio",
            category: "derived",
            formula: "\\frac{v_p}{v_a} = \\frac{r_a}{r_p}",
            latex: "\\frac{v_p}{v_a} = \\frac{r_a}{r_p}",
            description: "Inverse ratio",
            variables: [],
            derivedFrom: "velocity-perihelion-aphelion",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[rv] = m²/s",
            neet_frequency: "high",
        ...
        variations: [
          {
            type: "numerical",
            description: "Apply T² ∝ r³ to find period",
            difficulty: "easy"
          },
          {
            type: "numerical",
            description: "Compare periods of different planets/satellites",
            difficulty: "medium"
          },
          {
            type: "numerical",
            description: "Velocity at perihelion and aphelion",
            difficulty: "medium"
          },
          {
            type: "conceptual",
            description: "Interpretation of Kepler's laws",
            difficulty: "easy"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "T² ∝ r³ applications",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "Velocity ratio at perihelion/aphelion",
            frequency: "medium",
            yearAsked: [2019, 2021, 2023]
          },
          {
            pattern: "Areal velocity problems",
            frequency: "medium",
            yearAsked: [2018, 2020, 2022]
          }
        ],
      ...
      },
      {
        ...
        formulas: [
          {
            ...
            variables: [
              ...
              },
              {
                ...
                unit: "m/s²",
                typical_values: "Positive if downward"
              }
            ],
            derivedFrom: null,
            applications: [],
            specialCases: ["a = g (free fall): N = 0", "a > g: N negative (person would lift off floor)"],
          ...
          },
          {
            ...
            variables: [
              {
                symbol: "aᵣ",
                meaning: "Centripetal acceleration = g at that height",
                unit: "m/s²",
                typical_values: "~9 m/s² at ISS"
              }
            ],
            derivedFrom: "apparent-weight",
            applications: [],
            specialCases: ["Both astronaut and craft accelerate at same rate", "No relative motion, so no normal force"],
          ...
          },
          {
            ...
            variables: [
              {
                symbol: "g'",
                meaning: "Effective acceleration",
                unit: "m/s²",
                typical_values: "g at poles to g-0.034 at equator"
              },
              {
                symbol: "ω",
                meaning: "Earth angular velocity",
                unit: "rad/s",
                typical_values: "7.3 × 10⁻⁵ rad/s"
              },
              {
            ...
            derivedFrom: null,
            applications: [],
            specialCases: ["At poles (φ = 90°): no centrifugal effect", "At equator (φ = 0°): maximum reduction"],
            dimensionalCheck: "[g'] = m/s²",
          },
          {
            id: "free-fall",
          ...
          {
            id: "iss-height-400-km",
            name: "ISS height (~400 km)",
            category: "derived",
            formula: "g \\approx 0.89 g_0 \\approx 8.7 \\text{ m/s}^2",
            latex: "g \\approx 0.89 g_0 \\approx 8.7 \\text{ m/s}^2",
            description: "g is not zero!",
            variables: [],
            derivedFrom: "weightlessness-orbit",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[a] = m/s²",
            neet_frequency: "medium",
          ...
          {
            id: "for-weightlessness-at-equator",
            name: "For weightlessness at equator",
            category: "derived",
            formula: "g = R\\omega^2 \\Rightarrow \\omega = \\sqrt{g/R}",
            latex: "g = R\\omega^2 \\Rightarrow \\omega = \\sqrt{g/R}",
            description: "T ≈ 84 min",
            variables: [],
            derivedFrom: "effective-g-latitude",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[g'] = m/s²",
            neet_frequency: "medium",
          ...
          {
            id: "rotation-speed-needed",
            name: "Rotation speed needed",
            category: "derived",
            formula: "T = 2\\pi\\sqrt{R/g} \\approx 84 \\text{ min}",
            latex: "T = 2\\pi\\sqrt{R/g} \\approx 84 \\text{ min}",
            description: "Earth must spin 17× faster",
            variables: [],
            derivedFrom: "effective-g-latitude",
            applications: [],
            specialCases: [],
        ...
        variations: [
          {
            type: "conceptual",
            description: "Why astronauts feel weightless",
            difficulty: "easy"
          },
          {
            type: "numerical",
            description: "Apparent weight in lift",
            difficulty: "easy"
          },
          {
            type: "numerical",
            description: "Rotation speed for weightlessness",
            difficulty: "medium"
          },
          {
            type: "conceptual",
            description: "g value at space station altitude",
            difficulty: "medium"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "Apparent weight in lift problems",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "Weightlessness in orbit explanation",
            frequency: "medium",
            yearAsked: [2019, 2021, 2022]
          },
          {
            pattern: "Conditions for weightlessness",
            frequency: "medium",
            yearAsked: [2018, 2020, 2023]
          }
        ],
