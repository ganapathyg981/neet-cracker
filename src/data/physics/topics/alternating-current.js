...
export const alternatingCurrentTopics = [
      {
        ...
        formulas: [
          {
            ...
            variables: [
              {
                ...
                unit: "A",
                typical_values: "1-100 A"
              },
              {
                symbol: "V₀",
                meaning: "Peak voltage",
                unit: "V",
                typical_values: "100-350 V"
              },
              {
                symbol: "ω",
            ...
            derivedFrom: null,
            applications: [],
            specialCases: ["At t = 0: I = 0 (if phase = 0)", "At t = T/4: I = I₀ (maximum)"],
            ...
            variables: [
              {
                ...
                meaning: "RMS current",
                unit: "A",
                typical_values: "0.707I₀"
              },
              {
                symbol: "V_rms",
                meaning: "RMS voltage",
                unit: "V",
                typical_values: "220V in India"
              }
            ],
            derivedFrom: "ac-equation",
            applications: [],
            specialCases: ["RMS = DC equivalent for heating", "Meter readings show RMS values"],
            dimensionalCheck: "[I_rms] = A",
          },
          {
            id: "for-india-mains",
            name: "For India mains",
            category: "derived",
            formula: "\\omega = 2\\pi \\times 50 = 100\\pi \\text{ rad/s}",
            latex: "\\omega = 2\\pi \\times 50 = 100\\pi \\text{ rad/s}",
            description: "50 Hz frequency",
            variables: [],
            derivedFrom: "ac-equation",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Mains voltage",
            category: "derived",
            formula: "V_0 = V_{rms} \\times \\sqrt{2} = 220 \\times 1.414 \\approx 311V",
            latex: "V_0 = V_{rms} \\times \\sqrt{2} = 220 \\times 1.414 \\approx 311V",
            description: "Peak voltage from RMS",
            variables: [],
            derivedFrom: "rms-value",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[I_rms] = A",
            neet_frequency: "high",
          },
          {
            ...
            name: "Power formula",
            category: "derived",
            formula: "P = I_{rms}^2 R = \\frac{V_{rms}^2}{R}",
            latex: "P = I_{rms}^2 R = \\frac{V_{rms}^2}{R}",
            description: "Use RMS for power",
            variables: [],
            derivedFrom: "rms-value",
            applications: [],
            specialCases: [],
        ...
        variations: [
          {
            type: "numerical",
            description: "Convert between peak and RMS",
            difficulty: "easy"
          },
          {
            type: "numerical",
            description: "Average and RMS calculations",
            difficulty: "medium"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "Peak-RMS conversion",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
      ...
      },
      {
        ...
        formulas: [
            ...
            variables: [
              {
                ...
                unit: "Ω",
                typical_values: "10-1000 Ω"
              },
              {
                symbol: "L",
                meaning: "Inductance",
                unit: "H",
                typical_values: "mH to H"
              },
              {
                symbol: "ω",
                meaning: "Angular frequency",
                unit: "rad/s",
                typical_values: "100π rad/s"
              }
            ],
            derivedFrom: null,
            applications: [],
            specialCases: ["X_L ∝ f (increases with frequency)", "Current lags voltage by 90°"],
          ...
          },
          {
            ...
            derivedFrom: null,
            applications: [],
            specialCases: ["X_C ∝ 1/f (decreases with frequency)", "Current leads voltage by 90°"],
          ...
          },
          {
            ...
            applications: [],
            specialCases: ["If X_L > X_C: circuit is inductive", "If X_C > X_L: circuit is capacitive"],
            ...
            variables: [
              {
                ...
                unit: "Hz",
                typical_values: "100-10000 Hz"
              }
            ],
            derivedFrom: "impedance",
            applications: [],
            specialCases: ["At resonance: Z = R (minimum)", "Current maximum at resonance"],
            dimensionalCheck: "[f] = 1/√([L][C]) = 1/√(H·F) = Hz",
          },
          {
            id: "current-in-inductor",
            name: "Current in inductor",
            category: "derived",
            formula: "I = \\frac{V}{X_L} = \\frac{V}{\\omega L}",
            latex: "I = \\frac{V}{X_L} = \\frac{V}{\\omega L}",
            description: "Pure inductor circuit",
            variables: [],
            derivedFrom: "inductive-reactance",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            formula: "X_L = 0",
            latex: "X_L = 0",
            description: "Inductor is short for DC",
            variables: [],
            derivedFrom: "inductive-reactance",
            applications: [],
            specialCases: [],
          ...
          {
            id: "current-in-capacitor",
            name: "Current in capacitor",
            category: "derived",
            formula: "I = \\frac{V}{X_C} = \\omega CV",
            latex: "I = \\frac{V}{X_C} = \\omega CV",
            description: "Pure capacitor circuit",
            variables: [],
            derivedFrom: "capacitive-reactance",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[X_C] = 1/([ω][C]) = 1/(rad/s × F) = Ω",
            neet_frequency: "high",
          },
          {
            ...
            formula: "X_C = \\infty",
            latex: "X_C = \\infty",
            description: "Capacitor blocks DC",
            variables: [],
            derivedFrom: "capacitive-reactance",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            description: "Resonance condition",
            variables: [],
            derivedFrom: "resonant-frequency",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[f] = 1/√([L][C]) = 1/√(H·F) = Hz",
            neet_frequency: "high",
        ...
        variations: [
          {
            type: "numerical",
            description: "Calculate reactance",
            difficulty: "easy"
          },
          {
            type: "numerical",
            description: "Impedance of LCR circuit",
            difficulty: "medium"
          },
          {
            type: "numerical",
          ...
          {
            type: "conceptual",
            description: "Phase relationships",
            difficulty: "easy"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "Impedance calculation",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "Phase angle in circuits",
            frequency: "medium",
      ...
      },
      {
        ...
        formulas: [
          {
            ...
            variables: [
              {
                symbol: "P",
                meaning: "True/Real power",
                unit: "W",
                typical_values: "1-10000 W"
              },
              {
                symbol: "cos φ",
              ...
              },
              {
                ...
                meaning: "Phase angle",
                unit: "rad",
                typical_values: "0-π/2"
              }
            ],
            derivedFrom: "impedance",
            applications: [],
            specialCases: ["Only R consumes power, not L or C", "Pure L or C: P = 0"],
          ...
          },
          {
            ...
            derivedFrom: "impedance",
            applications: [],
            specialCases: ["cos φ = 1: resistive (power factor correction not needed)", "cos φ < 1: lagging (inductive) or leading (capacitive)"],
          ...
          },
          {
            ...
            name: "In terms of Z",
            category: "derived",
            formula: "P = I^2 Z \\cos\\phi",
            latex: "P = I^2 Z \\cos\\phi",
          ...
          {
            id: "from-phase-angle",
            name: "From phase angle",
            category: "derived",
            formula: "\\tan\\phi = \\frac{X_L - X_C}{R}",
            latex: "\\tan\\phi = \\frac{X_L - X_C}{R}",
            description: "Calculate φ first",
            variables: [],
            derivedFrom: "power-factor",
            applications: [],
            specialCases: [],
            dimensionalCheck: "Dimensionless",
            neet_frequency: "high",
        ...
        variations: [
          {
            type: "numerical",
            description: "Calculate power in AC circuit",
            difficulty: "medium"
          },
          {
            type: "numerical",
          ...
          {
            type: "conceptual",
            description: "Power in L and C",
            difficulty: "easy"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "Power factor calculation",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
      ...
      },
      {
        ...
        formulas: [
          {
            ...
            derivedFrom: "impedance",
            applications: [],
            specialCases: ["f₀ independent of R", "Halving L or C doubles ω₀"],
          ...
          },
          {
            ...
            applications: [],
            specialCases: ["Higher Q = sharper resonance", "Q increases if R decreases"],
            dimensionalCheck: "Dimensionless",
          },
          {
            ...
            variables: [
              {
                symbol: "I_max",
                meaning: "Maximum (resonant) current",
                unit: "A",
                typical_values: "mA to A"
              },
              {
                symbol: "V",
                meaning: "Source voltage (RMS)",
                unit: "V",
                typical_values: "1-220 V"
              }
            ],
            derivedFrom: "resonant-freq",
            applications: [],
            specialCases: ["At resonance, circuit behaves as pure resistor", "VL = VC (equal and opposite, cancel out)"],
          ...
          },
          {
            ...
            name: "From XL = XC",
            category: "derived",
            formula: "\\omega L = \\frac{1}{\\omega C} \\Rightarrow \\omega^2 = \\frac{1}{LC}",
            latex: "\\omega L = \\frac{1}{\\omega C} \\Rightarrow \\omega^2 = \\frac{1}{LC}",
          ...
          {
            id: "voltage-magnification",
            name: "Voltage magnification",
            category: "derived",
            formula: "V_L = V_C = QV",
            latex: "V_L = V_C = QV",
            description: "At resonance, VL and VC are Q times source voltage",
            variables: [],
          ...
          },
          {
            ...
            name: "Bandwidth",
            category: "derived",
            formula: "\\Delta f = \\frac{f_0}{Q}",
            latex: "\\Delta f = \\frac{f_0}{Q}",
            description: "Width of resonance curve",
            variables: [],
            derivedFrom: "quality-factor",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Energy factor",
            category: "derived",
            formula: "Q = 2\\pi \\times \\frac{\\text{Energy stored}}{\\text{Energy lost per cycle}}",
            latex: "Q = 2\\pi \\times \\frac{\\text{Energy stored}}{\\text{Energy lost per cycle}}",
          ...
          {
            id: "impedance-at-resonance",
            name: "Impedance at resonance",
            category: "derived",
            formula: "Z_{min} = R",
            latex: "Z_{min} = R",
            description: "Only resistance matters",
            variables: [],
            derivedFrom: "resonance-current",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[I] = [V]/[R] = A",
            neet_frequency: "high",
          ...
          {
            id: "power-at-resonance",
            name: "Power at resonance",
            category: "derived",
            formula: "P_{max} = \\frac{V^2}{R}",
            latex: "P_{max} = \\frac{V^2}{R}",
            description: "Maximum power transfer",
            variables: [],
            derivedFrom: "resonance-current",
            applications: [],
            specialCases: [],
        ...
        variations: [
          ...
          {
            type: "numerical",
            description: "Q factor and bandwidth",
            difficulty: "medium"
          },
          {
            type: "numerical",
            description: "Voltage across L and C at resonance",
            difficulty: "medium"
          },
          {
            type: "conceptual",
            description: "Properties at resonance",
            difficulty: "easy"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "Resonant frequency calculation",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "Q factor and sharpness",
            frequency: "medium",
            yearAsked: [2019, 2020, 2022]
          },
          {
            pattern: "Current and impedance at resonance",
            frequency: "high",
      ...
      },
      {
        ...
        formulas: [
          {
            ...
            variables: [
              {
                symbol: "V₁",
                meaning: "Primary voltage",
                unit: "V",
                typical_values: "220V mains"
              },
              {
                symbol: "V₂",
                meaning: "Secondary voltage",
                unit: "V",
                typical_values: "6-440 V"
              },
              {
                symbol: "N₁",
                meaning: "Primary turns",
                unit: "dimensionless",
                typical_values: "100-10000"
              },
              {
                symbol: "N₂",
                meaning: "Secondary turns",
                unit: "dimensionless",
              ...
              },
              {
                ...
                meaning: "Turns ratio",
                unit: "dimensionless",
                typical_values: "0.1-100"
              }
            ],
            derivedFrom: "mutual-inductance",
            applications: [],
            specialCases: ["k = 1: isolation transformer (same voltage)", "Works only with AC, not DC"],
          ...
          },
          {
            ...
            variables: [
              {
                symbol: "I₁",
                meaning: "Primary current",
                unit: "A",
                typical_values: "0.1-10 A"
              },
              {
                symbol: "I₂",
                meaning: "Secondary current",
                unit: "A",
                typical_values: "0.01-100 A"
              }
            ],
            derivedFrom: "transformer-ratio",
            applications: [],
            specialCases: ["Step-up: current decreases", "Step-down: current increases"],
            dimensionalCheck: "Dimensionless ratio",
          },
          {
            ...
            variables: [
              {
                ...
                meaning: "Efficiency",
                unit: "%",
                typical_values: "90-99%"
              },
              {
                symbol: "P_out",
                meaning: "Output power",
                unit: "W",
                typical_values: "Slightly less than P_in"
              },
              {
                symbol: "P_in",
                meaning: "Input power",
                unit: "W",
                typical_values: "Total input"
              }
            ],
            derivedFrom: "transformer-ratio",
            applications: [],
            specialCases: ["Ideal transformer: η = 100%", "Losses: copper (I²R), iron (hysteresis + eddy currents)"],
            dimensionalCheck: "[η] = %",
          },
          {
            ...
            variables: [
              {
                symbol: "P_loss",
                meaning: "Power lost in lines",
                unit: "W",
                typical_values: "1-5% of P"
              },
              {
                symbol: "R",
                meaning: "Resistance of lines",
                unit: "Ω",
                typical_values: "1-100 Ω"
              },
              {
                symbol: "P",
                meaning: "Power transmitted",
                unit: "W",
                typical_values: "MW to GW"
              },
              {
                symbol: "V",
                meaning: "Transmission voltage",
                unit: "V",
                typical_values: "11kV-765kV"
              }
            ],
            derivedFrom: null,
            applications: [],
            specialCases: ["Double V → quarter the loss", "That's why power is transmitted at very high voltages"],
          ...
          },
          {
            ...
            name: "Step-up",
            category: "derived",
            formula: "k > 1 \\Rightarrow V_2 > V_1",
            latex: "k > 1 \\Rightarrow V_2 > V_1",
            description: "Increases voltage",
            variables: [],
            derivedFrom: "transformer-ratio",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            latex: "V_1 I_1 = V_2 I_2",
            description: "Ideal transformer",
            variables: [],
            derivedFrom: "transformer-current",
            applications: [],
            specialCases: [],
            dimensionalCheck: "Dimensionless ratio",
            neet_frequency: "high",
          },
          {
            ...
            name: "Step-up effect",
            category: "derived",
            formula: "V \\uparrow \\Rightarrow I \\downarrow",
            latex: "V \\uparrow \\Rightarrow I \\downarrow",
            description: "Voltage up, current down",
            variables: [],
            derivedFrom: "transformer-current",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Power loss",
            category: "derived",
            formula: "P_{loss} = P_{in} - P_{out}",
            latex: "P_{loss} = P_{in} - P_{out}",
            description: "Copper + iron losses",
            variables: [],
            derivedFrom: "transformer-efficiency",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[η] = %",
            neet_frequency: "high",
          },
          {
            ...
            formula: "\\eta < 100\\%",
            latex: "\\eta < 100\\%",
            description: "Always some losses",
            variables: [],
            derivedFrom: "transformer-efficiency",
            applications: [],
            specialCases: [],
          ...
          {
            id: "high-voltage-advantage",
            name: "High voltage advantage",
            category: "derived",
            formula: "P_{loss} \\propto \\frac{1}{V^2}",
            latex: "P_{loss} \\propto \\frac{1}{V^2}",
            description: "Higher V → much lower loss",
            variables: [],
            derivedFrom: "power-transmission",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[P] = W",
            neet_frequency: "high",
          ...
          {
            id: "step-up-for-transmission",
            name: "Step-up for transmission",
            category: "derived",
            formula: "V \\uparrow \\Rightarrow I \\downarrow \\Rightarrow I^2R \\downarrow",
            latex: "V \\uparrow \\Rightarrow I \\downarrow \\Rightarrow I^2R \\downarrow",
            description: "Why we use high voltage",
            variables: [],
            derivedFrom: "power-transmission",
            applications: [],
            specialCases: [],
        ...
        variations: [
          {
            type: "numerical",
            description: "Calculate secondary voltage/current",
            difficulty: "easy"
          },
          {
            type: "numerical",
          ...
          {
            type: "numerical",
            description: "Power loss in transmission",
            difficulty: "medium"
          },
          {
            type: "conceptual",
            description: "Why transformers need AC",
            difficulty: "easy"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "Turns ratio calculations",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "Power transmission losses",
            frequency: "high",
            yearAsked: [2019, 2021, 2022]
          },
          {
            pattern: "Transformer efficiency",
            frequency: "medium",
            yearAsked: [2018, 2020, 2023]
          }
        ],
      ...
      },
      {
        ...
        formulas: [
          {
            ...
            variables: [
              {
                symbol: "f",
                meaning: "Oscillation frequency",
                unit: "Hz",
                typical_values: "kHz to MHz"
              },
              {
                symbol: "ω",
                meaning: "Angular frequency",
                unit: "rad/s",
                typical_values: "10³-10⁸ rad/s"
              }
            ],
            derivedFrom: null,
            applications: [],
            specialCases: ["Same as resonant frequency in LCR circuit", "Independent of initial conditions"],
            dimensionalCheck: "[f] = 1/√(H·F) = Hz",
          },
          {
            ...
            applications: [],
            specialCases: ["When q = q₀, I = 0 (all energy in C)", "When q = 0, I = I₀ (all energy in L)"],
          ...
          },
          {
            ...
            variables: [
              ...
              {
                symbol: "UC",
                meaning: "Energy in capacitor",
                unit: "J",
                typical_values: "Varies with time"
              },
              {
                symbol: "UL",
                meaning: "Energy in inductor",
                unit: "J",
                typical_values: "Varies with time"
              }
            ],
            ...
            applications: [],
            specialCases: ["At t = 0 (if C fully charged): all energy in C", "At t = T/4: all energy in L"],
          ...
          },
          {
            ...
            category: "derived",
            formula: "I_0 = \\omega q_0 = \\frac{q_0}{\\sqrt{LC}}",
            latex: "I_0 = \\omega q_0 = \\frac{q_0}{\\sqrt{LC}}",
            description: "Peak current value",
            variables: [],
            derivedFrom: "charge-current-lc",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            category: "derived",
            formula: "I \\text{ leads } q \\text{ by } 90°",
            latex: "I \\text{ leads } q \\text{ by } 90°",
            description: "Current and charge out of phase",
            variables: [],
            derivedFrom: "charge-current-lc",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            category: "derived",
            formula: "U_C + U_L = \\text{constant}",
            latex: "U_C + U_L = \\text{constant}",
            description: "No energy lost (ideal)",
            variables: [],
            derivedFrom: "energy-lc",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[U] = J",
            neet_frequency: "high",
          },
          {
            ...
            name: "Relation",
            category: "derived",
            formula: "\\frac{q_0^2}{2C} = \\frac{LI_0^2}{2}",
            latex: "\\frac{q_0^2}{2C} = \\frac{LI_0^2}{2}",
            description: "Max energies equal",
            variables: [],
            derivedFrom: "energy-lc",
            applications: [],
            specialCases: [],
        ...
        variations: [
          {
            type: "numerical",
            description: "Frequency of LC oscillation",
            difficulty: "easy"
          },
          {
            type: "numerical",
            description: "Maximum current from initial charge",
            difficulty: "medium"
          },
          {
            type: "numerical",
            description: "Energy at different instants",
            difficulty: "medium"
          },
          {
            type: "conceptual",
            description: "Analogy with SHM",
            difficulty: "easy"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "LC oscillation frequency",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "Energy distribution",
            frequency: "medium",
            yearAsked: [2019, 2021, 2023]
          },
          {
            pattern: "Analogy with mechanical SHM",
            frequency: "medium",
