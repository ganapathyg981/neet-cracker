...
export const motionInStraightLineTopics = [
  // Topic 1: Distance, Displacement and Position
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'Δx', meaning: 'Displacement', unit: 'm', typical_values: 'Can be +ve, -ve, or 0' },
          { symbol: 'x₁', meaning: 'Initial position', unit: 'm', typical_values: 'Depends on choice of origin' },
          { symbol: 'x₂', meaning: 'Final position', unit: 'm', typical_values: 'Depends on motion' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'One-way motion', latex: '|\\Delta x| = \\text{Distance}', context: 'No direction change', neet_frequency: 'medium' },
          { name: 'Round trip', latex: '\\Delta x = 0, \\text{ Distance} \\neq 0', context: 'Return to start', neet_frequency: 'high' },
        ],
        specialCases: [
          'Displacement can be negative (motion in -ve direction)',
          'For circular path returning to start: Δx = 0',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Calculate distance and displacement for given path', difficulty: 'easy' },
      { type: 'conceptual', description: 'Compare distance and displacement for various motions', difficulty: 'easy' },
      { type: 'numerical', description: 'Find position from displacement', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Distance vs displacement for multi-step motion', frequency: 'high', yearAsked: [2018, 2019, 2021, 2022] },
      { pattern: 'Displacement for circular/curved path', frequency: 'medium', yearAsked: [2019, 2020] },
    ],
  ...
  // Topic 2: Speed and Velocity
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'v_avg', meaning: 'Average speed', unit: 'm/s', typical_values: '1-30 m/s for everyday motion' },
          { symbol: 's', meaning: 'Total distance', unit: 'm', typical_values: 'Always positive' },
          { symbol: 't', meaning: 'Total time', unit: 's', typical_values: 'Always positive' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Two equal distances at different speeds', latex: 'v_{avg} = \\frac{2v_1v_2}{v_1 + v_2}', context: 'Harmonic mean', neet_frequency: 'high' },
          { name: 'Two equal times at different speeds', latex: 'v_{avg} = \\frac{v_1 + v_2}{2}', context: 'Arithmetic mean', neet_frequency: 'high' },
        ],
        specialCases: [
          'For equal distances: use harmonic mean',
          'For equal times: use arithmetic mean',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'v̄', meaning: 'Average velocity', unit: 'm/s', typical_values: 'Can be +ve, -ve, or 0' },
          { symbol: 'Δx', meaning: 'Displacement', unit: 'm', typical_values: 'Net change in position' },
          { symbol: 'Δt', meaning: 'Time interval', unit: 's', typical_values: 'Always positive' },
        ],
        derivedFrom: 'displacement-formula',
        applications: [
          { name: 'From x-t graph', latex: '\\bar{v} = \\text{slope of chord}', context: 'Secant line on position-time graph', neet_frequency: 'high' },
        ],
        specialCases: [
          'For round trip: average velocity = 0',
          'Can be negative (motion in -ve direction)',
        ],
        dimensionalCheck: '[v] = L/T = m/s',
      },
      {
        ...
        variables: [
          { symbol: 'v', meaning: 'Instantaneous velocity', unit: 'm/s', typical_values: 'Value at specific time' },
          { symbol: 'dx/dt', meaning: 'Derivative of position', unit: 'm/s', typical_values: 'Slope of x-t curve' },
        ],
        derivedFrom: 'average-velocity',
        applications: [
          { name: 'From x-t graph', latex: 'v = \\text{slope of tangent}', context: 'Tangent at a point', neet_frequency: 'high' },
          { name: 'Given x = f(t)', latex: 'v = \\frac{d}{dt}[f(t)]', context: 'Differentiate position function', neet_frequency: 'high' },
        ],
        specialCases: [
          'Magnitude of instantaneous velocity = instantaneous speed',
          'Slope of tangent to x-t curve',
        ],
        dimensionalCheck: '[v] = L/T = m/s',
      },
    ],
    ...
    variations: [
      { type: 'numerical', description: 'Average speed for multi-part journey', difficulty: 'medium' },
      { type: 'numerical', description: 'Instantaneous velocity from position function', difficulty: 'medium' },
      { type: 'graphical', description: 'Velocity from x-t graph', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Average speed for equal distances (harmonic mean)', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022, 2023] },
      { pattern: 'Velocity from x-t graph', frequency: 'high', yearAsked: [2019, 2020, 2022] },
      { pattern: 'Average speed vs average velocity', frequency: 'medium', yearAsked: [2018, 2021] },
    ],
  ...
  // Topic 3: Acceleration and Uniformly Accelerated Motion
  {
    id: 'acceleration-uam',
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'a', meaning: 'Acceleration', unit: 'm/s²', typical_values: 'g ≈ 10 m/s² for gravity' },
          { symbol: 'v', meaning: 'Final velocity', unit: 'm/s', typical_values: 'After time t' },
          { symbol: 'u', meaning: 'Initial velocity', unit: 'm/s', typical_values: 'At t = 0' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'From v-t graph', latex: 'a = \\text{slope of v-t graph}', context: 'Tangent slope', neet_frequency: 'high' },
        ],
        specialCases: [
          'Positive a: velocity increasing (not necessarily speeding up)',
          'Negative a: velocity decreasing (deceleration when slowing)',
      ...
      },
      {
        ...
        variables: [
          { symbol: 'v', meaning: 'Final velocity', unit: 'm/s', typical_values: 'Can be +ve or -ve' },
          { symbol: 'u', meaning: 'Initial velocity', unit: 'm/s', typical_values: 'Given or 0' },
          { symbol: 'a', meaning: 'Acceleration', unit: 'm/s²', typical_values: 'Constant value' },
          { symbol: 't', meaning: 'Time', unit: 's', typical_values: 'Always ≥ 0' },
        ],
        derivedFrom: 'acceleration-definition',
        applications: [
          { name: 'Time to stop', latex: 't = \\frac{v - u}{a} = \\frac{-u}{a}', context: 'When v = 0', neet_frequency: 'high' },
          { name: 'Velocity at time t', latex: 'v = u + at', context: 'Direct substitution', neet_frequency: 'high' },
        ],
        specialCases: [
          'If u = 0: v = at',
          'If v = 0: t = -u/a (time to stop)',
          'Does not involve displacement s',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 's', meaning: 'Displacement', unit: 'm', typical_values: 'Can be +ve or -ve' },
          { symbol: 'u', meaning: 'Initial velocity', unit: 'm/s', typical_values: 'Given' },
          { symbol: 'a', meaning: 'Acceleration', unit: 'm/s²', typical_values: 'Constant' },
          { symbol: 't', meaning: 'Time', unit: 's', typical_values: '≥ 0' },
        ],
        derivedFrom: 'first-equation',
        applications: [
          { name: 'From rest', latex: 's = \\frac{1}{2}at^2', context: 'When u = 0', neet_frequency: 'high' },
          { name: 'Displacement in nth second', latex: 's_n = u + a(n - \\frac{1}{2})', context: 'For integer n', neet_frequency: 'high' },
        ],
        specialCases: [
          'If u = 0: s = ½at² (parabolic motion)',
          'If a = 0: s = ut (uniform motion)',
          'Does not involve final velocity v',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'v', meaning: 'Final velocity', unit: 'm/s', typical_values: 'Speed at end' },
          { symbol: 'u', meaning: 'Initial velocity', unit: 'm/s', typical_values: 'Speed at start' },
          { symbol: 'a', meaning: 'Acceleration', unit: 'm/s²', typical_values: 'Constant' },
          { symbol: 's', meaning: 'Displacement', unit: 'm', typical_values: 'Net displacement' },
        ],
        derivedFrom: 'first-equation',
        applications: [
          { name: 'Stopping distance', latex: 's = \\frac{-u^2}{2a} = \\frac{u^2}{2|a|}', context: 'When v = 0', neet_frequency: 'high' },
          { name: 'From rest', latex: 'v^2 = 2as', context: 'When u = 0', neet_frequency: 'high' },
        ],
        specialCases: [
          'Time-independent equation',
          'Useful when time is not given/needed',
          'Stopping distance ∝ u² (doubling speed → 4× stopping distance)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'sₙ', meaning: 'Displacement in nth second', unit: 'm', typical_values: 'For integer n' },
          { symbol: 'n', meaning: 'nth second', unit: 's', typical_values: '1, 2, 3...' },
        ],
        derivedFrom: 'second-equation',
        applications: [
          { name: 'From rest', latex: 's_n = a\\left(n - \\frac{1}{2}\\right)', context: 'u = 0', neet_frequency: 'high' },
          { name: 'Ratio of displacements', latex: 's_1 : s_2 : s_3 = 1 : 3 : 5', context: 'From rest, successive seconds', neet_frequency: 'high' },
        ],
        specialCases: [
          'From rest: s₁:s₂:s₃... = 1:3:5:7... (odd numbers)',
          'Total s in n seconds: s₁:s₂:... = 1:4:9... (perfect squares)',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Find missing variable using kinematic equations', difficulty: 'easy' },
      { type: 'numerical', description: 'Displacement in nth second problems', difficulty: 'medium' },
      { type: 'graphical', description: 'Interpret v-t and a-t graphs', difficulty: 'medium' },
      { type: 'numerical', description: 'Two-body problems (catch-up, collision)', difficulty: 'hard' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Displacement in nth second (ratio 1:3:5:7...)', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022, 2023] },
      { pattern: 'Stopping distance problems', frequency: 'high', yearAsked: [2018, 2020, 2022] },
      { pattern: 'v-t graph analysis', frequency: 'high', yearAsked: [2019, 2021, 2023] },
      { pattern: 'Motion with direction change', frequency: 'medium', yearAsked: [2019, 2020] },
    ],
  ...
  // Topic 4: Free Fall and Motion Under Gravity
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'g', meaning: 'Acceleration due to gravity', unit: 'm/s²', typical_values: '9.8 or 10' },
          { symbol: 'h', meaning: 'Height fallen', unit: 'm', typical_values: 'Depends on drop height' },
          { symbol: 'v', meaning: 'Velocity after falling', unit: 'm/s', typical_values: 'Increases with h' },
        ],
        derivedFrom: 'second-equation',
        applications: [
          { name: 'Time to fall height h', latex: 't = \\sqrt{\\frac{2h}{g}}', context: 'Dropping from rest', neet_frequency: 'high' },
          { name: 'Velocity on hitting ground', latex: 'v = \\sqrt{2gh}', context: 'Independent of mass', neet_frequency: 'high' },
        ],
        specialCases: [
          'Time to fall ∝ √h (not h)',
          'Final velocity ∝ √h',
          'Independent of mass',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'H', meaning: 'Maximum height', unit: 'm', typical_values: 'Depends on u' },
          { symbol: 'T', meaning: 'Total time of flight', unit: 's', typical_values: 'Time to return' },
          { symbol: 'u', meaning: 'Initial upward velocity', unit: 'm/s', typical_values: 'Given' },
        ],
        derivedFrom: 'third-equation',
        applications: [
          { name: 'Time to reach max height', latex: 't_{up} = \\frac{u}{g}', context: 'Half of total time', neet_frequency: 'high' },
          { name: 'Velocity at height h', latex: 'v = \\sqrt{u^2 - 2gh}', context: 'During ascent or descent', neet_frequency: 'high' },
        ],
        specialCases: [
          'At H_max: v = 0 but a = g (not zero)',
          'Time of ascent = Time of descent (for same level)',
          'Speed at any height is same going up and down',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'a_rel', meaning: 'Relative acceleration', unit: 'm/s²', typical_values: '0' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Separation increases uniformly', latex: '\\Delta s = \\Delta u \\cdot t', context: 'Separation ∝ t', neet_frequency: 'medium' },
          { name: 'Objects dropped at interval', latex: 's_{rel} = v_{rel} \\cdot t', context: 'Relative velocity stays constant', neet_frequency: 'high' },
        ],
        specialCases: [
          'Separation between two free-falling objects ∝ time',
    ...
    variations: [
      { type: 'numerical', description: 'Maximum height and time of flight', difficulty: 'easy' },
      { type: 'numerical', description: 'Object dropped/thrown from building', difficulty: 'medium' },
      { type: 'numerical', description: 'Two objects released at interval', difficulty: 'medium' },
      { type: 'conceptual', description: 'Acceleration at various points', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Maximum height and time of flight', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022, 2023] },
      { pattern: 'Velocity at given height', frequency: 'high', yearAsked: [2019, 2020, 2022] },
      { pattern: 'Objects dropped at time intervals', frequency: 'medium', yearAsked: [2018, 2021, 2023] },
      { pattern: 'Motion from height (building/cliff)', frequency: 'medium', yearAsked: [2019, 2022] },
    ],
