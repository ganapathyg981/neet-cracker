...
export const mathematicalToolsTopics = [
      {
        ...
        formulas: [
          {
            ...
            variables: [
              ...
              },
              {
                ...
                meaning: "Exponent",
                unit: "dimensionless",
                typical_values: "Any real number"
              }
            ],
            derivedFrom: null,
            applications: [],
          ...
          },
          {
            ...
            variables: [
              {
                symbol: "x",
                meaning: "Small parameter",
                unit: "dimensionless",
                typical_values: "h/R, v/c, Δ/L"
              }
            ],
            derivedFrom: "binomial-expansion",
            applications: [],
            specialCases: ["Always check if x << 1 before applying", "Keep only first-order terms unless asked for higher accuracy"],
          ...
          },
          {
            ...
            category: "derived",
            formula: "(1+x)^n \\approx 1 + nx",
            latex: "(1+x)^n \\approx 1 + nx",
            description: "When |x| << 1",
            variables: [],
            derivedFrom: "binomial-expansion",
            applications: [],
            specialCases: [],
          ...
          {
            id: "gravity-at-height-h",
            name: "Gravity at height h",
            category: "derived",
            formula: "g_h = g\\left(1+\\frac{h}{R}\\right)^{-2} \\approx g\\left(1 - \\frac{2h}{R}\\right)",
            latex: "g_h = g\\left(1+\\frac{h}{R}\\right)^{-2} \\approx g\\left(1 - \\frac{2h}{R}\\right)",
            description: "h << R",
            variables: [],
            derivedFrom: "binomial-expansion",
            applications: [],
          ...
          },
          {
            ...
            name: "Time dilation",
            category: "derived",
            formula: "\\gamma = \\left(1-\\frac{v^2}{c^2}\\right)^{-1/2} \\approx 1 + \\frac{v^2}{2c^2}",
            latex: "\\gamma = \\left(1-\\frac{v^2}{c^2}\\right)^{-1/2} \\approx 1 + \\frac{v^2}{2c^2}",
            description: "v << c",
            variables: [],
            derivedFrom: "binomial-expansion",
            applications: [],
          ...
          {
            id: "gravity-variation",
            name: "Gravity variation",
            category: "derived",
            formula: "g_h \\approx g\\left(1-\\frac{2h}{R}\\right)",
            latex: "g_h \\approx g\\left(1-\\frac{2h}{R}\\right)",
            description: "At height h << R",
            variables: [],
            derivedFrom: "common-approximations",
            applications: [],
            specialCases: [],
            dimensionalCheck: "Depends on context",
            neet_frequency: "high",
          },
          {
            ...
            name: "Gravity inside Earth",
            category: "derived",
            formula: "g_d \\approx g\\left(1-\\frac{d}{R}\\right)",
            latex: "g_d \\approx g\\left(1-\\frac{d}{R}\\right)",
            description: "At depth d",
            variables: [],
            derivedFrom: "common-approximations",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            category: "derived",
            formula: "C = \\frac{\\epsilon_0 A}{d-t+t/K}",
            latex: "C = \\frac{\\epsilon_0 A}{d-t+t/K}",
            description: "Partial dielectric",
            variables: [],
            derivedFrom: "common-approximations",
            applications: [],
            specialCases: [],
        ...
        variations: [
          {
            type: "numerical",
            description: "Apply binomial to gravity problems",
            difficulty: "medium"
          },
          {
            type: "conceptual",
            description: "When is approximation valid",
            difficulty: "easy"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "Gravity variation with height/depth",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "Condition for approximation validity",
            frequency: "medium",
            yearAsked: [2019, 2021]
          }
        ],
      ...
      },
      {
        ...
        formulas: [
            ...
            variables: [
              {
                ...
                unit: "y-unit/x-unit",
                typical_values: "Derivative"
              },
              {
                symbol: "area",
                meaning: "Accumulated quantity",
                unit: "y-unit × x-unit",
                typical_values: "Integral"
              }
            ],
            derivedFrom: null,
            applications: [],
            specialCases: ["Horizontal line: constant quantity", "Straight line with slope: uniform rate of change", "Curved line: variable rate of change"],
            dimensionalCheck: "Units from y-axis and x-axis",
          },
          {
            id: "x-t-graph-slope",
            name: "x-t graph slope",
            category: "derived",
            formula: "v = \\text{slope}",
            latex: "v = \\text{slope}",
            description: "Velocity from position graph",
            variables: [],
            derivedFrom: "graph-interpretations",
            applications: [],
            specialCases: [],
            dimensionalCheck: "Units from y-axis and x-axis",
            neet_frequency: "high",
          ...
          {
            id: "v-t-graph-slope",
            name: "v-t graph slope",
            category: "derived",
            formula: "a = \\text{slope}",
            latex: "a = \\text{slope}",
            description: "Acceleration from velocity graph",
            variables: [],
            derivedFrom: "graph-interpretations",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "v-t graph area",
            category: "derived",
            formula: "s = \\int v\\,dt = \\text{area}",
            latex: "s = \\int v\\,dt = \\text{area}",
            description: "Displacement from velocity graph",
            variables: [],
            derivedFrom: "graph-interpretations",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "F-x graph area",
            category: "derived",
            formula: "W = \\int F\\,dx = \\text{area}",
            latex: "W = \\int F\\,dx = \\text{area}",
            description: "Work from force graph",
            variables: [],
            derivedFrom: "graph-interpretations",
            applications: [],
            specialCases: [],
        ...
        variations: [
          {
            type: "graphical",
            description: "Find slope at a point",
            difficulty: "easy"
          },
          {
            type: "graphical",
        ...
        mostAskedPatterns: [
          ...
          {
            pattern: "Displacement from v-t graph",
            frequency: "high",
            yearAsked: [
              2019,
              2020,
      ...
      },
      {
        ...
        formulas: [
          {
            ...
            variables: [
              {
                symbol: "log",
                meaning: "Logarithm (any base)",
                unit: "dimensionless",
                typical_values: "Real number"
              }
            ],
            derivedFrom: null,
            applications: [],
          ...
          },
          {
            ...
            derivedFrom: null,
            applications: [],
            specialCases: ["e ≈ 2.718", "ln e = 1", "e^(ln x) = x"],
          ...
          },
          {
            ...
            category: "derived",
            formula: "t = \\frac{1}{\\lambda}\\ln\\left(\\frac{N_0}{N}\\right)",
            latex: "t = \\frac{1}{\\lambda}\\ln\\left(\\frac{N_0}{N}\\right)",
            description: "Time from decay equation",
            variables: [],
            derivedFrom: "log-properties",
            applications: [],
            specialCases: [],
            dimensionalCheck: "Logarithm is dimensionless",
            neet_frequency: "high",
          ...
          },
          {
            ...
            description: "Sound intensity level",
            variables: [],
            derivedFrom: "log-properties",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            description: "Uses ln 2",
            variables: [],
            derivedFrom: "useful-log-values",
            applications: [],
            specialCases: [],
            dimensionalCheck: "Pure numbers",
            neet_frequency: "high",
          },
          {
            ...
            name: "Conversion",
            category: "derived",
            formula: "\\ln x = 2.303 \\log_{10} x",
            latex: "\\ln x = 2.303 \\log_{10} x",
            description: "Natural to common log",
            variables: [],
            derivedFrom: "useful-log-values",
            applications: [],
            specialCases: [],
        ...
        variations: [
          {
            type: "numerical",
            description: "Simplify logarithmic expressions",
            difficulty: "easy"
          },
          {
            type: "numerical",
            description: "Solve exponential equations using log",
            difficulty: "medium"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "Half-life calculations using ln 2",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
      ...
      },
      {
        ...
        formulas: [
            ...
            variables: [
              {
                ...
                meaning: "Integral",
                unit: "x-unit × y-unit",
                typical_values: "Accumulated quantity"
              },
              {
                symbol: "C",
                meaning: "Constant of integration",
                unit: "same as y",
                typical_values: "Determined by initial conditions"
              }
            ],
            derivedFrom: null,
            applications: [],
          ...
          },
          {
            ...
            derivedFrom: null,
            applications: [],
            specialCases: ["d(tan x)/dx = sec²x", "∫cos x dx = sin x + C", "∫sin x dx = -cos x + C"],
            dimensionalCheck: "Dimensionless (trigonometric)",
          },
          {
            id: "velocity-from-position",
            ...
            variables: [],
            derivedFrom: "differentiation-rules",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[dy/dx] = [y]/[x]",
            neet_frequency: "high",
          ...
          },
          {
            ...
            name: "Force from potential",
            category: "derived",
            formula: "F = -\\frac{dU}{dx}",
            latex: "F = -\\frac{dU}{dx}",
            description: "Gradient of PE",
            variables: [],
            derivedFrom: "differentiation-rules",
            applications: [],
            specialCases: [],
          ...
          {
            id: "displacement-from-velocity",
            name: "Displacement from velocity",
            category: "derived",
            formula: "x = \\int v \\, dt",
            latex: "x = \\int v \\, dt",
            description: "Area under v-t curve",
            variables: [],
            derivedFrom: "integration-rules",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[∫y dx] = [y][x]",
            neet_frequency: "high",
          ...
          {
            id: "work-from-force",
            name: "Work from force",
            category: "derived",
            formula: "W = \\int F \\, dx",
            latex: "W = \\int F \\, dx",
            description: "Area under F-x curve",
            variables: [],
            derivedFrom: "integration-rules",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            formula: "J = \\int F \\, dt",
            latex: "J = \\int F \\, dt",
            description: "Area under F-t curve",
            variables: [],
            derivedFrom: "integration-rules",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "SHM velocity",
            category: "derived",
            formula: "x = A\\sin\\omega t \\Rightarrow v = A\\omega\\cos\\omega t",
            latex: "x = A\\sin\\omega t \\Rightarrow v = A\\omega\\cos\\omega t",
            description: "Velocity in SHM",
            variables: [],
            derivedFrom: "trigonometric-calculus",
            applications: [],
            specialCases: [],
            dimensionalCheck: "Dimensionless (trigonometric)",
            neet_frequency: "high",
          },
          {
            ...
            category: "derived",
            formula: "a = -A\\omega^2\\sin\\omega t = -\\omega^2 x",
            latex: "a = -A\\omega^2\\sin\\omega t = -\\omega^2 x",
            description: "Acceleration in SHM",
            variables: [],
            derivedFrom: "trigonometric-calculus",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            description: "Note the minus sign",
            variables: [],
            derivedFrom: "trigonometric-calculus",
            applications: [],
            specialCases: [],
        ...
        variations: [
          {
            type: "numerical",
            description: "Find velocity/acceleration from position function",
            difficulty: "medium"
          },
          {
            type: "numerical",
            description: "Find displacement from velocity function",
            difficulty: "medium"
          },
          {
            type: "conceptual",
            description: "Physical interpretation of derivative/integral",
            difficulty: "easy"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "v, a from x(t) in kinematics",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "SHM calculus (x, v, a relations)",
            frequency: "high",
            yearAsked: [
              2019,
              2020,
          ...
          {
            pattern: "Work from variable force",
            frequency: "medium",
