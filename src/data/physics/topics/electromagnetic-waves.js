...
export const electromagneticWavesTopics = [
  // Topic 1: Electromagnetic Spectrum and Properties
  {
    ...
    formulas: [
      {
        ...
        variables: [
          ...
          { symbol: 'ε₀', meaning: 'Permittivity of free space', unit: 'F/m', typical_values: '8.85 × 10⁻¹²' },
          { symbol: 'f', meaning: 'Frequency', unit: 'Hz', typical_values: '10³ to 10²⁰ Hz' },
          { symbol: 'λ', meaning: 'Wavelength', unit: 'm', typical_values: '10⁻¹² to 10⁶ m' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'In medium', latex: 'v = \\frac{c}{n} = \\frac{1}{\\sqrt{\\mu \\varepsilon}}', context: 'n = refractive index', neet_frequency: 'high' },
          { name: 'Wave equation', latex: 'c = f\\lambda', context: 'Fundamental wave relation', neet_frequency: 'high' },
        ],
        specialCases: [
          'c is same for all EM waves in vacuum',
          'Frequency doesn\'t change in different media, wavelength does',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'E', meaning: 'Electric field', unit: 'V/m', typical_values: 'Varies with source' },
          { symbol: 'B', meaning: 'Magnetic field', unit: 'T', typical_values: 'E/c' },
          { symbol: 'E₀, B₀', meaning: 'Amplitude of fields', unit: 'V/m, T', typical_values: 'Peak values' },
        ],
        derivedFrom: 'speed-em-waves',
        applications: [
          { name: 'Wave equation', latex: 'E = E_0\\sin(kx - \\omega t), B = B_0\\sin(kx - \\omega t)', context: 'In phase', neet_frequency: 'high' },
          { name: 'Direction', latex: '\\vec{E} \\times \\vec{B} \\parallel \\vec{c}', context: 'Cross product gives direction of propagation', neet_frequency: 'medium' },
        ],
        specialCases: [
          'E and B are in phase (reach maxima together)',
          'E and B perpendicular to each other and to direction of travel',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'Id', meaning: 'Displacement current', unit: 'A', typical_values: 'Same as conduction current' },
          { symbol: 'ΦE', meaning: 'Electric flux', unit: 'V·m', typical_values: 'Depends on field' },
          { symbol: 'dΦE/dt', meaning: 'Rate of change of electric flux', unit: 'V·m/s', typical_values: 'Varies' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'In capacitor', latex: 'I_d = \\varepsilon_0 A \\frac{dE}{dt}', context: 'Between capacitor plates', neet_frequency: 'high' },
          { name: 'Modified Ampere\'s law', latex: '\\oint B \\cdot dl = \\mu_0(I_c + I_d)', context: 'Includes displacement current', neet_frequency: 'high' },
        ],
        specialCases: [
          'Displacement current = conduction current (continuity)',
          'Allows changing E field to produce B field',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'I', meaning: 'Intensity', unit: 'W/m²', typical_values: 'Sunlight: ~1400 W/m²' },
        ],
        derivedFrom: 'em-field-relation',
        applications: [
          { name: 'Energy density', latex: 'u = \\varepsilon_0 E^2 = \\frac{B^2}{\\mu_0}', context: 'Energy per unit volume', neet_frequency: 'medium' },
          { name: 'Average intensity', latex: 'I_{avg} = \\frac{1}{2}\\varepsilon_0 c E_0^2', context: 'Time-averaged', neet_frequency: 'high' },
        ],
        specialCases: [
          'I ∝ E₀² ∝ B₀²',
          'Energy equally divided between E and B fields',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'p', meaning: 'Momentum', unit: 'kg·m/s', typical_values: 'Very small' },
          { symbol: 'U', meaning: 'Energy of wave', unit: 'J', typical_values: 'Varies' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Radiation pressure (absorbing)', latex: 'P = \\frac{I}{c}', context: 'Pressure on absorbing surface', neet_frequency: 'high' },
          { name: 'Radiation pressure (reflecting)', latex: 'P = \\frac{2I}{c}', context: 'Double for perfect reflection', neet_frequency: 'high' },
        ],
        specialCases: [
          'Pressure on absorbing surface = I/c',
          'Pressure on reflecting surface = 2I/c',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Speed of EM waves from μ₀ and ε₀', difficulty: 'easy' },
      { type: 'numerical', description: 'E and B amplitude ratio', difficulty: 'easy' },
      { type: 'numerical', description: 'Intensity and radiation pressure', difficulty: 'medium' },
      { type: 'conceptual', description: 'EM spectrum order and properties', difficulty: 'easy' },
      { type: 'numerical', description: 'Displacement current problems', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Speed of EM waves (c = 1/√μ₀ε₀)', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'EM spectrum order and properties', frequency: 'high', yearAsked: [2018, 2019, 2021, 2022] },
      { pattern: 'E/B = c relation', frequency: 'medium', yearAsked: [2019, 2020, 2023] },
      { pattern: 'Displacement current', frequency: 'medium', yearAsked: [2018, 2021, 2022] },
      { pattern: 'Radiation pressure', frequency: 'medium', yearAsked: [2019, 2020, 2023] },
    ],
    
    // EM Spectrum Details (Important for NEET)
    emSpectrum: [
      {
        type: 'Radio waves',
        wavelength: '> 0.1 m',
