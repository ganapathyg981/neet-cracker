...
export const rayOpticsTopics = [
  // Topic 1: Reflection from Plane Mirror
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: '∠i', meaning: 'Angle of incidence', unit: 'degrees', typical_values: '0-90°' },
          { symbol: '∠r', meaning: 'Angle of reflection', unit: 'degrees', typical_values: '0-90°' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Normal incidence', latex: 'i = r = 0°', context: 'Light retraces its path', neet_frequency: 'medium' },
          { name: 'Grazing incidence', latex: 'i = r \\approx 90°', context: 'Light almost parallel to surface', neet_frequency: 'low' },
        ],
        specialCases: [
          'Angles measured from normal, not surface',
          'For diffuse surfaces, law holds at each point',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'd_i', meaning: 'Image distance (behind mirror)', unit: 'm', typical_values: 'Same as d_o' },
          { symbol: 'd_o', meaning: 'Object distance (in front)', unit: 'm', typical_values: '0.1-10 m' },
        ],
        derivedFrom: 'law-of-reflection',
        applications: [
          { name: 'Image velocity', latex: 'v_i = -v_o', context: 'Object and image move opposite ways (perpendicular)', neet_frequency: 'high' },
          { name: 'Relative velocity', latex: 'v_{rel} = 2v_o', context: 'Object and image approach/recede at 2v_o', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Magnification = 1 (same size)',
          'Virtual image (cannot be captured on screen)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'θ', meaning: 'Angle of mirror rotation', unit: 'degrees', typical_values: '1-45°' },
          { symbol: '2θ', meaning: 'Rotation of reflected ray', unit: 'degrees', typical_values: 'Twice mirror rotation' },
        ],
        derivedFrom: 'law-of-reflection',
        applications: [
          { name: 'Galvanometer', latex: '\\text{Scale reading} \\propto 2\\theta', context: 'Used to amplify small rotations', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Incident ray direction unchanged',
          'Used in optical lever for sensitivity',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'n', meaning: 'Number of images', unit: 'dimensionless', typical_values: '1 to ∞' },
          { symbol: 'θ', meaning: 'Angle between mirrors', unit: 'degrees', typical_values: '30-180°' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Mirrors at 60°', latex: 'n = \\frac{360}{60} - 1 = 5', context: '5 images formed', neet_frequency: 'high' },
          { name: 'Mirrors at 90°', latex: 'n = \\frac{360}{90} - 1 = 3', context: '3 images formed', neet_frequency: 'high' },
          { name: 'Parallel mirrors', latex: 'n = \\infty', context: 'Infinite images (θ → 0)', neet_frequency: 'medium' },
        ],
        specialCases: [
          'If 360/θ is odd, n depends on object position',
      ...
      },
      {
        ...
        variables: [
          { symbol: 'L_min', meaning: 'Minimum mirror length', unit: 'm', typical_values: 'Half of height' },
          { symbol: 'h', meaning: 'Height of person', unit: 'm', typical_values: '1.5-2 m' },
        ],
        derivedFrom: 'plane-mirror-image',
        applications: [
          { name: 'Top edge position', latex: 'y_{top} = \\frac{H_{eye} + H_{head}}{2}', context: 'Top of mirror at midpoint of eye-head', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Independent of distance from mirror',
          'Mirror must be properly positioned (bottom at midpoint of eye-foot)',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Find number of images in inclined mirrors', difficulty: 'easy' },
      { type: 'numerical', description: 'Image velocity problems', difficulty: 'medium' },
      { type: 'conceptual', description: 'Properties of image in plane mirror', difficulty: 'easy' },
      { type: 'numerical', description: 'Minimum mirror size calculations', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Number of images in inclined mirrors', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022] },
      { pattern: 'Image velocity problems', frequency: 'medium', yearAsked: [2019, 2021, 2023] },
      { pattern: 'Effect of mirror rotation', frequency: 'medium', yearAsked: [2018, 2020] },
    ],
  ...
  // Topic 2: Reflection from Spherical Mirror
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'v', meaning: 'Image distance from pole', unit: 'm', typical_values: '-∞ to +∞' },
          { symbol: 'u', meaning: 'Object distance from pole', unit: 'm', typical_values: 'Always -ve (object in front)' },
          { symbol: 'f', meaning: 'Focal length', unit: 'm', typical_values: '-ve for concave, +ve for convex' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Concave mirror image', latex: 'v = \\frac{uf}{u - f}', context: 'Finding image position', neet_frequency: 'high' },
          { name: 'At center of curvature', latex: 'u = v = 2f', context: 'Object at C gives image at C', neet_frequency: 'high' },
          { name: 'At focus', latex: 'v = \\infty', context: 'Object at focus, image at infinity', neet_frequency: 'medium' },
        ],
        specialCases: [
          'u = ∞: v = f (parallel rays converge at focus)',
          'u = f: v = ∞ (image at infinity)',
          'u = 2f: v = 2f (same size image at C)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'm', meaning: 'Magnification', unit: 'dimensionless', typical_values: 'Can be +ve or -ve' },
          { symbol: 'h\'', meaning: 'Image height', unit: 'm', typical_values: '+ve upward, -ve downward' },
          { symbol: 'h', meaning: 'Object height', unit: 'm', typical_values: '+ve (upward from axis)' },
        ],
        derivedFrom: 'mirror-formula',
        applications: [
          { name: 'Virtual image (convex)', latex: 'm = +\\frac{f}{f-u}', context: 'Always positive (erect)', neet_frequency: 'high' },
          { name: 'Real image (concave)', latex: 'm = -\\frac{v}{u}', context: 'Negative means inverted', neet_frequency: 'high' },
        ],
        specialCases: [
          '|m| > 1: magnified image',
      ...
      },
      {
        ...
        variables: [
          { symbol: 'R', meaning: 'Radius of curvature', unit: 'm', typical_values: '0.1-2 m' },
          { symbol: 'f', meaning: 'Focal length', unit: 'm', typical_values: 'R/2' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Find f from R', latex: 'f = \\frac{R}{2}', context: 'Given radius, find focal length', neet_frequency: 'high' },
        ],
        specialCases: [
          'Valid only for paraxial rays (small aperture)',
          'For large aperture, spherical aberration occurs',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'P', meaning: 'Power of mirror', unit: 'D (diopter)', typical_values: '-5 to +5 D' },
          { symbol: 'f', meaning: 'Focal length', unit: 'm', typical_values: '0.1-2 m' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Concave mirror', latex: 'P = -\\frac{1}{|f|}', context: 'Negative power (converging)', neet_frequency: 'medium' },
          { name: 'Convex mirror', latex: 'P = +\\frac{1}{|f|}', context: 'Positive power (diverging)', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Concave: P < 0 (converging)',
          'Convex: P > 0 (diverging)',
          'Note: Sign opposite to lens convention',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Apply mirror formula for various positions', difficulty: 'medium' },
      { type: 'numerical', description: 'Find magnification and image characteristics', difficulty: 'medium' },
      { type: 'conceptual', description: 'Image formation for different object positions', difficulty: 'easy' },
      { type: 'graphical', description: 'Draw ray diagrams for spherical mirrors', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Mirror formula application', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022, 2023] },
      { pattern: 'Image characteristics (real/virtual, magnification)', frequency: 'high', yearAsked: [2018, 2019, 2021, 2022] },
      { pattern: 'Object at specific positions (F, C, infinity)', frequency: 'medium', yearAsked: [2019, 2020, 2023] },
    ],
  ...
  // Topic 3: Refraction from Plane Surface
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'n₁, n₂', meaning: 'Refractive indices of media', unit: 'dimensionless', typical_values: '1-2.5' },
          { symbol: 'θ₁', meaning: 'Angle of incidence', unit: 'degrees', typical_values: '0-90°' },
          { symbol: 'θ₂', meaning: 'Angle of refraction', unit: 'degrees', typical_values: '0-90°' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Relative refractive index', latex: '{}_{1}n_2 = \\frac{n_2}{n_1} = \\frac{\\sin\\theta_1}{\\sin\\theta_2}', context: 'RI of medium 2 w.r.t medium 1', neet_frequency: 'high' },
          { name: 'Normal incidence', latex: '\\theta_1 = \\theta_2 = 0', context: 'No bending when light enters normally', neet_frequency: 'medium' },
        ],
        specialCases: [
          'If n₂ > n₁: θ₂ < θ₁ (bends toward normal)',
          'If n₂ < n₁: θ₂ > θ₁ (bends away from normal)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'n', meaning: 'Refractive index', unit: 'dimensionless', typical_values: 'Water 1.33, Glass 1.5' },
          { symbol: 'c', meaning: 'Speed of light in vacuum', unit: 'm/s', typical_values: '3 × 10⁸ m/s' },
          { symbol: 'v', meaning: 'Speed of light in medium', unit: 'm/s', typical_values: 'c/n' },
          { symbol: 'λ₀, λ', meaning: 'Wavelength in vacuum and medium', unit: 'm', typical_values: 'λ = λ₀/n' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Speed in medium', latex: 'v = \\frac{c}{n}', context: 'Light slows in denser medium', neet_frequency: 'high' },
          { name: 'Wavelength in medium', latex: '\\lambda = \\frac{\\lambda_0}{n}', context: 'Wavelength decreases, frequency unchanged', neet_frequency: 'high' },
        ],
        specialCases: [
          'Frequency remains constant during refraction',
          'n ≥ 1 for all media (vacuum n = 1)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'd_app', meaning: 'Apparent depth', unit: 'm', typical_values: 'Less than real depth' },
          { symbol: 'd_real', meaning: 'Real depth', unit: 'm', typical_values: '0.1-10 m' },
          { symbol: 'n', meaning: 'Refractive index of denser medium', unit: 'dimensionless', typical_values: '1.33-1.5' },
        ],
        derivedFrom: 'snells-law',
        applications: [
          { name: 'Object in water', latex: 'd_{app} = \\frac{d_{real}}{1.33}', context: 'Object appears 1/1.33 of actual depth', neet_frequency: 'high' },
          { name: 'Shift of object', latex: '\\text{Shift} = d_{real}\\left(1 - \\frac{1}{n}\\right)', context: 'How much closer object appears', neet_frequency: 'high' },
        ],
        specialCases: [
          'Valid only for normal viewing (near-normal rays)',
          'Apparent depth < Real depth for n > 1',
        ],
        dimensionalCheck: '[d] = m',
      },
      {
        ...
        variables: [
          { symbol: 'd', meaning: 'Lateral shift', unit: 'm', typical_values: 'Few mm typically' },
          { symbol: 't', meaning: 'Thickness of slab', unit: 'm', typical_values: '0.001-0.1 m' },
          { symbol: 'i', meaning: 'Angle of incidence', unit: 'degrees', typical_values: '0-60°' },
          { symbol: 'r', meaning: 'Angle of refraction', unit: 'degrees', typical_values: 'Less than i in glass' },
        ],
        derivedFrom: 'snells-law',
        applications: [
          { name: 'Approximate formula', latex: 'd \\approx t \\cdot i \\cdot \\left(1 - \\frac{1}{n}\\right)', context: 'For small angles (in radians)', neet_frequency: 'medium' },
          { name: 'Maximum shift', latex: 'd_{max} = t', context: 'When i = 90° (grazing incidence)', neet_frequency: 'low' },
        ],
        specialCases: [
          'd = 0 for normal incidence (i = 0)',
          'Emergent ray parallel to incident ray (no net deviation)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'tᵢ', meaning: 'Thickness of ith slab', unit: 'm', typical_values: 'Individual thicknesses' },
          { symbol: 'nᵢ', meaning: 'RI of ith slab', unit: 'dimensionless', typical_values: '1.33-1.7' },
        ],
        derivedFrom: 'apparent-depth',
        applications: [
          { name: 'Two slabs', latex: '\\text{Shift} = t_1(1-1/n_1) + t_2(1-1/n_2)', context: 'Additive shifts', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Shifts add for multiple slabs',
          'Each slab contributes independently',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Apply Snell\'s law calculations', difficulty: 'medium' },
      { type: 'numerical', description: 'Apparent depth problems', difficulty: 'easy' },
      { type: 'numerical', description: 'Lateral shift in glass slab', difficulty: 'medium' },
      { type: 'conceptual', description: 'Direction of bending at interface', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Snell\'s law application', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022] },
      { pattern: 'Apparent depth calculation', frequency: 'high', yearAsked: [2019, 2020, 2022, 2023] },
      { pattern: 'Speed/wavelength change in refraction', frequency: 'medium', yearAsked: [2018, 2021, 2023] },
    ],
  ...
  // Topic 4: Total Internal Reflection
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'θc', meaning: 'Critical angle', unit: 'degrees', typical_values: '40-50° typically' },
          { symbol: 'n₁', meaning: 'RI of denser medium', unit: 'dimensionless', typical_values: '> 1' },
          { symbol: 'n₂', meaning: 'RI of rarer medium', unit: 'dimensionless', typical_values: '1 for air' },
          { symbol: 'n', meaning: 'Relative RI = n₁/n₂', unit: 'dimensionless', typical_values: '> 1' },
        ],
        derivedFrom: 'snells-law',
        applications: [
          { name: 'Glass-air interface', latex: '\\theta_c = \\sin^{-1}\\left(\\frac{1}{1.5}\\right) \\approx 42°', context: 'Critical angle for glass', neet_frequency: 'high' },
          { name: 'Water-air interface', latex: '\\theta_c = \\sin^{-1}\\left(\\frac{1}{1.33}\\right) \\approx 49°', context: 'Critical angle for water', neet_frequency: 'high' },
          { name: 'Diamond-air', latex: '\\theta_c = \\sin^{-1}\\left(\\frac{1}{2.4}\\right) \\approx 24°', context: 'Very small critical angle - why diamonds sparkle', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Higher n means smaller critical angle',
          'Exists only for denser to rarer transition',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'i', meaning: 'Angle of incidence', unit: 'degrees', typical_values: 'Must exceed θc' },
          { symbol: 'θc', meaning: 'Critical angle', unit: 'degrees', typical_values: '24-49° for common media' },
        ],
        derivedFrom: 'critical-angle',
        applications: [
          { name: 'Optical fiber', latex: 'i > \\theta_c \\text{ at core-cladding interface}', context: 'Light stays in fiber core', neet_frequency: 'high' },
          { name: 'Prism binoculars', latex: 'i = 45° > \\theta_c = 42°', context: 'TIR in 45-90-45 prism', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Both conditions necessary',
          'If n₁ < n₂, TIR impossible (no critical angle)',
        ],
        dimensionalCheck: '[angle] = degrees',
      },
      {
        ...
        variables: [
          { symbol: 'NA', meaning: 'Numerical aperture', unit: 'dimensionless', typical_values: '0.1-0.5' },
          { symbol: 'α', meaning: 'Acceptance angle (half-cone)', unit: 'degrees', typical_values: '5-30°' },
          { symbol: 'n₁', meaning: 'RI of core', unit: 'dimensionless', typical_values: '1.5-1.7' },
          { symbol: 'n₂', meaning: 'RI of cladding', unit: 'dimensionless', typical_values: 'Slightly less than n₁' },
        ],
        derivedFrom: 'snells-law',
        applications: [
          { name: 'Acceptance cone', latex: '2\\alpha = \\text{full acceptance angle}', context: 'Light within this cone enters fiber', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Larger NA means more light can enter',
    ...
    variations: [
      { type: 'numerical', description: 'Calculate critical angle for given media', difficulty: 'easy' },
      { type: 'conceptual', description: 'Identify conditions for TIR', difficulty: 'easy' },
      { type: 'application', description: 'Optical fiber and prism problems', difficulty: 'medium' },
      { type: 'numerical', description: 'Numerical aperture of optical fiber', difficulty: 'hard' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Critical angle calculation', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'Conditions for TIR to occur', frequency: 'high', yearAsked: [2019, 2020, 2021] },
      { pattern: 'Applications (optical fiber, prism)', frequency: 'medium', yearAsked: [2018, 2021, 2022] },
    ],
  ...
  // Topic 5: Lens and Lens Formula
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'v', meaning: 'Image distance from lens', unit: 'm', typical_values: '+ve for real, -ve for virtual' },
          { symbol: 'u', meaning: 'Object distance from lens', unit: 'm', typical_values: 'Always -ve (real object)' },
          { symbol: 'f', meaning: 'Focal length', unit: 'm', typical_values: '+ve for convex, -ve for concave' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Find image position', latex: 'v = \\frac{uf}{u+f}', context: 'Solving for v', neet_frequency: 'high' },
          { name: 'Object at infinity', latex: 'v = f', context: 'Parallel rays converge at focus', neet_frequency: 'high' },
          { name: 'Object at 2f', latex: 'v = 2f', context: 'Same size real image', neet_frequency: 'high' },
        ],
        specialCases: [
          'Note: Unlike mirror, formula is 1/v - 1/u (minus sign)',
          'Concave lens: v always -ve (virtual image)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'm', meaning: 'Linear magnification', unit: 'dimensionless', typical_values: 'Any value' },
          { symbol: 'h\'', meaning: 'Image height', unit: 'm', typical_values: '+ve erect, -ve inverted' },
          { symbol: 'h', meaning: 'Object height', unit: 'm', typical_values: '+ve (above axis)' },
        ],
        derivedFrom: 'thin-lens-formula',
        applications: [
          { name: 'Real image (convex)', latex: 'm < 0 \\text{ (inverted)}', context: 'When v and u have opposite signs', neet_frequency: 'high' },
          { name: 'Virtual image', latex: 'm > 0 \\text{ (erect)}', context: 'When v and u have same sign', neet_frequency: 'high' },
        ],
        specialCases: [
          'For lens: m = v/u (no negative sign, unlike mirror)',
          '|m| = 1 when object at 2f (for convex)',
        ],
        dimensionalCheck: 'Dimensionless',
      },
      {
        ...
        variables: [
          { symbol: 'f', meaning: 'Focal length', unit: 'm', typical_values: '0.1-1 m' },
          { symbol: 'n', meaning: 'Refractive index of lens material', unit: 'dimensionless', typical_values: '1.5 typically' },
          { symbol: 'R₁', meaning: 'Radius of first surface', unit: 'm', typical_values: '+ve for convex toward object' },
          { symbol: 'R₂', meaning: 'Radius of second surface', unit: 'm', typical_values: '-ve for convex away from object' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Equiconvex lens', latex: 'R_1 = R, R_2 = -R \\Rightarrow \\frac{1}{f} = \\frac{2(n-1)}{R}', context: 'Both surfaces same radius', neet_frequency: 'high' },
          { name: 'Plano-convex lens', latex: 'R_1 = R, R_2 = \\infty \\Rightarrow \\frac{1}{f} = \\frac{(n-1)}{R}', context: 'One flat surface', neet_frequency: 'high' },
        ],
        specialCases: [
          'Sign of R: +ve if center on right of surface, -ve if on left',
          'For convex lens: f > 0; for concave: f < 0',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'P', meaning: 'Power of lens', unit: 'D (diopter)', typical_values: '-10 to +10 D' },
          { symbol: 'f', meaning: 'Focal length', unit: 'm', typical_values: '0.1-1 m' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Combined lenses', latex: 'P_{total} = P_1 + P_2 + ...', context: 'Lenses in contact', neet_frequency: 'high' },
          { name: 'Convex lens', latex: 'P > 0', context: 'Converging, positive power', neet_frequency: 'high' },
          { name: 'Concave lens', latex: 'P < 0', context: 'Diverging, negative power', neet_frequency: 'high' },
        ],
        specialCases: [
          'Higher |P| = stronger lens',
          'Eye correction: myopia needs -ve P, hypermetropia needs +ve P',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'f_eq', meaning: 'Equivalent focal length', unit: 'm', typical_values: 'Combined effect' },
          { symbol: 'f₁, f₂', meaning: 'Individual focal lengths', unit: 'm', typical_values: 'Given values' },
        ],
        derivedFrom: 'lens-power',
        applications: [
          { name: 'Power addition', latex: 'P_{eq} = P_1 + P_2', context: 'Simpler form for power', neet_frequency: 'high' },
          { name: 'Separated lenses', latex: '\\frac{1}{f_{eq}} = \\frac{1}{f_1} + \\frac{1}{f_2} - \\frac{d}{f_1 f_2}', context: 'Lenses separated by distance d', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Achromatic doublet: f₁/f₂ = -ω₁/ω₂ (remove chromatic aberration)',
          'Lenses in contact are most common in NEET',
        ],
        dimensionalCheck: '[1/f] = m⁻¹',
      },
    ],
    ...
    variations: [
      { type: 'numerical', description: 'Apply lens formula for image formation', difficulty: 'medium' },
      { type: 'numerical', description: 'Lens maker\'s formula applications', difficulty: 'medium' },
      { type: 'numerical', description: 'Combination of lenses', difficulty: 'medium' },
      { type: 'conceptual', description: 'Power and focal length relations', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Lens formula application', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022, 2023] },
      { pattern: 'Power of lens combinations', frequency: 'high', yearAsked: [2019, 2020, 2021, 2022] },
      { pattern: 'Lens maker\'s formula', frequency: 'medium', yearAsked: [2018, 2020, 2023] },
    ],
  ...
  // Additional topics follow same pattern...
  // Topics 6-9 abbreviated for space
  
  // Topic 6: Newton's Formula
  {
    id: 'newtons-formula',
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'x₁', meaning: 'Object distance from F₁', unit: 'm', typical_values: 'Distance from focus' },
          { symbol: 'x₂', meaning: 'Image distance from F₂', unit: 'm', typical_values: 'Distance from focus' },
          { symbol: 'f', meaning: 'Focal length', unit: 'm', typical_values: '0.1-1 m' },
        ],
        derivedFrom: 'thin-lens-formula',
        applications: [
          { name: 'Find image position', latex: 'x_2 = \\frac{f^2}{x_1}', context: 'When object position from focus is known', neet_frequency: 'medium' },
          { name: 'Displacement method', latex: 'f = \\frac{D^2 - d^2}{4D}', context: 'Finding f using two image positions', neet_frequency: 'high' },
        ],
        specialCases: [
          'u = -f - x₁ and v = f + x₂ (converting to standard)',
          'Same formula for mirrors: x₁x₂ = f²',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Apply Newton\'s formula', difficulty: 'medium' },
      { type: 'numerical', description: 'Displacement method for focal length', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Displacement method formula', frequency: 'medium', yearAsked: [2018, 2020, 2022] },
    ],
  ...
  // Topic 7: Combination of Lens and Mirror
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'P_eq', meaning: 'Equivalent power', unit: 'D', typical_values: 'Combined effect' },
          { symbol: 'P_L', meaning: 'Power of lens', unit: 'D', typical_values: '1/f_L' },
          { symbol: 'P_M', meaning: 'Power of mirror', unit: 'D', typical_values: '1/f_M' },
        ],
        derivedFrom: 'lens-power',
        applications: [
          { name: 'Lens + plane mirror', latex: 'P_{eq} = \\frac{2}{f_L}', context: 'P_M = 0 for plane mirror', neet_frequency: 'high' },
          { name: 'Equivalent focal length', latex: 'f_{eq} = \\frac{1}{P_{eq}}', context: 'Acts as concave mirror usually', neet_frequency: 'high' },
        ],
        specialCases: [
          'System acts as a mirror (not lens)',
          'f_eq = f_L/2 for lens + plane mirror',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Find equivalent focal length of silvered lens', difficulty: 'medium' },
      { type: 'numerical', description: 'Image formation by lens-mirror combination', difficulty: 'hard' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Silvered lens equivalent power', frequency: 'high', yearAsked: [2018, 2019, 2021, 2022] },
      { pattern: 'Convex lens + plane mirror', frequency: 'medium', yearAsked: [2019, 2020, 2023] },
    ],
  ...
  // Topic 8: Dispersion of Light
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'ω', meaning: 'Dispersive power', unit: 'dimensionless', typical_values: '0.01-0.1' },
          { symbol: 'nᵥ', meaning: 'RI for violet', unit: 'dimensionless', typical_values: 'Highest' },
          { symbol: 'nᵣ', meaning: 'RI for red', unit: 'dimensionless', typical_values: 'Lowest' },
          { symbol: 'nᵧ', meaning: 'RI for yellow (mean)', unit: 'dimensionless', typical_values: 'Average n' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Angular dispersion', latex: '\\theta = (n_v - n_r)A', context: 'For small angle prism', neet_frequency: 'high' },
          { name: 'Mean deviation', latex: '\\delta = (n_y - 1)A', context: 'Deviation for yellow light', neet_frequency: 'high' },
        ],
        specialCases: [
          'Flint glass has higher ω than crown glass',
          'Used in designing achromatic combinations',
        ],
        dimensionalCheck: 'Dimensionless',
      },
      {
        ...
        variables: [
          { symbol: 'δ', meaning: 'Angle of deviation', unit: 'degrees/rad', typical_values: 'Few degrees' },
          { symbol: 'n', meaning: 'Refractive index', unit: 'dimensionless', typical_values: '1.5 typical' },
          { symbol: 'A', meaning: 'Angle of prism', unit: 'degrees/rad', typical_values: 'Small, < 10°' },
        ],
        derivedFrom: 'snells-law',
        applications: [
          { name: 'Minimum deviation', latex: 'n = \\frac{\\sin\\frac{A+\\delta_m}{2}}{\\sin\\frac{A}{2}}', context: 'For any prism at minimum deviation', neet_frequency: 'high' },
          { name: 'At minimum deviation', latex: 'i = e = \\frac{A+\\delta_m}{2}', context: 'Entry and exit angles equal', neet_frequency: 'high' },
        ],
        specialCases: [
          'Thin prism: δ independent of angle of incidence',
          'For thick prism, use full formula with minimum deviation',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'ω₁, ω₂', meaning: 'Dispersive powers', unit: 'dimensionless', typical_values: 'Different materials' },
          { symbol: 'A₁, A₂', meaning: 'Prism angles', unit: 'degrees', typical_values: 'Opposite orientations' },
        ],
        derivedFrom: 'dispersive-power',
        applications: [
          { name: 'Prism angles ratio', latex: '\\frac{A_1}{A_2} = -\\frac{\\omega_2}{\\omega_1}', context: 'Prisms in opposite orientation', neet_frequency: 'medium' },
          { name: 'Net deviation', latex: '\\delta_{net} = (n_1 - 1)A_1 + (n_2 - 1)A_2', context: 'Deviation without dispersion', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Prisms of different materials combined',
          'Crown and flint glass commonly used',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Calculate dispersive power', difficulty: 'easy' },
      { type: 'numerical', description: 'Deviation by thin prism', difficulty: 'medium' },
      { type: 'numerical', description: 'Minimum deviation problems', difficulty: 'medium' },
      { type: 'conceptual', description: 'Order of colors after dispersion', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Dispersive power calculation', frequency: 'medium', yearAsked: [2018, 2020, 2022] },
      { pattern: 'Minimum deviation formula', frequency: 'high', yearAsked: [2018, 2019, 2021, 2022] },
      { pattern: 'Order of colors/wavelength dependence', frequency: 'medium', yearAsked: [2019, 2020, 2023] },
    ],
  ...
  // Topic 9: Optical Instruments
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'M', meaning: 'Magnifying power', unit: 'dimensionless', typical_values: '2-10x' },
          { symbol: 'D', meaning: 'Least distance of distinct vision', unit: 'cm', typical_values: '25 cm' },
          { symbol: 'f', meaning: 'Focal length of lens', unit: 'cm', typical_values: '2-10 cm' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Image at infinity', latex: 'M = \\frac{D}{f}', context: 'Relaxed eye viewing', neet_frequency: 'high' },
        ],
        specialCases: [
          'Smaller f gives larger magnification',
      ...
      },
      {
        ...
        variables: [
          { symbol: 'M', meaning: 'Total magnifying power', unit: 'dimensionless', typical_values: '50-1000x' },
          { symbol: 'L', meaning: 'Tube length', unit: 'cm', typical_values: '15-20 cm' },
          { symbol: 'fo', meaning: 'Focal length of objective', unit: 'cm', typical_values: '0.5-2 cm (small)' },
          { symbol: 'fe', meaning: 'Focal length of eyepiece', unit: 'cm', typical_values: '2-5 cm' },
        ],
        derivedFrom: 'simple-microscope',
        applications: [
          { name: 'Image at D', latex: 'M = \\frac{L}{f_o}\\left(1 + \\frac{D}{f_e}\\right)', context: 'Maximum magnification', neet_frequency: 'high' },
        ],
        specialCases: [
          'Objective has small f (high magnification)',
          'Final image is virtual, inverted, magnified',
        ],
        dimensionalCheck: 'Dimensionless',
      },
      {
        ...
        variables: [
          { symbol: 'M', meaning: 'Magnifying power', unit: 'dimensionless', typical_values: '10-200x' },
          { symbol: 'fo', meaning: 'Focal length of objective', unit: 'cm', typical_values: '50-200 cm (large)' },
          { symbol: 'fe', meaning: 'Focal length of eyepiece', unit: 'cm', typical_values: '2-5 cm (small)' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Tube length (normal)', latex: 'L = f_o + f_e', context: 'Distance between lenses', neet_frequency: 'high' },
          { name: 'Image at D', latex: 'M = \\frac{f_o}{f_e}\\left(1 + \\frac{f_e}{D}\\right)', context: 'Maximum magnification', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Objective has large f (collects light from far objects)',
          'Final image is inverted (OK for astronomy)',
        ],
        dimensionalCheck: 'Dimensionless',
      },
    ],
    ...
    variations: [
      { type: 'numerical', description: 'Simple microscope magnification', difficulty: 'easy' },
      { type: 'numerical', description: 'Compound microscope problems', difficulty: 'medium' },
      { type: 'numerical', description: 'Telescope magnification and tube length', difficulty: 'medium' },
      { type: 'conceptual', description: 'Eye defects and corrections', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Telescope magnification calculation', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022] },
      { pattern: 'Microscope magnification', frequency: 'medium', yearAsked: [2019, 2021, 2023] },
      { pattern: 'Eye defects and lens power needed', frequency: 'medium', yearAsked: [2018, 2020, 2022] },
    ],
