...
export const mechanicalPropertiesFluidsTopics = [
  // Topic 1: Pressure and Pascal's Law
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'P', meaning: 'Pressure', unit: 'Pa or N/m²', typical_values: '10⁵ Pa (atm)' },
          { symbol: 'F', meaning: 'Force (perpendicular)', unit: 'N', typical_values: '1-10⁶ N' },
          { symbol: 'A', meaning: 'Area', unit: 'm²', typical_values: '10⁻⁴-1 m²' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Atmospheric pressure', latex: 'P_{atm} \\approx 10^5 \\text{ Pa}', context: 'Pressure of air at sea level', neet_frequency: 'high' },
          { name: 'Mercury barometer', latex: 'P_{atm} = \\rho_{Hg} g h = 76 \\text{ cm Hg}', context: 'Height of mercury column', neet_frequency: 'high' },
        ],
        specialCases: [
          'Pressure is scalar (acts equally in all directions in fluid)',
          '1 atm = 76 cm Hg = 10.3 m water column',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'P', meaning: 'Pressure at depth', unit: 'Pa', typical_values: '>P₀' },
          { symbol: 'P₀', meaning: 'Pressure at surface', unit: 'Pa', typical_values: '10⁵ Pa' },
          { symbol: 'ρ', meaning: 'Fluid density', unit: 'kg/m³', typical_values: '1000 kg/m³ (water)' },
          { symbol: 'h', meaning: 'Depth below surface', unit: 'm', typical_values: '0.1-100 m' },
        ],
        derivedFrom: 'pressure-formula',
        applications: [
          { name: 'Gauge pressure', latex: 'P_{gauge} = P - P_{atm} = \\rho gh', context: 'Pressure above atmospheric', neet_frequency: 'high' },
          { name: 'Absolute pressure', latex: 'P_{abs} = P_{atm} + \\rho gh', context: 'Total pressure', neet_frequency: 'high' },
          { name: 'Pressure difference', latex: '\\Delta P = \\rho g \\Delta h', context: 'Between two depths', neet_frequency: 'high' },
        ],
        specialCases: [
          'Pressure depends on depth, not container shape',
          'Same depth = same pressure (horizontal planes)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'F₁', meaning: 'Input force (small piston)', unit: 'N', typical_values: 'Small force' },
          { symbol: 'A₁', meaning: 'Small piston area', unit: 'm²', typical_values: 'Small area' },
          { symbol: 'F₂', meaning: 'Output force (large piston)', unit: 'N', typical_values: 'Large force' },
          { symbol: 'A₂', meaning: 'Large piston area', unit: 'm²', typical_values: 'Large area' },
        ],
        derivedFrom: 'pressure-formula',
        applications: [
          { name: 'Mechanical advantage', latex: 'MA = \\frac{F_2}{F_1} = \\frac{A_2}{A_1}', context: 'Force multiplication', neet_frequency: 'high' },
          { name: 'Distance trade-off', latex: 'd_1 A_1 = d_2 A_2', context: 'Work conservation', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Force multiplied, distance divided (work conserved)',
          'Pressure same throughout connected fluid',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Pressure at given depth', difficulty: 'easy' },
      { type: 'numerical', description: 'Hydraulic press force calculation', difficulty: 'medium' },
      { type: 'conceptual', description: 'Gauge vs absolute pressure', difficulty: 'easy' },
      { type: 'numerical', description: 'Barometer height problems', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Hydrostatic pressure calculation', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'Hydraulic press problems', frequency: 'medium', yearAsked: [2019, 2021, 2022] },
      { pattern: 'Atmospheric pressure and barometer', frequency: 'high', yearAsked: [2018, 2020, 2023] },
    ],
  ...
  // Topic 2: Buoyancy and Archimedes' Principle
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'F_b', meaning: 'Buoyant force', unit: 'N', typical_values: 'Up to weight of body' },
          { symbol: 'ρ_fluid', meaning: 'Fluid density', unit: 'kg/m³', typical_values: '1000 kg/m³ (water)' },
          { symbol: 'V_displaced', meaning: 'Volume of fluid displaced', unit: 'm³', typical_values: 'Submerged volume' },
        ],
        derivedFrom: 'hydrostatic-pressure',
        applications: [
          { name: 'Fully submerged', latex: 'F_b = \\rho_f g V_{object}', context: 'V_displaced = V_object', neet_frequency: 'high' },
          { name: 'Floating body', latex: 'F_b = mg = \\rho_f g V_{submerged}', context: 'Equilibrium', neet_frequency: 'high' },
          { name: 'Apparent weight', latex: 'W_{app} = W - F_b = (\\rho_{obj} - \\rho_f)gV', context: 'Weight in fluid', neet_frequency: 'high' },
        ],
        specialCases: [
          'In vacuum: F_b = 0',
          'In denser fluid: more buoyancy',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'V_sub', meaning: 'Submerged volume', unit: 'm³', typical_values: 'Part of total' },
          { symbol: 'V_total', meaning: 'Total volume', unit: 'm³', typical_values: 'Object volume' },
        ],
        derivedFrom: 'buoyant-force',
        applications: [
          { name: 'Ice in water', latex: '\\frac{V_{sub}}{V} = \\frac{917}{1000} \\approx 0.92', context: '92% submerged', neet_frequency: 'high' },
          { name: 'Wood in water', latex: '\\frac{V_{sub}}{V} = \\frac{\\rho_{wood}}{1000}', context: 'Depends on wood type', neet_frequency: 'medium' },
        ],
        specialCases: [
          'If ρ_obj = ρ_fluid: just submerged (neutral buoyancy)',
          'If ρ_obj > ρ_fluid: sinks',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'RD', meaning: 'Relative density', unit: 'dimensionless', typical_values: '0.5-20' },
          { symbol: 'W_air', meaning: 'Weight in air', unit: 'N', typical_values: 'True weight' },
          { symbol: 'W_water', meaning: 'Apparent weight in water', unit: 'N', typical_values: 'Less than W_air' },
        ],
        derivedFrom: 'buoyant-force',
        applications: [
          { name: 'Find density', latex: '\\rho = RD \\times 1000 \\text{ kg/m}^3', context: 'From relative density', neet_frequency: 'high' },
          { name: 'From weights', latex: 'RD = \\frac{W}{W - W_w} = \\frac{W}{\\text{loss in water}}', context: 'Experimental method', neet_frequency: 'medium' },
        ],
        specialCases: [
    ...
    variations: [
      { type: 'numerical', description: 'Calculate buoyant force', difficulty: 'easy' },
      { type: 'numerical', description: 'Fraction submerged for floating body', difficulty: 'medium' },
      { type: 'numerical', description: 'Apparent weight in fluid', difficulty: 'medium' },
      { type: 'numerical', description: 'Relative density from weights', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Buoyant force calculation', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'Fraction submerged problems', frequency: 'high', yearAsked: [2019, 2021, 2022] },
      { pattern: 'Apparent weight in liquid', frequency: 'medium', yearAsked: [2018, 2020, 2023] },
    ],
  ...
  // Topic 3: Fluid Flow and Continuity
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'A₁, A₂', meaning: 'Cross-sectional areas', unit: 'm²', typical_values: '10⁻⁴ to 1 m²' },
          { symbol: 'v₁, v₂', meaning: 'Flow velocities', unit: 'm/s', typical_values: '0.1 to 10 m/s' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Velocity ratio', latex: '\\frac{v_2}{v_1} = \\frac{A_1}{A_2}', context: 'Inverse proportionality', neet_frequency: 'high' },
          { name: 'Circular pipes', latex: '\\pi r_1^2 v_1 = \\pi r_2^2 v_2', context: 'v ∝ 1/r²', neet_frequency: 'high' },
        ],
        specialCases: [
          'Valid for incompressible, steady flow',
          'Narrower section = faster flow',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'Q', meaning: 'Volume flow rate', unit: 'm³/s', typical_values: '10⁻⁶ to 1 m³/s' },
          { symbol: 'A', meaning: 'Cross-sectional area', unit: 'm²', typical_values: '10⁻⁴ to 1 m²' },
          { symbol: 'v', meaning: 'Flow velocity', unit: 'm/s', typical_values: '0.1 to 10 m/s' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Mass flow rate', latex: '\\dot{m} = \\rho Q = \\rho A v', context: 'For compressible fluids', neet_frequency: 'medium' },
          { name: 'Time to fill tank', latex: 't = \\frac{V}{Q}', context: 'V = volume of tank', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Q = constant along streamline (continuity)',
          '1 L/s = 10⁻³ m³/s',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'Re', meaning: 'Reynolds number', unit: 'dimensionless', typical_values: '100 to 10⁶' },
          { symbol: 'D', meaning: 'Characteristic dimension (diameter)', unit: 'm', typical_values: '0.01 to 1 m' },
          { symbol: 'η', meaning: 'Dynamic viscosity', unit: 'Pa·s', typical_values: '10⁻³ Pa·s (water)' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Laminar flow', latex: 'Re < 2000', context: 'Smooth, orderly flow', neet_frequency: 'medium' },
          { name: 'Turbulent flow', latex: 'Re > 3000', context: 'Chaotic, mixing flow', neet_frequency: 'medium' },
          { name: 'Critical velocity', latex: 'v_c = \\frac{2000 \\eta}{\\rho D}', context: 'Transition point', neet_frequency: 'medium' },
        ],
        specialCases: [
          '2000 < Re < 3000: transition region',
          'Higher viscosity favors laminar flow',
        ],
        dimensionalCheck: 'Dimensionless',
      },
    ],
    ...
    variations: [
      { type: 'numerical', description: 'Apply continuity equation', difficulty: 'easy' },
      { type: 'numerical', description: 'Calculate volume flow rate', difficulty: 'easy' },
      { type: 'numerical', description: 'Reynolds number calculation', difficulty: 'medium' },
      { type: 'conceptual', description: 'Identify laminar vs turbulent flow', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Continuity equation problems', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2023] },
      { pattern: 'Flow rate calculations', frequency: 'medium', yearAsked: [2019, 2022, 2023] },
      { pattern: 'Reynolds number and flow type', frequency: 'medium', yearAsked: [2018, 2020, 2022] },
    ],
  ...
  // Topic 4: Bernoulli's Principle
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'P', meaning: 'Static pressure', unit: 'Pa', typical_values: '10⁵ Pa' },
          { symbol: '½ρv²', meaning: 'Dynamic pressure', unit: 'Pa', typical_values: '0 to 10⁴ Pa' },
          { symbol: 'ρgh', meaning: 'Pressure head', unit: 'Pa', typical_values: 'Height dependent' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Horizontal flow', latex: 'P_1 + \\frac{1}{2}\\rho v_1^2 = P_2 + \\frac{1}{2}\\rho v_2^2', context: 'h constant', neet_frequency: 'high' },
          { name: 'At rest', latex: 'P_1 + \\rho g h_1 = P_2 + \\rho g h_2', context: 'v = 0 (hydrostatics)', neet_frequency: 'high' },
          { name: 'Pressure difference', latex: 'P_1 - P_2 = \\frac{1}{2}\\rho(v_2^2 - v_1^2)', context: 'Same height', neet_frequency: 'high' },
        ],
        specialCases: [
          'Each term has units of pressure (Pa)',
          'Sum is constant along streamline only',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'v', meaning: 'Efflux velocity', unit: 'm/s', typical_values: '1-20 m/s' },
          { symbol: 'h', meaning: 'Height of liquid above hole', unit: 'm', typical_values: '0.1-10 m' },
        ],
        derivedFrom: 'bernoullis-equation',
        applications: [
          { name: 'Range of liquid jet', latex: 'R = v \\times t = 2\\sqrt{h(H-h)}', context: 'Horizontal distance', neet_frequency: 'high' },
          { name: 'Maximum range', latex: 'R_{max} = H \\text{ when } h = H/2', context: 'Hole at mid-height', neet_frequency: 'high' },
          { name: 'Time to empty', latex: 't = \\frac{A}{a}\\sqrt{\\frac{2H}{g}}', context: 'A=tank area, a=hole area', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Same as free fall from height h',
          'Valid for small hole (A_hole << A_tank)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'ΔP', meaning: 'Pressure difference', unit: 'Pa', typical_values: '10²-10⁴ Pa' },
          { symbol: 'A₁, A₂', meaning: 'Wide and narrow areas', unit: 'm²', typical_values: 'A₂ < A₁' },
        ],
        derivedFrom: 'bernoullis-equation',
        applications: [
          { name: 'Venturi meter', latex: 'Q = A_2 \\sqrt{\\frac{2\\Delta P}{\\rho(1-(A_2/A_1)^2)}}', context: 'Flow rate measurement', neet_frequency: 'medium' },
          { name: 'Atomizer/spray', latex: '', context: 'Fast air creates low P, draws liquid up', neet_frequency: 'low' },
        ],
        specialCases: [
          'Pressure lowest at narrowest point',
      ...
      },
      {
        ...
        variables: [
          { symbol: 'F', meaning: 'Lift force', unit: 'N', typical_values: 'Equals weight for level flight' },
          { symbol: 'A', meaning: 'Wing area', unit: 'm²', typical_values: '10-500 m²' },
        ],
        derivedFrom: 'bernoullis-equation',
        applications: [
          { name: 'Pressure difference', latex: 'P_{bottom} - P_{top} = \\frac{1}{2}\\rho(v_t^2 - v_b^2)', context: 'Higher v on top', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Curved top = faster flow = lower pressure',
    ...
    variations: [
      { type: 'numerical', description: 'Apply Bernoulli equation', difficulty: 'medium' },
      { type: 'numerical', description: 'Torricelli efflux velocity', difficulty: 'easy' },
      { type: 'numerical', description: 'Range of liquid jet', difficulty: 'medium' },
      { type: 'conceptual', description: 'Explain lift on airplane', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: "Bernoulli's equation problems", frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022, 2023] },
      { pattern: "Torricelli's theorem", frequency: 'high', yearAsked: [2019, 2020, 2022, 2023] },
      { pattern: 'Range of efflux liquid', frequency: 'medium', yearAsked: [2018, 2021, 2022] },
    ],
  ...
  // Topic 5: Viscosity
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'F', meaning: 'Viscous force', unit: 'N', typical_values: '10⁻⁶ to 1 N' },
          { symbol: 'η', meaning: 'Coefficient of viscosity', unit: 'Pa·s', typical_values: '10⁻³ (water) to 1 (honey)' },
          { symbol: 'A', meaning: 'Contact area between layers', unit: 'm²', typical_values: '10⁻⁴ to 1 m²' },
          { symbol: 'dv/dx', meaning: 'Velocity gradient', unit: 's⁻¹', typical_values: '1 to 10³ s⁻¹' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Shear stress', latex: '\\tau = \\eta \\frac{dv}{dx}', context: 'Force per unit area', neet_frequency: 'medium' },
          { name: 'Viscosity formula', latex: '\\eta = \\frac{F}{A(dv/dx)}', context: 'Definition', neet_frequency: 'high' },
        ],
        specialCases: [
          'η ∝ T (gases), η ∝ 1/T (liquids)',
          'Ideal fluid has η = 0',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'F', meaning: 'Drag force', unit: 'N', typical_values: 'Opposes motion' },
          { symbol: 'r', meaning: 'Radius of sphere', unit: 'm', typical_values: '10⁻⁶ to 10⁻² m' },
          { symbol: 'v', meaning: 'Velocity of sphere', unit: 'm/s', typical_values: '10⁻³ to 1 m/s' },
        ],
        derivedFrom: 'newtons-viscosity',
        applications: [
          { name: 'Terminal velocity', latex: 'v_t = \\frac{2r^2(\\rho_s - \\rho_f)g}{9\\eta}', context: 'Falling sphere', neet_frequency: 'high' },
          { name: 'Rising bubble', latex: 'v_t = \\frac{2r^2(\\rho_f - \\rho_b)g}{9\\eta}', context: 'ρ_b < ρ_f', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Valid for slow, laminar flow (Re < 1)',
          'F ∝ r (not r²)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'v_t', meaning: 'Terminal velocity', unit: 'm/s', typical_values: '10⁻³ to 10 m/s' },
          { symbol: 'ρ_s', meaning: 'Sphere density', unit: 'kg/m³', typical_values: '1000-8000 kg/m³' },
          { symbol: 'ρ_f', meaning: 'Fluid density', unit: 'kg/m³', typical_values: '1000 kg/m³ (water)' },
        ],
        derivedFrom: 'stokes-law',
        applications: [
          { name: 'Proportionality', latex: 'v_t \\propto r^2', context: 'Larger sphere falls faster', neet_frequency: 'high' },
          { name: 'In denser fluid', latex: 'v_t \\downarrow', context: 'Buoyancy increases', neet_frequency: 'medium' },
        ],
        specialCases: [
          'At terminal velocity: weight = buoyancy + drag',
          'If ρ_s < ρ_f: sphere rises (v_t negative)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'Q', meaning: 'Volume flow rate', unit: 'm³/s', typical_values: '10⁻⁶ to 10⁻³ m³/s' },
          { symbol: 'P', meaning: 'Pressure difference', unit: 'Pa', typical_values: '10² to 10⁵ Pa' },
          { symbol: 'r', meaning: 'Pipe radius', unit: 'm', typical_values: '10⁻³ to 10⁻¹ m' },
          { symbol: 'L', meaning: 'Pipe length', unit: 'm', typical_values: '0.1 to 10 m' },
        ],
        derivedFrom: 'newtons-viscosity',
        applications: [
          { name: 'Flow rate proportionality', latex: 'Q \\propto r^4', context: 'Strong dependence on radius', neet_frequency: 'high' },
          { name: 'Fluid resistance', latex: 'R = \\frac{8\\eta L}{\\pi r^4}', context: 'Like electrical resistance', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Q ∝ r⁴ (halving radius → 16× less flow)',
          'Used in blood flow analysis',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Calculate terminal velocity', difficulty: 'medium' },
      { type: 'numerical', description: 'Apply Stokes law', difficulty: 'easy' },
      { type: 'numerical', description: 'Poiseuille flow rate', difficulty: 'medium' },
      { type: 'conceptual', description: 'Factors affecting viscosity', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Terminal velocity calculation', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: "Stokes' law problems", frequency: 'high', yearAsked: [2019, 2021, 2022] },
      { pattern: 'Poiseuille equation (Q ∝ r⁴)', frequency: 'medium', yearAsked: [2018, 2020, 2023] },
    ],
  ...
  // Topic 6: Surface Tension
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'T', meaning: 'Surface tension', unit: 'N/m', typical_values: '0.02-0.07 N/m' },
          { symbol: 'F', meaning: 'Force along surface', unit: 'N', typical_values: '10⁻⁵ to 10⁻² N' },
          { symbol: 'L', meaning: 'Length of surface', unit: 'm', typical_values: 'cm to m' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Force on wire', latex: 'F = 2TL', context: 'Wire pulling soap film (2 surfaces)', neet_frequency: 'high' },
          { name: 'Surface energy', latex: 'E = T \\times A', context: 'Energy = T × area', neet_frequency: 'high' },
          { name: 'Work to increase area', latex: 'W = T \\Delta A', context: 'Creating new surface', neet_frequency: 'high' },
        ],
        specialCases: [
          'T decreases with temperature',
          'Soap reduces T (surfactant effect)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'ΔP', meaning: 'Excess pressure inside', unit: 'Pa', typical_values: '10-1000 Pa' },
          { symbol: 'R', meaning: 'Radius of drop/bubble', unit: 'm', typical_values: '10⁻³ to 10⁻² m' },
        ],
        derivedFrom: 'surface-tension-formula',
        applications: [
          { name: 'Liquid drop in air', latex: '\\Delta P = \\frac{2T}{R}', context: 'One surface', neet_frequency: 'high' },
          { name: 'Soap bubble in air', latex: '\\Delta P = \\frac{4T}{R}', context: 'Two surfaces (inside + outside)', neet_frequency: 'high' },
          { name: 'Air bubble in liquid', latex: '\\Delta P = \\frac{2T}{R}', context: 'One surface', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Smaller drop/bubble = higher internal pressure',
          'Why small bubbles merge into larger ones',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'h', meaning: 'Capillary rise', unit: 'm', typical_values: '1-10 cm' },
          { symbol: 'θ', meaning: 'Contact angle', unit: 'degrees', typical_values: '0° (water-glass) to 140° (mercury-glass)' },
          { symbol: 'r', meaning: 'Tube radius', unit: 'm', typical_values: '0.1-1 mm' },
        ],
        derivedFrom: 'surface-tension-formula',
        applications: [
          { name: 'Water in glass (θ ≈ 0°)', latex: 'h = \\frac{2T}{\\rho gr}', context: 'Rises, concave meniscus', neet_frequency: 'high' },
          { name: 'Mercury in glass (θ ≈ 140°)', latex: 'h = \\frac{2T\\cos 140°}{\\rho gr} < 0', context: 'Depresses, convex meniscus', neet_frequency: 'medium' },
          { name: 'Proportionality', latex: 'h \\propto \\frac{1}{r}', context: 'Narrower tube = higher rise', neet_frequency: 'high' },
        ],
        specialCases: [
          'h > 0 for θ < 90° (wetting), h < 0 for θ > 90° (non-wetting)',
      ...
      },
      {
        ...
        variables: [
          { symbol: 'W', meaning: 'Work done', unit: 'J', typical_values: '10⁻⁸ to 10⁻⁵ J' },
          { symbol: 'A', meaning: 'Surface area', unit: 'm²', typical_values: '4πR²' },
        ],
        derivedFrom: 'surface-tension-formula',
        applications: [
          { name: 'Splitting drop', latex: 'W = 4\\pi T(nR_2^2 - R_1^2)', context: 'One → many drops', neet_frequency: 'medium' },
          { name: 'Coalescing drops', latex: 'W = 4\\pi T(R_3^2 - R_1^2 - R_2^2)', context: 'Energy released (negative W)', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Splitting releases energy if area decreases',
          'Surface energy = work stored',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Excess pressure in drop/bubble', difficulty: 'easy' },
      { type: 'numerical', description: 'Capillary rise calculation', difficulty: 'medium' },
      { type: 'numerical', description: 'Work to form drops', difficulty: 'medium' },
      { type: 'conceptual', description: 'Meniscus shape and contact angle', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Excess pressure in bubble/drop', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2023] },
      { pattern: 'Capillary rise problems', frequency: 'high', yearAsked: [2019, 2020, 2022, 2023] },
      { pattern: 'Surface energy and work', frequency: 'medium', yearAsked: [2018, 2021, 2022] },
    ],
