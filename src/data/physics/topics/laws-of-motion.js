...
export const lawsOfMotionTopics = [
  // Topic 1: Newton's First Law and Inertia
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'F_net', meaning: 'Net external force', unit: 'N', typical_values: '0 for equilibrium' },
          { symbol: 'a', meaning: 'Acceleration', unit: 'm/s²', typical_values: '0 for constant velocity' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Static equilibrium', latex: '\\vec{v} = 0, \\vec{a} = 0', context: 'Object at rest', neet_frequency: 'high' },
          { name: 'Dynamic equilibrium', latex: '\\vec{v} = \\text{const}, \\vec{a} = 0', context: 'Constant velocity motion', neet_frequency: 'high' },
        ],
        specialCases: [
          'Equilibrium can be static (v=0) or dynamic (v=const)',
          'First law defines what "no force" means',
        ],
    ...
    variations: [
      { type: 'conceptual', description: 'Inertia comparisons', difficulty: 'easy' },
      { type: 'conceptual', description: 'Inertial vs non-inertial frames', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Inertia concepts', frequency: 'medium', yearAsked: [2018, 2020, 2022] },
      { pattern: 'Identifying inertial frames', frequency: 'low', yearAsked: [2019] },
    ],
  ...
  // Topic 2: Newton's Second Law
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'F', meaning: 'Net external force', unit: 'N', typical_values: '1-1000 N typically' },
          { symbol: 'm', meaning: 'Mass', unit: 'kg', typical_values: '0.1-100 kg typically' },
          { symbol: 'a', meaning: 'Acceleration', unit: 'm/s²', typical_values: '0-10 m/s² typically' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Component form', latex: 'F_x = ma_x, F_y = ma_y', context: 'Apply in each direction', neet_frequency: 'high' },
          { name: 'Weight', latex: 'W = mg', context: 'Force due to gravity', neet_frequency: 'high' },
        ],
        specialCases: [
          'F = 0 ⟹ a = 0 (first law)',
      ...
      },
      {
        ...
        variables: [
          { symbol: 'p', meaning: 'Momentum', unit: 'kg⋅m/s', typical_values: 'p = mv' },
        ],
        derivedFrom: 'second-law',
        applications: [
          { name: 'Constant mass', latex: 'F = m\\frac{dv}{dt} = ma', context: 'Reduces to F = ma', neet_frequency: 'high' },
          { name: 'Variable mass (rocket)', latex: 'F = m\\frac{dv}{dt} + v\\frac{dm}{dt}', context: 'Rocket equation', neet_frequency: 'low' },
        ],
        specialCases: [
          'More fundamental than F = ma',
          'Valid for variable mass systems',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Direct F = ma problems', difficulty: 'easy' },
      { type: 'numerical', description: 'Multiple forces on body', difficulty: 'medium' },
      { type: 'numerical', description: 'Connected bodies', difficulty: 'hard' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Net force calculations', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022, 2023] },
      { pattern: 'Momentum-impulse relation', frequency: 'high', yearAsked: [2019, 2020, 2022] },
    ],
  ...
  // Topic 3: Newton's Third Law
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'F_AB', meaning: 'Force on A by B', unit: 'N', typical_values: 'Depends on interaction' },
          { symbol: 'F_BA', meaning: 'Force on B by A', unit: 'N', typical_values: 'Equal magnitude to F_AB' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Normal force', latex: 'N_{ground on block} = -N_{block on ground}', context: 'Contact force pair', neet_frequency: 'high' },
          { name: 'Gravitational', latex: 'F_{Earth on apple} = -F_{apple on Earth}', context: 'Gravitational pair', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Always true, even for accelerating systems',
          'Pairs don\'t cancel - they\'re on different bodies',
        ],
    ...
    variations: [
      { type: 'conceptual', description: 'Identify action-reaction pairs', difficulty: 'easy' },
      { type: 'conceptual', description: 'Explain motion using third law', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Identifying action-reaction pairs', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021] },
      { pattern: 'Horse-cart paradox', frequency: 'medium', yearAsked: [2020, 2022] },
    ],
  ...
  // Topic 4: Free Body Diagrams
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'ΣFx', meaning: 'Sum of x-components', unit: 'N', typical_values: '0 for equilibrium' },
          { symbol: 'ΣFy', meaning: 'Sum of y-components', unit: 'N', typical_values: '0 for equilibrium' },
        ],
        derivedFrom: 'second-law',
        applications: [
          { name: 'On horizontal surface', latex: 'N = mg', context: 'Vertical equilibrium', neet_frequency: 'high' },
          { name: 'On incline', latex: 'N = mg\\cos\\theta', context: 'Perpendicular to incline', neet_frequency: 'high' },
        ],
        specialCases: [
          'For equilibrium: a = 0, so ΣF = 0',
    ...
    variations: [
      { type: 'diagrammatic', description: 'Draw FBD for given situation', difficulty: 'easy' },
      { type: 'numerical', description: 'Calculate forces using FBD', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'FBD analysis', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022, 2023] },
      { pattern: 'Force identification', frequency: 'high', yearAsked: [2019, 2020, 2022] },
    ],
  ...
  // Topic 5: Friction
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'fs', meaning: 'Static friction', unit: 'N', typical_values: '0 to μsN' },
          { symbol: 'μs', meaning: 'Coefficient of static friction', unit: 'dimensionless', typical_values: '0.1 to 1.0' },
          { symbol: 'N', meaning: 'Normal force', unit: 'N', typical_values: 'Depends on weight and other forces' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Maximum static friction', latex: 'f_{s,max} = \\mu_s N', context: 'Just before sliding', neet_frequency: 'high' },
          { name: 'Angle of repose', latex: '\\tan\\theta = \\mu_s', context: 'Incline angle for impending slip', neet_frequency: 'high' },
        ],
        specialCases: [
          'fs is self-adjusting (matches applied force up to max)',
          'fs can be zero if no tendency to slide',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'fk', meaning: 'Kinetic friction', unit: 'N', typical_values: 'Constant once sliding' },
          { symbol: 'μk', meaning: 'Coefficient of kinetic friction', unit: 'dimensionless', typical_values: '0.1 to 0.8' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Deceleration due to friction', latex: 'a = \\mu_k g', context: 'Sliding on horizontal surface', neet_frequency: 'high' },
          { name: 'Stopping distance', latex: 's = \\frac{v^2}{2\\mu_k g}', context: 'From v² = 2as', neet_frequency: 'high' },
        ],
        specialCases: [
          'fk is constant (doesn\'t depend on velocity)',
          'μk < μs always',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'λ', meaning: 'Angle of friction', unit: 'degrees', typical_values: 'tan⁻¹(μ)' },
        ],
        derivedFrom: 'static-friction',
        applications: [
          { name: 'Angle of repose', latex: '\\theta_{repose} = \\tan^{-1}(\\mu_s)', context: 'Max incline angle without sliding', neet_frequency: 'high' },
        ],
        specialCases: [
          'Angle of repose = Angle of friction',
          'If incline angle > angle of repose, block slides',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Calculate friction force', difficulty: 'easy' },
      { type: 'numerical', description: 'Motion on rough incline', difficulty: 'medium' },
      { type: 'numerical', description: 'Angle of repose problems', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Static vs kinetic friction', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022, 2023] },
      { pattern: 'Angle of repose', frequency: 'high', yearAsked: [2019, 2020, 2022] },
      { pattern: 'Motion on rough incline', frequency: 'high', yearAsked: [2018, 2021, 2023] },
    ],
  ...
  // Topic 6: Motion on Inclined Plane
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'θ', meaning: 'Incline angle', unit: 'degrees', typical_values: '15° to 60°' },
        ],
        derivedFrom: 'second-law',
        applications: [
          { name: 'With friction (down)', latex: 'a = g(\\sin\\theta - \\mu_k\\cos\\theta)', context: 'Moving down rough incline', neet_frequency: 'high' },
          { name: 'With friction (up)', latex: 'a = g(\\sin\\theta + \\mu_k\\cos\\theta)', context: 'Retardation when moving up', neet_frequency: 'high' },
        ],
        specialCases: [
          'a = 0 when θ = angle of repose (impending motion)',
          'a is same for all masses (like free fall)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'N', meaning: 'Normal force', unit: 'N', typical_values: 'Less than mg' },
        ],
        derivedFrom: 'equilibrium-conditions',
        applications: [
          { name: 'Friction on incline', latex: 'f = \\mu mg\\cos\\theta', context: 'Friction depends on N', neet_frequency: 'high' },
        ],
        specialCases: [
          'N decreases as θ increases',
          'N = 0 when θ = 90° (vertical surface)',
          'N = mg when θ = 0° (horizontal)',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Acceleration on incline', difficulty: 'medium' },
      { type: 'numerical', description: 'Time to slide down incline', difficulty: 'medium' },
      { type: 'numerical', description: 'Minimum angle for motion', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Acceleration on rough incline', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022] },
      { pattern: 'Condition for motion on incline', frequency: 'medium', yearAsked: [2019, 2021] },
    ],
  ...
  // Topic 7: Tension in Strings
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'a', meaning: 'Acceleration of system', unit: 'm/s²', typical_values: 'Less than g' },
          { symbol: 'm₁', meaning: 'Heavier mass', unit: 'kg', typical_values: 'm₁ > m₂' },
          { symbol: 'm₂', meaning: 'Lighter mass', unit: 'kg', typical_values: 'm₂ < m₁' },
        ],
        derivedFrom: 'second-law',
        applications: [
          { name: 'Tension in string', latex: 'T = \\frac{2m_1m_2g}{m_1 + m_2}', context: 'Common tension in Atwood machine', neet_frequency: 'high' },
        ],
        specialCases: [
          'If m₁ = m₂: a = 0, T = mg',
          'If m₂ = 0: a = g (free fall)',
          'T is always between m₁g and m₂g',
        ],
        dimensionalCheck: '[a] = [g] = m/s²',
      },
      {
        ...
        variables: [
          { symbol: 'x₁, x₂', meaning: 'Positions of connected masses', unit: 'm', typical_values: 'Variable' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Simple pulley', latex: 'a_1 = a_2 = a', context: 'Same magnitude acceleration', neet_frequency: 'high' },
          { name: 'Movable pulley', latex: 'a_1 = 2a_2', context: 'Pulley moves with mass', neet_frequency: 'medium' },
        ],
        specialCases: [
          'For movable pulley, constraint changes',
          'Acceleration constraint from differentiating length constraint twice',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Atwood machine problems', difficulty: 'medium' },
      { type: 'numerical', description: 'Block-pulley systems', difficulty: 'medium' },
      { type: 'numerical', description: 'Multiple pulley systems', difficulty: 'hard' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Atwood machine', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'Block-pulley on table', frequency: 'high', yearAsked: [2019, 2021, 2022] },
    ],
  ...
  // Topic 8: Apparent Weight and Lift Problems
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: "W'", meaning: 'Apparent weight', unit: 'N', typical_values: 'More or less than mg' },
          { symbol: 'a', meaning: 'Acceleration of lift', unit: 'm/s²', typical_values: '1-3 m/s² for elevators' },
        ],
        derivedFrom: 'second-law',
        applications: [
          { name: 'Going up (or slowing while going down)', latex: "W' = m(g + a)", context: 'Feel heavier', neet_frequency: 'high' },
          { name: 'Going down (or slowing while going up)', latex: "W' = m(g - a)", context: 'Feel lighter', neet_frequency: 'high' },
          { name: 'Free fall', latex: "W' = 0", context: 'Weightlessness', neet_frequency: 'high' },
        ],
        specialCases: [
          'Constant velocity: apparent = actual weight',
          'a = g: apparent weight = 0',
          'a > g: person would float (lose contact)',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Apparent weight calculation', difficulty: 'easy' },
      { type: 'conceptual', description: 'Direction of motion vs acceleration', difficulty: 'medium' },
      { type: 'numerical', description: 'Spring scale reading in lift', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Apparent weight in accelerating lift', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022] },
      { pattern: 'Weightlessness condition', frequency: 'medium', yearAsked: [2019, 2021] },
    ],
  ...
  // Topic 9: Connected Bodies and Constraint Motion
  {
    id: 'connected-bodies',
    ...
    formulas: [
      {
        ...
        derivedFrom: null,
        applications: [
          { name: 'Simple pulley', latex: 'a_1 + a_2 = 0 \\text{ (opposite directions)}', context: 'One up, other down', neet_frequency: 'high' },
          { name: 'Movable pulley', latex: 'a_P = \\frac{a_1 + a_2}{2}', context: 'Pulley acceleration is average', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Differentiate length equation twice for acceleration constraint',
          'Account for pulley motion if pulley moves',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Two-body pulley systems', difficulty: 'medium' },
      { type: 'numerical', description: 'Block on table with hanging mass', difficulty: 'medium' },
      { type: 'numerical', description: 'Complex pulley arrangements', difficulty: 'hard' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Block-pulley on table', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022] },
      { pattern: 'Movable pulley problems', frequency: 'medium', yearAsked: [2019, 2021, 2023] },
    ],
  ...
  // Topic 10: Pseudo Forces
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'F_pseudo', meaning: 'Pseudo force', unit: 'N', typical_values: 'Depends on frame acceleration' },
          { symbol: 'a₀', meaning: 'Acceleration of reference frame', unit: 'm/s²', typical_values: 'Frame\'s acceleration' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'In accelerating train', latex: 'F_{pseudo} = ma_{train}', context: 'Backward force felt', neet_frequency: 'high' },
          { name: 'Centrifugal force', latex: 'F = m\\omega^2 r', context: 'In rotating frame, outward', neet_frequency: 'high' },
        ],
        specialCases: [
          'No reaction to pseudo force',
          'Direction opposite to frame\'s acceleration',
          'Disappears if you switch to inertial frame',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Motion in accelerating frame', difficulty: 'medium' },
      { type: 'conceptual', description: 'Identify pseudo forces', difficulty: 'medium' },
      { type: 'numerical', description: 'Equilibrium in non-inertial frame', difficulty: 'hard' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Pseudo force in accelerating lift/train', frequency: 'medium', yearAsked: [2019, 2020, 2022] },
      { pattern: 'Centrifugal force problems', frequency: 'medium', yearAsked: [2018, 2021] },
    ],
