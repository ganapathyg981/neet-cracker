...
export const movingChargesMagnetismTopics = [
  // Topic 1: Biot-Savart Law
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'dB', meaning: 'Magnetic field element', unit: 'T', typical_values: 'μT to mT' },
          { symbol: 'μ₀', meaning: 'Permeability of free space', unit: 'T·m/A', typical_values: '4π × 10⁻⁷' },
          { symbol: 'I', meaning: 'Current', unit: 'A', typical_values: '1-10 A' },
          { symbol: 'dl', meaning: 'Current element length', unit: 'm', typical_values: 'Infinitesimal' },
          { symbol: 'θ', meaning: 'Angle between dl and r', unit: 'rad', typical_values: '0 to π' },
          { symbol: 'r', meaning: 'Distance from element', unit: 'm', typical_values: 'cm to m' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Straight wire', latex: 'B = \\frac{\\mu_0 I}{2\\pi r}', context: 'Infinite straight wire', neet_frequency: 'high' },
          { name: 'At center of loop', latex: 'B = \\frac{\\mu_0 I}{2R}', context: 'Circular loop radius R', neet_frequency: 'high' },
          { name: 'On axis of loop', latex: 'B = \\frac{\\mu_0 IR^2}{2(R^2 + x^2)^{3/2}}', context: 'At distance x from center', neet_frequency: 'medium' },
        ],
        specialCases: [
          'dB = 0 when θ = 0 or π (along the wire)',
          'dB maximum when θ = 90°',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'B', meaning: 'Magnetic field', unit: 'T', typical_values: 'μT to mT' },
          { symbol: 'r', meaning: 'Perpendicular distance', unit: 'm', typical_values: 'cm to m' },
          { symbol: 'α, β', meaning: 'Angles from ends to point', unit: 'rad', typical_values: '0 to π/2' },
        ],
        derivedFrom: 'biot-savart',
        applications: [
          { name: 'Infinite wire', latex: 'B = \\frac{\\mu_0 I}{2\\pi r}', context: 'α = β = π/2', neet_frequency: 'high' },
          { name: 'Semi-infinite wire', latex: 'B = \\frac{\\mu_0 I}{4\\pi r}', context: 'One end at the point', neet_frequency: 'medium' },
        ],
        specialCases: [
    ...
    variations: [
      { type: 'numerical', description: 'Field due to straight wire', difficulty: 'easy' },
      { type: 'numerical', description: 'Field at center/axis of loop', difficulty: 'medium' },
      { type: 'conceptual', description: 'Direction of magnetic field', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Field due to infinite straight wire', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022] },
      { pattern: 'Field at center of circular loop', frequency: 'high', yearAsked: [2019, 2020, 2022, 2023] },
    ],
  ...
  // Topic 2: Magnetic Field Due to Current Carrying Ring
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'B', meaning: 'Magnetic field', unit: 'T', typical_values: 'μT to mT' },
          { symbol: 'I', meaning: 'Current', unit: 'A', typical_values: '1-10 A' },
          { symbol: 'R', meaning: 'Radius of loop', unit: 'm', typical_values: 'cm to m' },
        ],
        derivedFrom: 'biot-savart',
        applications: [
          { name: 'N turn coil', latex: 'B = \\frac{\\mu_0 NI}{2R}', context: 'Coil of N turns', neet_frequency: 'high' },
          { name: 'Two coils (same direction)', latex: 'B_{net} = B_1 + B_2', context: 'Add for parallel currents', neet_frequency: 'medium' },
        ],
        specialCases: [
          'B ∝ I, B ∝ 1/R',
          'Double current → double field',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'x', meaning: 'Distance from center on axis', unit: 'm', typical_values: '0 to several R' },
        ],
        derivedFrom: 'biot-savart',
        applications: [
          { name: 'At x = 0', latex: 'B = \\frac{\\mu_0 I}{2R}', context: 'Reduces to center formula', neet_frequency: 'high' },
          { name: 'Far from loop (x >> R)', latex: 'B \\approx \\frac{\\mu_0 IR^2}{2x^3} = \\frac{\\mu_0 m}{2\\pi x^3}', context: 'Dipole field', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Field along axis only (by symmetry)',
          'Decreases as 1/x³ at large distance (dipole behavior)',
        ],
        dimensionalCheck: '[B] = T',
      },
      {
        ...
        variables: [
          { symbol: 'm', meaning: 'Magnetic moment', unit: 'A·m²', typical_values: '10⁻³ to 1 A·m²' },
          { symbol: 'N', meaning: 'Number of turns', unit: 'dimensionless', typical_values: '1 to 1000' },
          { symbol: 'I', meaning: 'Current', unit: 'A', typical_values: '1-10 A' },
          { symbol: 'A', meaning: 'Area of loop', unit: 'm²', typical_values: 'cm² to m²' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Torque in field', latex: '\\tau = mB\\sin\\theta', context: 'Torque on loop in magnetic field', neet_frequency: 'high' },
          { name: 'Potential energy', latex: 'U = -mB\\cos\\theta = -\\vec{m} \\cdot \\vec{B}', context: 'Energy of dipole', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Direction: perpendicular to loop (right-hand rule)',
          'm = IA for single loop',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Field at center of loop/coil', difficulty: 'easy' },
      { type: 'numerical', description: 'Field on axis at given distance', difficulty: 'medium' },
      { type: 'numerical', description: 'Magnetic moment and torque', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Field at center of N-turn coil', frequency: 'high', yearAsked: [2018, 2019, 2021, 2022, 2023] },
      { pattern: 'Field on axis of loop', frequency: 'medium', yearAsked: [2019, 2020, 2022] },
      { pattern: 'Magnetic moment calculation', frequency: 'medium', yearAsked: [2018, 2021, 2023] },
    ],
  ...
  // Topic 3: Ampere's Law
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: '∮B·dl', meaning: 'Line integral of B', unit: 'T·m', typical_values: 'μ₀I' },
          { symbol: 'I_enclosed', meaning: 'Current passing through loop', unit: 'A', typical_values: 'Total current linked' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Long straight wire', latex: 'B(2\\pi r) = \\mu_0 I \\Rightarrow B = \\frac{\\mu_0 I}{2\\pi r}', context: 'Circular Amperian loop', neet_frequency: 'high' },
        ],
        specialCases: [
          'Current not through loop contributes 0',
          'Sign of I: right-hand rule with loop direction',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'B', meaning: 'Magnetic field inside', unit: 'T', typical_values: 'mT to T' },
          { symbol: 'n', meaning: 'Turns per unit length', unit: 'turns/m', typical_values: '100-10000 turns/m' },
          { symbol: 'N', meaning: 'Total number of turns', unit: 'dimensionless', typical_values: '100-10000' },
          { symbol: 'L', meaning: 'Length of solenoid', unit: 'm', typical_values: '0.1-1 m' },
        ],
        derivedFrom: 'amperes-law',
        applications: [
          { name: 'With core', latex: 'B = \\mu_0 \\mu_r n I', context: 'Relative permeability μᵣ', neet_frequency: 'medium' },
          { name: 'At end of solenoid', latex: 'B = \\frac{\\mu_0 n I}{2}', context: 'Half of center value', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Field uniform inside (for long solenoid)',
          'Field ≈ 0 outside',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'B', meaning: 'Magnetic field', unit: 'T', typical_values: 'mT' },
          { symbol: 'N', meaning: 'Total number of turns', unit: 'dimensionless', typical_values: '100-10000' },
          { symbol: 'r', meaning: 'Radius from center of toroid', unit: 'm', typical_values: 'Inner to outer radius' },
        ],
        derivedFrom: 'amperes-law',
        applications: [
          { name: 'At mean radius', latex: 'B = \\frac{\\mu_0 N I}{2\\pi r_{mean}}', context: 'Average field value', neet_frequency: 'high' },
        ],
        specialCases: [
          'B = 0 outside toroid and in central hole',
          'Field confined within the coil',
        ],
        dimensionalCheck: '[B] = T',
      },
    ],
    ...
    variations: [
      { type: 'numerical', description: 'Field in solenoid', difficulty: 'easy' },
      { type: 'numerical', description: 'Field in toroid', difficulty: 'medium' },
      { type: 'conceptual', description: 'When to use Ampere\'s law', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Field inside solenoid', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'Field inside toroid', frequency: 'medium', yearAsked: [2019, 2021, 2022] },
    ],
  ...
  // Topic 4: Force on Moving Charge
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'F', meaning: 'Magnetic force', unit: 'N', typical_values: 'pN to N' },
          { symbol: 'q', meaning: 'Charge', unit: 'C', typical_values: 'e = 1.6 × 10⁻¹⁹ C' },
          { symbol: 'v', meaning: 'Velocity of charge', unit: 'm/s', typical_values: '10³ to 10⁸ m/s' },
          { symbol: 'B', meaning: 'Magnetic field', unit: 'T', typical_values: 'mT to T' },
          { symbol: 'θ', meaning: 'Angle between v and B', unit: 'rad', typical_values: '0 to π' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Perpendicular entry', latex: 'F = qvB', context: 'θ = 90°, maximum force', neet_frequency: 'high' },
          { name: 'Parallel entry', latex: 'F = 0', context: 'θ = 0° or 180°, no force', neet_frequency: 'medium' },
        ],
        specialCases: [
          'F = 0 for stationary charge (v = 0)',
          'F perpendicular to v: no work done',
          'Negative charge: force opposite to v × B',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'r', meaning: 'Radius of circular path', unit: 'm', typical_values: 'mm to m' },
          { symbol: 'm', meaning: 'Mass of particle', unit: 'kg', typical_values: 'me = 9.1 × 10⁻³¹ kg' },
        ],
        derivedFrom: 'lorentz-force-magnetic',
        applications: [
          { name: 'Time period', latex: 'T = \\frac{2\\pi m}{qB}', context: 'Independent of v!', neet_frequency: 'high' },
          { name: 'Frequency', latex: 'f = \\frac{qB}{2\\pi m}', context: 'Cyclotron frequency', neet_frequency: 'high' },
          { name: 'Angular velocity', latex: '\\omega = \\frac{qB}{m}', context: 'Cyclotron angular frequency', neet_frequency: 'medium' },
        ],
        specialCases: [
          'r ∝ v: faster particles make larger circles',
          'T independent of v: all particles take same time per revolution',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'K', meaning: 'Kinetic energy', unit: 'J or eV', typical_values: 'eV to MeV' },
        ],
        derivedFrom: 'circular-motion-charge',
        applications: [
          { name: 'From K = ½mv²', latex: 'r = \\frac{\\sqrt{2mK}}{qB}', context: 'When K is given instead of v', neet_frequency: 'high' },
          { name: 'For accelerated particles', latex: 'K = qV, \\text{ so } r = \\frac{\\sqrt{2mqV}}{qB}', context: 'Particle accelerated through V', neet_frequency: 'high' },
        ],
        specialCases: [
          'r ∝ √K for same particle',
          'r ∝ √m for same K',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Force on moving charge', difficulty: 'easy' },
      { type: 'numerical', description: 'Radius and time period of circular motion', difficulty: 'medium' },
      { type: 'conceptual', description: 'Work done by magnetic force', difficulty: 'easy' },
      { type: 'numerical', description: 'Cyclotron frequency and radius', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Radius of circular path', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'Time period (independence of v)', frequency: 'high', yearAsked: [2019, 2020, 2021, 2022] },
      { pattern: 'Comparison of different particles', frequency: 'medium', yearAsked: [2018, 2021, 2023] },
    ],
  ...
  // Topics 5-8 follow similar pattern - abbreviated for space
  {
    id: 'lorentz-force',
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'F', meaning: 'Total force', unit: 'N', typical_values: 'Sum of both' },
          { symbol: 'E', meaning: 'Electric field', unit: 'V/m', typical_values: '10³ to 10⁶ V/m' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Velocity selector', latex: 'v = \\frac{E}{B}', context: 'For undeflected path', neet_frequency: 'high' },
        ],
        specialCases: [
          'If E = 0: only magnetic force',
          'If v = 0: only electric force',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Velocity selector calculation', difficulty: 'medium' },
      { type: 'conceptual', description: 'Cyclotron operation', difficulty: 'medium' },
    ],
    mostAskedPatterns: [
      { pattern: 'Velocity selector v = E/B', frequency: 'high', yearAsked: [2018, 2019, 2021, 2022] },
    ],
    analogies: [],
    questions: [],
  },

  // Topic 6: Force on Current-Carrying Conductor
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'F', meaning: 'Force on conductor', unit: 'N', typical_values: '10⁻³ to 10 N' },
          { symbol: 'B', meaning: 'Magnetic field strength', unit: 'T', typical_values: '0.01-1 T' },
          { symbol: 'I', meaning: 'Current in conductor', unit: 'A', typical_values: '1-10 A' },
          { symbol: 'L', meaning: 'Length of conductor in field', unit: 'm', typical_values: '0.1-1 m' },
          { symbol: 'θ', meaning: 'Angle between I and B', unit: 'rad', typical_values: '0 to π' },
        ],
        derivedFrom: 'lorentz-force-magnetic',
        applications: [
          { name: 'Perpendicular field', latex: 'F = BIL', context: 'θ = 90°, maximum force', neet_frequency: 'high' },
          { name: 'Force per unit length', latex: 'f = BI', context: 'Force per meter of conductor', neet_frequency: 'medium' },
        ],
        specialCases: [
          'F = 0 when conductor parallel to B (θ = 0°)',
      ...
      },
      {
        ...
        variables: [
          { symbol: 'F/L', meaning: 'Force per unit length', unit: 'N/m', typical_values: '10⁻⁶ to 10⁻³ N/m' },
          { symbol: 'I₁, I₂', meaning: 'Currents in wires', unit: 'A', typical_values: '1-10 A' },
          { symbol: 'd', meaning: 'Distance between wires', unit: 'm', typical_values: '0.01-1 m' },
        ],
        derivedFrom: 'force-conductor',
        applications: [
          { name: 'Definition of Ampere', latex: 'F/L = 2 \\times 10^{-7} \\text{ N/m}', context: 'When I₁ = I₂ = 1 A, d = 1 m', neet_frequency: 'high' },
          { name: 'Same direction currents', latex: 'F = \\text{attractive}', context: 'Wires attract each other', neet_frequency: 'high' },
          { name: 'Opposite direction currents', latex: 'F = \\text{repulsive}', context: 'Wires repel each other', neet_frequency: 'high' },
        ],
        specialCases: [
          'Same direction → attract (like poles attract in magnetism!)',
          'Opposite direction → repel',
          'F ∝ 1/d (inverse with distance)',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Force on wire in magnetic field', difficulty: 'easy' },
      { type: 'numerical', description: 'Force between parallel wires', difficulty: 'medium' },
      { type: 'conceptual', description: 'Direction of force using hand rules', difficulty: 'easy' },
      { type: 'numerical', description: 'Definition of Ampere problems', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Force on wire in magnetic field', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'Force between parallel wires', frequency: 'high', yearAsked: [2019, 2021, 2022] },
      { pattern: 'Attraction/repulsion of parallel currents', frequency: 'medium', yearAsked: [2018, 2020, 2023] },
    ],
  ...
  // Topic 7: Torque on Current Loop and Magnetic Dipole
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'τ', meaning: 'Torque on loop', unit: 'N·m', typical_values: '10⁻⁶ to 10⁻² N·m' },
          { symbol: 'N', meaning: 'Number of turns', unit: 'dimensionless', typical_values: '1-1000' },
          { symbol: 'I', meaning: 'Current in loop', unit: 'A', typical_values: '0.01-10 A' },
          { symbol: 'A', meaning: 'Area of loop', unit: 'm²', typical_values: '10⁻⁴ to 10⁻² m²' },
          { symbol: 'B', meaning: 'Magnetic field', unit: 'T', typical_values: '0.01-1 T' },
          { symbol: 'θ', meaning: 'Angle between m and B', unit: 'rad', typical_values: '0 to π' },
        ],
        derivedFrom: 'force-conductor',
        applications: [
          { name: 'Maximum torque', latex: '\\tau_{max} = NIAB', context: 'When θ = 90° (plane ∥ B)', neet_frequency: 'high' },
          { name: 'In terms of moment', latex: '\\vec{\\tau} = \\vec{m} \\times \\vec{B}', context: 'Vector form', neet_frequency: 'medium' },
        ],
        specialCases: [
          'θ = 0: τ = 0 (stable equilibrium)',
          'θ = 180°: τ = 0 (unstable equilibrium)',
          'τ tends to decrease θ (align m with B)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'U', meaning: 'Potential energy', unit: 'J', typical_values: '10⁻⁶ to 10⁻³ J' },
          { symbol: 'm', meaning: 'Magnetic moment', unit: 'A·m²', typical_values: '10⁻⁴ to 1 A·m²' },
        ],
        derivedFrom: 'torque-loop',
        applications: [
          { name: 'Stable position (θ = 0)', latex: 'U_{min} = -mB', context: 'm parallel to B', neet_frequency: 'high' },
          { name: 'Unstable position (θ = 180°)', latex: 'U_{max} = +mB', context: 'm anti-parallel to B', neet_frequency: 'medium' },
          { name: 'Work to rotate', latex: 'W = \\Delta U = mB(\\cos\\theta_1 - \\cos\\theta_2)', context: 'Work done by external agent', neet_frequency: 'high' },
        ],
        specialCases: [
          'U = 0 when θ = 90°',
          'ΔU = 2mB for complete flip (0 to 180°)',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Calculate torque on current loop', difficulty: 'medium' },
      { type: 'numerical', description: 'Potential energy calculations', difficulty: 'medium' },
      { type: 'numerical', description: 'Work done to rotate loop', difficulty: 'medium' },
      { type: 'conceptual', description: 'Stable and unstable equilibrium', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Torque on coil in magnetic field', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022, 2023] },
      { pattern: 'Work done to rotate coil', frequency: 'medium', yearAsked: [2019, 2020, 2022] },
      { pattern: 'Equilibrium positions and stability', frequency: 'medium', yearAsked: [2018, 2021, 2023] },
    ],
  ...
  // Topic 8: Moving Coil Galvanometer
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'θ', meaning: 'Angular deflection', unit: 'rad', typical_values: '0 to π/2' },
          { symbol: 'N', meaning: 'Number of turns', unit: 'dimensionless', typical_values: '10-1000' },
          { symbol: 'A', meaning: 'Area of coil', unit: 'm²', typical_values: '10⁻⁴ m²' },
          { symbol: 'B', meaning: 'Magnetic field', unit: 'T', typical_values: '0.1-0.5 T' },
          { symbol: 'k', meaning: 'Torsion constant', unit: 'N·m/rad', typical_values: '10⁻⁷ to 10⁻⁵' },
          { symbol: 'I', meaning: 'Current', unit: 'A', typical_values: 'μA to mA' },
        ],
        derivedFrom: 'torque-loop',
        applications: [
          { name: 'Current sensitivity', latex: 'S_I = \\frac{\\theta}{I} = \\frac{NAB}{k}', context: 'Deflection per ampere', neet_frequency: 'high' },
          { name: 'Voltage sensitivity', latex: 'S_V = \\frac{\\theta}{V} = \\frac{NAB}{kR}', context: 'Deflection per volt', neet_frequency: 'medium' },
        ],
        specialCases: [
          'θ ∝ I (linear relationship)',
          'Higher NAB/k = more sensitive',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'S', meaning: 'Shunt resistance', unit: 'Ω', typical_values: 'Very small, < G' },
          { symbol: 'G', meaning: 'Galvanometer resistance', unit: 'Ω', typical_values: '10-100 Ω' },
          { symbol: 'Ig', meaning: 'Full scale deflection current', unit: 'A', typical_values: 'mA' },
          { symbol: 'I', meaning: 'Desired ammeter range', unit: 'A', typical_values: '1-10 A' },
        ],
        derivedFrom: 'galvanometer-deflection',
        applications: [
          { name: 'For n times range', latex: 'S = \\frac{G}{n-1}', context: 'When I = nIg', neet_frequency: 'high' },
          { name: 'Effective resistance', latex: 'R_A = \\frac{SG}{S+G} \\approx S', context: 'Ammeter has low resistance', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Shunt in parallel with galvanometer',
          'Most current bypasses through shunt',
          'Ammeter must have very low resistance',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'R', meaning: 'Multiplier (high resistance)', unit: 'Ω', typical_values: 'kΩ to MΩ' },
          { symbol: 'V', meaning: 'Desired voltmeter range', unit: 'V', typical_values: '1-100 V' },
        ],
        derivedFrom: 'galvanometer-deflection',
        applications: [
          { name: 'For n times range', latex: 'R = (n-1)G', context: 'When V = nVg', neet_frequency: 'high' },
          { name: 'Effective resistance', latex: 'R_V = G + R', context: 'Voltmeter has high resistance', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Multiplier in series with galvanometer',
          'Limits current to Ig at full voltage',
    ...
    variations: [
      { type: 'numerical', description: 'Calculate shunt for ammeter conversion', difficulty: 'medium' },
      { type: 'numerical', description: 'Calculate multiplier for voltmeter', difficulty: 'medium' },
      { type: 'numerical', description: 'Current sensitivity problems', difficulty: 'easy' },
      { type: 'conceptual', description: 'Why radial field is used', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Shunt resistance calculation', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'Multiplier resistance calculation', frequency: 'high', yearAsked: [2019, 2020, 2021, 2022] },
      { pattern: 'Current/voltage sensitivity', frequency: 'medium', yearAsked: [2018, 2021, 2023] },
    ],
