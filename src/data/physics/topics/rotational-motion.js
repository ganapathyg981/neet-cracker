...
export const rotationalMotionTopics = [
      {
        ...
        formulas: [
          {
            ...
            variables: [
              ...
              },
              {
                ...
                unit: "kg",
                typical_values: "Point masses"
              },
              {
                symbol: "rᵢ",
                meaning: "Perpendicular distance from axis",
                unit: "m",
            ...
            derivedFrom: null,
            applications: [],
            specialCases: ["Point mass: I = mr²", "System of particles: Sum individual contributions"],
          ...
          },
          {
            ...
            applications: [],
            specialCases: ["All mass at distance R from axis", "Maximum MOI for given mass and radius"],
          ...
          },
          {
            ...
            variables: [
              {
                symbol: "M",
                meaning: "Mass of disc",
                unit: "kg",
                typical_values: "0.1-10 kg"
              },
              {
                symbol: "R",
                meaning: "Radius of disc",
                unit: "m",
                typical_values: "0.01-1 m"
              }
            ],
            derivedFrom: "moi-definition",
            applications: [],
            specialCases: ["Mass distributed from 0 to R", "Half of ring's MOI for same M and R"],
            dimensionalCheck: "[I] = kg·m²",
          },
          {
            id: "moi-solid-sphere",
            ...
            derivedFrom: "moi-definition",
            applications: [],
            specialCases: ["Same about any diameter (spherical symmetry)", "Less than disc due to mass distribution"],
            dimensionalCheck: "[I] = kg·m²",
          },
          {
            ...
            variables: [
              {
                symbol: "M",
                meaning: "Mass of shell",
                unit: "kg",
                typical_values: "0.1-10 kg"
              },
              {
                symbol: "R",
                meaning: "Radius of shell",
                unit: "m",
                typical_values: "0.01-1 m"
              }
            ],
            derivedFrom: "moi-definition",
            applications: [],
            specialCases: ["All mass at distance R from center", "Greater than solid sphere for same M, R"],
            dimensionalCheck: "[I] = kg·m²",
          },
          {
            ...
            variables: [
              {
                symbol: "M",
                meaning: "Mass of cylinder",
                unit: "kg",
                typical_values: "0.1-10 kg"
              },
              {
                symbol: "R",
                meaning: "Radius of cylinder",
                unit: "m",
                typical_values: "0.01-1 m"
              }
            ],
            derivedFrom: "moi-definition",
            applications: [],
            specialCases: ["Same as disc about central axis", "Length does not affect I about geometric axis"],
            dimensionalCheck: "[I] = kg·m²",
          },
          {
            id: "moi-rod-center",
            ...
            derivedFrom: "moi-definition",
            applications: [],
            specialCases: ["ML²/3 about end is 4 times ML²/12 about center", "Only length matters, not cross-section (thin rod)"],
            dimensionalCheck: "[I] = kg·m²",
          },
          {
            id: "two-particle-system",
            name: "Two particle system",
            category: "derived",
            formula: "I = m_1r_1^2 + m_2r_2^2",
            latex: "I = m_1r_1^2 + m_2r_2^2",
            description: "Two masses at different distances from axis",
            variables: [],
            derivedFrom: "moi-definition",
            applications: [],
            specialCases: [],
          ...
          {
            id: "ring-about-center",
            name: "Ring about center",
            category: "derived",
            formula: "I = MR^2",
            latex: "I = MR^2",
            description: "All mass at same distance R",
            variables: [],
            derivedFrom: "moi-definition",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "About diameter",
            category: "derived",
            formula: "I = \\frac{MR^2}{2}",
            latex: "I = \\frac{MR^2}{2}",
            description: "Ring about any diameter",
            variables: [],
            derivedFrom: "moi-ring",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[I] = kg·m²",
            neet_frequency: "high",
          ...
          {
            id: "about-tangent-in-plane",
            name: "About tangent (in plane)",
            category: "derived",
            formula: "I = \\frac{3MR^2}{2}",
            latex: "I = \\frac{3MR^2}{2}",
          ...
          {
            id: "about-tangent-perpendicular",
            name: "About tangent (perpendicular)",
            category: "derived",
            formula: "I = 2MR^2",
            latex: "I = 2MR^2",
            description: "Tangent perpendicular to plane",
            variables: [],
            derivedFrom: "moi-ring",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "About diameter",
            category: "derived",
            formula: "I = \\frac{MR^2}{4}",
            latex: "I = \\frac{MR^2}{4}",
            description: "Disc about any diameter",
            variables: [],
            derivedFrom: "moi-disc",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[I] = kg·m²",
            neet_frequency: "high",
          ...
          {
            id: "about-tangent-in-plane-2",
            name: "About tangent (in plane)",
            category: "derived",
            formula: "I = \\frac{5MR^2}{4}",
            latex: "I = \\frac{5MR^2}{4}",
            description: "Using parallel axis theorem",
            variables: [],
            derivedFrom: "moi-disc",
            applications: [],
          ...
          {
            id: "about-tangent-perpendicular-2",
            name: "About tangent (perpendicular)",
            category: "derived",
            formula: "I = \\frac{3MR^2}{2}",
            latex: "I = \\frac{3MR^2}{2}",
          ...
          },
          {
            ...
            name: "About tangent",
            category: "derived",
            formula: "I = \\frac{7}{5}MR^2",
            latex: "I = \\frac{7}{5}MR^2",
            description: "Using parallel axis theorem",
            variables: [],
            derivedFrom: "moi-solid-sphere",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[I] = kg·m²",
            neet_frequency: "high",
          ...
          {
            id: "rolling-on-incline",
            name: "Rolling on incline",
            category: "derived",
            formula: "I = \\frac{2}{5}MR^2",
            latex: "I = \\frac{2}{5}MR^2",
            description: "Used in rolling motion problems",
            variables: [],
            derivedFrom: "moi-solid-sphere",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "About tangent",
            category: "derived",
            formula: "I = \\frac{5}{3}MR^2",
            latex: "I = \\frac{5}{3}MR^2",
            description: "Using parallel axis theorem",
            variables: [],
            derivedFrom: "moi-hollow-sphere",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[I] = kg·m²",
            neet_frequency: "medium",
          ...
          {
            id: "about-diameter-at-center",
            name: "About diameter at center",
            category: "derived",
            formula: "I = \\frac{M}{4}\\left(R^2 + \\frac{L^2}{3}\\right)",
            latex: "I = \\frac{M}{4}\\left(R^2 + \\frac{L^2}{3}\\right)",
            description: "Perpendicular to length at center",
            variables: [],
            derivedFrom: "moi-solid-cylinder",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[I] = kg·m²",
            neet_frequency: "low",
        ...
        variations: [
          {
            type: "numerical",
            description: "Calculate MOI of standard shapes about given axis",
            difficulty: "easy"
          },
          {
            type: "numerical",
            description: "MOI of composite bodies (disc with hole, etc.)",
            difficulty: "hard"
          },
          {
            type: "conceptual",
            description: "Compare MOI of different shapes",
            difficulty: "medium"
          },
          {
            type: "numerical",
            description: "Apply parallel axis theorem",
            difficulty: "medium"
          },
          {
            type: "application",
            description: "MOI in rolling motion problems",
            difficulty: "hard"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "MOI of standard shapes (disc, ring, sphere)",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "Parallel axis theorem application",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "MOI of composite system",
            frequency: "medium",
            yearAsked: [2019, 2020, 2022]
          },
          {
            pattern: "Compare MOI about different axes",
            frequency: "medium",
      ...
      },
      {
        ...
        formulas: [
          {
            ...
            variables: [
              {
                symbol: "I",
                meaning: "MOI about given axis",
                unit: "kg·m²",
                typical_values: "Greater than I_cm"
              },
              {
                symbol: "I_cm",
                meaning: "MOI about parallel axis through CM",
                unit: "kg·m²",
              ...
              {
                symbol: "d",
                meaning: "Distance between parallel axes",
                unit: "m",
            ...
            derivedFrom: "moi-definition",
            applications: [],
            specialCases: ["Minimum MOI is always about axis through CM", "d = 0 gives I = I_cm (trivial case)"],
          ...
          },
          {
            ...
            variables: [
              {
                symbol: "I_z",
                meaning: "MOI about axis perpendicular to plane",
                unit: "kg·m²",
                typical_values: "Sum of I_x and I_y"
              },
              {
                symbol: "I_x, I_y",
                meaning: "MOI about axes in the plane",
                unit: "kg·m²",
                typical_values: "In-plane axes"
              }
            ],
            derivedFrom: "moi-definition",
            applications: [],
            specialCases: ["Only valid for 2D/planar/laminar bodies", "All three axes must pass through same point", "If I_x = I_y (symmetry), then I_z = 2I_x"],
            dimensionalCheck: "[I] = kg·m²",
          },
          {
            id: "rod-about-end",
            name: "Rod about end",
            category: "derived",
            formula: "I_{end} = \\frac{ML^2}{12} + M\\left(\\frac{L}{2}\\right)^2 = \\frac{ML^2}{3}",
            latex: "I_{end} = \\frac{ML^2}{12} + M\\left(\\frac{L}{2}\\right)^2 = \\frac{ML^2}{3}",
            description: "From center to end of rod",
            variables: [],
            derivedFrom: "parallel-axis",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[I] = [I_cm] + [M][d²] = kg·m²",
            neet_frequency: "high",
          ...
          {
            id: "disc-about-tangent",
            name: "Disc about tangent",
            category: "derived",
            formula: "I = \\frac{MR^2}{2} + MR^2 = \\frac{3MR^2}{2}",
            latex: "I = \\frac{MR^2}{2} + MR^2 = \\frac{3MR^2}{2}",
            description: "Tangent perpendicular to plane",
            variables: [],
            derivedFrom: "parallel-axis",
            applications: [],
          ...
          {
            id: "ring-about-tangent",
            name: "Ring about tangent",
            category: "derived",
            formula: "I = MR^2 + MR^2 = 2MR^2",
            latex: "I = MR^2 + MR^2 = 2MR^2",
            description: "Tangent perpendicular to plane",
            variables: [],
            derivedFrom: "parallel-axis",
            applications: [],
          ...
          {
            id: "ring-about-diameter",
            name: "Ring about diameter",
            category: "derived",
            formula: "I_{dia} = \\frac{I_z}{2} = \\frac{MR^2}{2}",
            latex: "I_{dia} = \\frac{I_z}{2} = \\frac{MR^2}{2}",
            description: "Since I_x = I_y by symmetry",
            variables: [],
            derivedFrom: "perpendicular-axis",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[I] = kg·m²",
            neet_frequency: "high",
          ...
          {
            id: "disc-about-diameter",
            name: "Disc about diameter",
            category: "derived",
            formula: "I_{dia} = \\frac{I_z}{2} = \\frac{MR^2}{4}",
            latex: "I_{dia} = \\frac{I_z}{2} = \\frac{MR^2}{4}",
            description: "Using I_z = MR²/2",
            variables: [],
            derivedFrom: "perpendicular-axis",
            applications: [],
            specialCases: [],
        ...
        variations: [
          {
            type: "numerical",
            description: "Apply parallel axis theorem to find MOI",
            difficulty: "medium"
          },
          {
            type: "numerical",
            description: "Apply perpendicular axis theorem for planar bodies",
            difficulty: "medium"
          },
          {
            type: "conceptual",
            description: "Identify when each theorem applies",
            difficulty: "easy"
          },
          {
            type: "numerical",
            description: "Combined use of both theorems",
            difficulty: "hard"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "Parallel axis theorem for rod, disc, ring",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "MOI about diameter using perpendicular axis theorem",
            frequency: "high",
            yearAsked: [
              2018,
              2020,
          ...
          {
            pattern: "Identify correct theorem to apply",
            frequency: "medium",
            yearAsked: [2019, 2022]
          }
        ],
      ...
      },
      {
        ...
        formulas: [
          {
            ...
            variables: [
              {
                ...
                unit: "m",
                typical_values: "Fraction of body dimensions"
              },
              {
                symbol: "I",
                meaning: "Moment of inertia",
                unit: "kg·m²",
                typical_values: "Standard MOI values"
              },
              {
                symbol: "M",
                meaning: "Total mass",
            ...
            derivedFrom: "moi-definition",
            applications: [],
            specialCases: ["k is independent of mass", "k depends only on geometry and axis"],
            ...
            variables: [
              {
                ...
                meaning: "Moment of inertia",
                unit: "kg·m²",
                typical_values: "Calculated value"
              },
              {
                symbol: "M",
                meaning: "Total mass",
              ...
              },
              {
                ...
                meaning: "Radius of gyration",
                unit: "m",
                typical_values: "Given or calculated"
              }
            ],
            derivedFrom: "radius-gyration-def",
            applications: [],
            specialCases: ["Same formula form as I = mr² for point mass", "k plays role of effective distance"],
          ...
          },
          {
            ...
            formula: "k = R",
            latex: "k = R",
            description: "Since I = MR², k = √(MR²/M) = R",
            variables: [],
            derivedFrom: "radius-gyration-def",
            applications: [],
            specialCases: [],
          ...
          {
            id: "disc-about-center",
            name: "Disc about center",
            category: "derived",
            formula: "k = \\frac{R}{\\sqrt{2}}",
            latex: "k = \\frac{R}{\\sqrt{2}}",
            description: "Since I = MR²/2",
            variables: [],
            derivedFrom: "radius-gyration-def",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Solid sphere",
            category: "derived",
            formula: "k = R\\sqrt{\\frac{2}{5}}",
            latex: "k = R\\sqrt{\\frac{2}{5}}",
            description: "Since I = 2MR²/5",
            variables: [],
            derivedFrom: "radius-gyration-def",
            applications: [],
            specialCases: [],
          ...
          {
            id: "rod-about-center",
            name: "Rod about center",
            category: "derived",
            formula: "k = \\frac{L}{\\sqrt{12}} = \\frac{L}{2\\sqrt{3}}",
            latex: "k = \\frac{L}{\\sqrt{12}} = \\frac{L}{2\\sqrt{3}}",
            description: "Since I = ML²/12",
            variables: [],
            derivedFrom: "radius-gyration-def",
            applications: [],
            specialCases: [],
          ...
          {
            id: "comparing-bodies",
            name: "Comparing bodies",
            category: "derived",
            formula: "\\frac{I_1}{I_2} = \\frac{M_1 k_1^2}{M_2 k_2^2}",
            latex: "\\frac{I_1}{I_2} = \\frac{M_1 k_1^2}{M_2 k_2^2}",
            description: "Ratio of MOI",
            variables: [],
            derivedFrom: "moi-from-k",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[I] = [M][k²] = kg·m²",
            neet_frequency: "medium",
        ...
        variations: [
          {
            type: "numerical",
            description: "Calculate k for given shape and axis",
            difficulty: "easy"
          },
          {
            type: "numerical",
            description: "Find MOI given k and M",
            difficulty: "easy"
          },
          {
            type: "conceptual",
            description: "Compare k for different bodies",
            difficulty: "medium"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "Calculate k for standard shapes",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "Ratio of k for different axes",
            frequency: "medium",
      ...
      },
      {
        ...
        formulas: [
          {
            ...
            variables: [
              {
                ...
                unit: "kg·m²/s",
                typical_values: "10⁻³ to 10² kg·m²/s"
              },
              {
                symbol: "I",
                meaning: "Moment of inertia",
                unit: "kg·m²",
                typical_values: "Standard values"
              },
              {
                symbol: "ω",
            ...
            derivedFrom: null,
            applications: [],
            specialCases: ["Direction along axis of rotation (right-hand rule)", "For multiple rotating parts: L_total = ΣIᵢωᵢ"],
          ...
          },
          {
            ...
            variables: [
              ...
              {
                symbol: "r",
                meaning: "Position vector from O",
                unit: "m",
                typical_values: "Distance from reference"
              },
              {
                symbol: "p",
            ...
            derivedFrom: null,
            applications: [],
            specialCases: ["L = 0 when particle moves toward/away from O (θ = 0 or π)", "L = mvr (maximum) when r ⊥ v"],
          ...
          },
          {
            ...
            variables: [
              {
                symbol: "I₁, I₂",
                meaning: "Initial and final MOI",
                unit: "kg·m²",
                typical_values: "Before and after change"
              },
              {
                symbol: "ω₁, ω₂",
                meaning: "Initial and final angular velocity",
                unit: "rad/s",
                typical_values: "Before and after"
              }
            ],
            derivedFrom: "angular-momentum-rigid",
            applications: [],
            specialCases: ["τ_ext = 0 is required condition", "Internal forces cannot change L"],
          ...
          },
          {
            ...
            variables: [
              {
                symbol: "τ",
                meaning: "Net external torque",
                unit: "N·m",
                typical_values: "1-100 N·m"
              },
              {
                symbol: "dL/dt",
                meaning: "Rate of change of L",
                unit: "kg·m²/s²",
            ...
            derivedFrom: null,
            applications: [],
            specialCases: ["τ = 0 implies L = constant (conservation)", "Analog of F = dp/dt in linear motion"],
          ...
          },
          {
            ...
            name: "Rotating disc",
            category: "derived",
            formula: "L = \\frac{1}{2}MR^2 \\omega",
            latex: "L = \\frac{1}{2}MR^2 \\omega",
            description: "Using I = MR²/2 for disc",
            variables: [],
            derivedFrom: "angular-momentum-rigid",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Rotating ring",
            category: "derived",
            formula: "L = MR^2 \\omega",
            latex: "L = MR^2 \\omega",
            description: "Using I = MR² for ring",
            variables: [],
            derivedFrom: "angular-momentum-rigid",
            applications: [],
            specialCases: [],
          ...
          {
            id: "particle-in-circular-motion",
            name: "Particle in circular motion",
            category: "derived",
            formula: "L = mvr",
            latex: "L = mvr",
            description: "When r ⊥ v (θ = 90°)",
            variables: [],
            derivedFrom: "angular-momentum-particle",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[L] = [m][v][r] = kg·m/s·m = kg·m²/s",
            neet_frequency: "high",
          ...
          {
            id: "particle-moving-in-straight-line",
            name: "Particle moving in straight line",
            category: "derived",
            formula: "L = mvd",
            latex: "L = mvd",
            description: "d = perpendicular distance from O to line",
            variables: [],
            derivedFrom: "angular-momentum-particle",
            applications: [],
            specialCases: [],
          ...
          {
            id: "spinning-skater",
            name: "Spinning skater",
            category: "derived",
            formula: "\\omega_2 = \\omega_1 \\frac{I_1}{I_2}",
            latex: "\\omega_2 = \\omega_1 \\frac{I_1}{I_2}",
            description: "ω increases when I decreases",
            variables: [],
            derivedFrom: "conservation-angular-momentum",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[I][ω] = kg·m²/s (constant)",
            neet_frequency: "high",
          ...
          {
            id: "rotating-platform-with-person",
            name: "Rotating platform with person",
            category: "derived",
            formula: "I_p\\omega_0 + I_m \\cdot 0 = (I_p + I_m)\\omega",
            latex: "I_p\\omega_0 + I_m \\cdot 0 = (I_p + I_m)\\omega",
            description: "Person jumps on rotating platform",
            variables: [],
            derivedFrom: "conservation-angular-momentum",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            formula: "\\tau = I\\alpha",
            latex: "\\tau = I\\alpha",
            description: "Since L = Iω, τ = I(dω/dt) = Iα",
            variables: [],
            derivedFrom: "torque-angular-momentum",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[τ] = [dL/dt] = kg·m²/s² = N·m",
            neet_frequency: "high",
          },
          {
            ...
            category: "derived",
            formula: "\\int \\tau \\, dt = \\Delta L",
            latex: "\\int \\tau \\, dt = \\Delta L",
            description: "Angular impulse equals change in L",
            variables: [],
            derivedFrom: "torque-angular-momentum",
            applications: [],
            specialCases: [],
        ...
        variations: [
          {
            type: "numerical",
            description: "Calculate L for rotating rigid body",
            difficulty: "easy"
          },
          {
            type: "numerical",
          ...
          {
            type: "numerical",
            description: "L of particle about external point",
            difficulty: "medium"
          },
          {
            type: "conceptual",
            description: "Conditions for L conservation",
            difficulty: "easy"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "Conservation of angular momentum problems",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "Angular momentum of rotating disc/ring",
            frequency: "high",
            yearAsked: [2019, 2020, 2022]
          },
          {
            pattern: "Spinning skater type problems",
            frequency: "medium",
            yearAsked: [2018, 2021, 2023]
          }
        ],
      ...
      },
      {
        ...
        formulas: [
          {
            ...
            variables: [
              {
                symbol: "v_cm",
                meaning: "Velocity of center of mass",
                unit: "m/s",
              ...
              },
              {
                ...
                meaning: "Angular velocity",
                unit: "rad/s",
                typical_values: "v_cm/R"
              },
              {
                symbol: "R",
                meaning: "Radius of rolling body",
                unit: "m",
                typical_values: "0.01-1 m"
              }
            ],
            derivedFrom: null,
            applications: [],
            specialCases: ["v_cm > ωR: forward slipping (skidding)", "v_cm < ωR: backward slipping (spinning)"],
          ...
          },
          {
            ...
            variables: [
              {
                ...
                unit: "J",
                typical_values: "Sum of both components"
              },
              {
                symbol: "M",
                meaning: "Mass of body",
                unit: "kg",
                typical_values: "0.1-10 kg"
              },
              {
                symbol: "v_cm",
                meaning: "Velocity of CM",
                unit: "m/s",
                typical_values: "1-10 m/s"
              },
              {
            ...
            applications: [],
            specialCases: ["KE_trans = ½Mv² and KE_rot = ½Iω²", "KE_rot/KE_total = k²/(k² + R²) = I/(I + MR²)"],
          ...
          },
          {
            ...
            variables: [
              {
                symbol: "a",
                meaning: "Acceleration of CM",
                unit: "m/s²",
                typical_values: "Less than g sin θ"
              },
              {
                symbol: "g",
                meaning: "Acceleration due to gravity",
                unit: "m/s²",
                typical_values: "9.8 or 10 m/s²"
              },
              {
                symbol: "θ",
                meaning: "Angle of incline",
                unit: "degrees/rad",
                typical_values: "15-45°"
              },
              {
                symbol: "I/MR²",
                meaning: "Geometric factor",
                unit: "dimensionless",
                typical_values: "2/5 to 1"
              }
            ],
            derivedFrom: "rolling-condition",
            applications: [],
            specialCases: ["Solid sphere has maximum a (reaches bottom first)", "Ring/hollow cylinder has minimum a (reaches last)", "Acceleration independent of mass and radius"],
          ...
          },
          {
            ...
            variables: [
              {
                symbol: "v",
                meaning: "Velocity at bottom",
                unit: "m/s",
                typical_values: "Less than √(2gh)"
              },
              {
                symbol: "h",
                meaning: "Height of incline",
                unit: "m",
                typical_values: "0.5-5 m"
              }
            ],
            derivedFrom: "rolling-ke",
            applications: [],
            specialCases: ["From energy conservation: Mgh = ½Mv²(1 + k²/R²)", "Sliding body (no rotation): v = √(2gh)"],
          ...
          },
          {
            ...
            variables: [
              {
                symbol: "f",
                meaning: "Friction force",
                unit: "N",
                typical_values: "Less than μN"
              },
              {
                symbol: "I/MR²",
                meaning: "Geometric factor",
            ...
            applications: [],
            specialCases: ["f must be less than μₛN = μₛMg cos θ for pure rolling", "Static friction acts, does no work at contact point"],
          ...
          },
          {
            ...
            category: "derived",
            formula: "\\omega = \\frac{v_{cm}}{R}",
            latex: "\\omega = \\frac{v_{cm}}{R}",
            description: "Finding ω from v",
            variables: [],
            derivedFrom: "rolling-condition",
            applications: [],
            specialCases: [],
          ...
          {
            id: "acceleration-condition",
            name: "Acceleration condition",
            category: "derived",
            formula: "a_{cm} = \\alpha R",
            latex: "a_{cm} = \\alpha R",
            description: "For pure rolling",
            variables: [],
            derivedFrom: "rolling-condition",
            applications: [],
            specialCases: [],
          ...
          {
            id: "discsolid-cylinder",
            name: "Disc/Solid cylinder",
            category: "derived",
            formula: "KE = \\frac{3}{4}Mv_{cm}^2",
            latex: "KE = \\frac{3}{4}Mv_{cm}^2",
            description: "k² = R²/2, so factor = 3/2",
            variables: [],
            derivedFrom: "rolling-ke",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Solid sphere",
            category: "derived",
            formula: "KE = \\frac{7}{10}Mv_{cm}^2",
            latex: "KE = \\frac{7}{10}Mv_{cm}^2",
            description: "k² = 2R²/5, so factor = 7/5",
            variables: [],
            derivedFrom: "rolling-ke",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Hollow sphere",
            category: "derived",
            formula: "KE = \\frac{5}{6}Mv_{cm}^2",
            latex: "KE = \\frac{5}{6}Mv_{cm}^2",
            description: "k² = 2R²/3, so factor = 5/3",
            variables: [],
            derivedFrom: "rolling-ke",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Solid sphere",
            category: "derived",
            formula: "a = \\frac{5g\\sin\\theta}{7}",
            latex: "a = \\frac{5g\\sin\\theta}{7}",
            description: "I/MR² = 2/5",
            variables: [],
            derivedFrom: "rolling-incline-acceleration",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Disc/Cylinder",
            category: "derived",
            formula: "a = \\frac{2g\\sin\\theta}{3}",
            latex: "a = \\frac{2g\\sin\\theta}{3}",
            description: "I/MR² = 1/2",
            variables: [],
            derivedFrom: "rolling-incline-acceleration",
            applications: [],
            specialCases: [],
          ...
          {
            id: "ringhollow-cylinder",
            name: "Ring/Hollow cylinder",
            category: "derived",
            formula: "a = \\frac{g\\sin\\theta}{2}",
            latex: "a = \\frac{g\\sin\\theta}{2}",
            description: "I/MR² = 1",
            variables: [],
            derivedFrom: "rolling-incline-acceleration",
            applications: [],
          ...
          },
          {
            ...
            name: "Hollow sphere",
            category: "derived",
            formula: "a = \\frac{3g\\sin\\theta}{5}",
            latex: "a = \\frac{3g\\sin\\theta}{5}",
            description: "I/MR² = 2/3",
            variables: [],
            derivedFrom: "rolling-incline-acceleration",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Solid sphere",
            category: "derived",
            formula: "v = \\sqrt{\\frac{10gh}{7}}",
            latex: "v = \\sqrt{\\frac{10gh}{7}}",
            description: "Fastest rolling body",
            variables: [],
            derivedFrom: "rolling-incline-velocity",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[v] = √[gh] = m/s",
            neet_frequency: "high",
          },
          {
            ...
            latex: "v = \\sqrt{\\frac{4gh}{3}}",
            description: "Intermediate speed",
            variables: [],
            derivedFrom: "rolling-incline-velocity",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            formula: "v = \\sqrt{gh}",
            latex: "v = \\sqrt{gh}",
            description: "Slowest rolling body",
            variables: [],
            derivedFrom: "rolling-incline-velocity",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Solid sphere",
            category: "derived",
            formula: "f = \\frac{2}{7}Mg\\sin\\theta",
            latex: "f = \\frac{2}{7}Mg\\sin\\theta",
            description: "Minimum friction among rolling bodies",
            variables: [],
          ...
          },
          {
            ...
            name: "Disc",
            category: "derived",
            formula: "f = \\frac{1}{3}Mg\\sin\\theta",
            latex: "f = \\frac{1}{3}Mg\\sin\\theta",
            description: "Intermediate friction",
            variables: [],
            derivedFrom: "rolling-friction",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Ring",
            category: "derived",
            formula: "f = \\frac{1}{2}Mg\\sin\\theta",
            latex: "f = \\frac{1}{2}Mg\\sin\\theta",
            description: "Maximum friction among rolling bodies",
            variables: [],
            derivedFrom: "rolling-friction",
            applications: [],
            specialCases: [],
        ...
        variations: [
          {
            type: "numerical",
            description: "KE of rolling body at given speed",
            difficulty: "easy"
          },
          {
            type: "numerical",
            description: "Acceleration on inclined plane",
            difficulty: "medium"
          },
          {
            type: "numerical",
            description: "Velocity at bottom of incline",
            difficulty: "medium"
          },
          {
            type: "conceptual",
            description: "Which body reaches bottom first?",
            difficulty: "easy"
          },
          {
            type: "numerical",
            description: "Minimum friction for pure rolling",
            difficulty: "hard"
          },
          {
            type: "conceptual",
            description: "Work done by friction in rolling",
            difficulty: "medium"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "Which body reaches bottom first?",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "Velocity at bottom of incline",
            frequency: "high",
            yearAsked: [2019, 2020, 2022]
          },
          {
            pattern: "Ratio of rotational to total KE",
            frequency: "medium",
            yearAsked: [2018, 2021, 2022]
          },
          {
            pattern: "Acceleration of rolling body on incline",
            frequency: "high",
      ...
      },
      {
        ...
        formulas: [
          {
            ...
            variables: [
              {
                symbol: "t",
                meaning: "Time to descend",
                unit: "s",
                typical_values: "1-10 s"
              },
              {
                symbol: "s",
                meaning: "Length of incline",
                unit: "m",
                typical_values: "1-10 m"
              },
              {
                symbol: "θ",
                meaning: "Angle of incline",
            ...
            derivedFrom: "rolling-incline-acceleration",
            applications: [],
            specialCases: ["Time ratio depends only on k²/R², not on mass or radius", "Solid sphere takes least time among common shapes"],
            ...
            variables: [
              {
                ...
                unit: "J",
                typical_values: "Fraction of total"
              },
              {
                symbol: "KE_total",
                meaning: "Total kinetic energy",
                unit: "J",
                typical_values: "Mgh at bottom"
              }
            ],
            derivedFrom: "rolling-ke",
            applications: [],
            specialCases: ["Higher I/MR² means more energy in rotation", "This energy \"diverted\" to rotation makes body slower"],
          ...
          },
          {
            ...
            variables: [
              {
                symbol: "μ_min",
                meaning: "Minimum friction coefficient",
                unit: "dimensionless",
            ...
            derivedFrom: "rolling-friction",
            applications: [],
            specialCases: ["If μ < μ_min, body will slip while rolling", "Ring needs maximum friction to roll without slipping"],
          ...
          },
          {
            ...
            name: "Solid sphere",
            category: "derived",
            formula: "t = \\sqrt{\\frac{14s}{5g\\sin\\theta}}",
            latex: "t = \\sqrt{\\frac{14s}{5g\\sin\\theta}}",
            description: "Shortest time (fastest)",
            variables: [],
            derivedFrom: "time-to-descend",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[t] = √([s]/[g]) = s",
            neet_frequency: "medium",
          },
          {
            ...
            name: "Ring",
            category: "derived",
            formula: "t = \\sqrt{\\frac{4s}{g\\sin\\theta}}",
            latex: "t = \\sqrt{\\frac{4s}{g\\sin\\theta}}",
            description: "Longest time (slowest)",
            variables: [],
            derivedFrom: "time-to-descend",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Ring",
            category: "derived",
            formula: "\\frac{KE_{rot}}{KE_{total}} = \\frac{1}{2}",
            latex: "\\frac{KE_{rot}}{KE_{total}} = \\frac{1}{2}",
            description: "Half energy is rotational",
            variables: [],
            derivedFrom: "ke-distribution",
            applications: [],
            specialCases: [],
            dimensionalCheck: "Dimensionless ratio",
            neet_frequency: "high",
          },
          {
            ...
            name: "Disc",
            category: "derived",
            formula: "\\frac{KE_{rot}}{KE_{total}} = \\frac{1}{3}",
            latex: "\\frac{KE_{rot}}{KE_{total}} = \\frac{1}{3}",
            description: "One-third rotational",
            variables: [],
            derivedFrom: "ke-distribution",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Solid sphere",
            category: "derived",
            formula: "\\frac{KE_{rot}}{KE_{total}} = \\frac{2}{7}",
            latex: "\\frac{KE_{rot}}{KE_{total}} = \\frac{2}{7}",
            description: "2/7 rotational",
            variables: [],
            derivedFrom: "ke-distribution",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Solid sphere",
            category: "derived",
            formula: "\\mu_{min} = \\frac{2}{7}\\tan\\theta",
            latex: "\\mu_{min} = \\frac{2}{7}\\tan\\theta",
            description: "Needs least friction",
            variables: [],
            derivedFrom: "minimum-friction-coefficient",
            applications: [],
            specialCases: [],
            dimensionalCheck: "Dimensionless",
            neet_frequency: "medium",
          },
          {
            ...
            name: "Disc",
            category: "derived",
            formula: "\\mu_{min} = \\frac{1}{3}\\tan\\theta",
            latex: "\\mu_{min} = \\frac{1}{3}\\tan\\theta",
            description: "Intermediate requirement",
            variables: [],
            derivedFrom: "minimum-friction-coefficient",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Ring",
            category: "derived",
            formula: "\\mu_{min} = \\frac{1}{2}\\tan\\theta",
            latex: "\\mu_{min} = \\frac{1}{2}\\tan\\theta",
            description: "Needs most friction",
            variables: [],
            derivedFrom: "minimum-friction-coefficient",
            applications: [],
            specialCases: [],
        ...
        variations: [
          {
            type: "conceptual",
            description: "Race between different rolling bodies",
            difficulty: "easy"
          },
          {
            type: "numerical",
            description: "Find velocity at bottom for given shape",
            difficulty: "medium"
          },
          {
            type: "numerical",
            description: "Calculate time to descend",
            difficulty: "medium"
          },
          {
            type: "numerical",
            description: "Find minimum μ for pure rolling",
            difficulty: "hard"
          },
          {
            type: "conceptual",
            description: "Effect of mass/radius on rolling race",
            difficulty: "medium"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "Which body wins rolling race?",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "Fraction of KE that is rotational",
            frequency: "medium",
