...
export const magnetismMatterTopics = [
  // Topic 1: Bar Magnet and Magnetic Dipole
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'm', meaning: 'Magnetic dipole moment', unit: 'A·m²', typical_values: '0.1-10 A·m²' },
          { symbol: 'qm', meaning: 'Pole strength', unit: 'A·m', typical_values: 'Depends on magnet' },
          { symbol: '2l', meaning: 'Magnetic length', unit: 'm', typical_values: '0.8-0.9 of geometric length' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Equivalent current loop', latex: 'm = NIA', context: 'Current loop equivalent to bar magnet', neet_frequency: 'high' },
          { name: 'Torque in field', latex: '\\tau = mB\\sin\\theta', context: 'Same as current loop', neet_frequency: 'high' },
        ],
        specialCases: [
          'Magnetic length ≈ 5/6 of geometric length',
          'm direction: S to N inside magnet',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'B_axial', meaning: 'Field on axis', unit: 'T', typical_values: 'μT to mT' },
          { symbol: 'r', meaning: 'Distance from center', unit: 'm', typical_values: 'r >> l for this formula' },
        ],
        derivedFrom: 'magnetic-dipole-moment',
        applications: [
          { name: 'Exact formula', latex: 'B = \\frac{\\mu_0}{4\\pi} \\frac{2mr}{(r^2-l^2)^2}', context: 'When r not >> l', neet_frequency: 'medium' },
          { name: 'Direction', latex: '\\text{Along } \\vec{m}', context: 'Same direction as dipole moment', neet_frequency: 'medium' },
        ],
        specialCases: [
          'B_axial = 2 × B_equatorial (at same distance)',
          'Field direction: along m (N-pole direction)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'B_eq', meaning: 'Field on equatorial line', unit: 'T', typical_values: 'μT to mT' },
        ],
        derivedFrom: 'magnetic-dipole-moment',
        applications: [
          { name: 'Exact formula', latex: 'B = \\frac{\\mu_0}{4\\pi} \\frac{m}{(r^2+l^2)^{3/2}}', context: 'When r not >> l', neet_frequency: 'medium' },
          { name: 'Direction', latex: '\\text{Opposite to } \\vec{m}', context: 'Antiparallel to dipole moment', neet_frequency: 'medium' },
        ],
        specialCases: [
          'B_eq = ½ × B_axial (at same distance)',
          'Field direction: opposite to m (S-pole direction)',
        ],
        dimensionalCheck: '[B] = T',
      },
    ],
    ...
    variations: [
      { type: 'numerical', description: 'Calculate axial field of bar magnet', difficulty: 'medium' },
      { type: 'numerical', description: 'Calculate equatorial field', difficulty: 'medium' },
      { type: 'conceptual', description: 'Compare axial and equatorial fields', difficulty: 'easy' },
      { type: 'numerical', description: 'Torque on bar magnet in external field', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Ratio of axial to equatorial field', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022] },
      { pattern: 'Field at given distance on axis', frequency: 'medium', yearAsked: [2019, 2021, 2023] },
      { pattern: 'Bar magnet equivalent to solenoid', frequency: 'medium', yearAsked: [2018, 2020] },
    ],
  ...
  // Topic 2: Earth's Magnetism
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'BH', meaning: 'Horizontal component', unit: 'T', typical_values: '~25-40 μT' },
          { symbol: 'BV', meaning: 'Vertical component', unit: 'T', typical_values: '~25-60 μT' },
          { symbol: 'B', meaning: 'Total Earth\'s field', unit: 'T', typical_values: '~25-65 μT' },
          { symbol: 'δ', meaning: 'Angle of dip/inclination', unit: 'degrees', typical_values: '0° at equator, 90° at poles' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Total field', latex: 'B = \\sqrt{B_H^2 + B_V^2}', context: 'From components', neet_frequency: 'high' },
          { name: 'Tan of dip', latex: '\\tan\\delta = \\frac{B_V}{B_H}', context: 'Find dip from components', neet_frequency: 'high' },
        ],
        specialCases: [
          'At equator: δ = 0°, BV = 0, B = BH',
          'At poles: δ = 90°, BH = 0, B = BV',
        ],
        dimensionalCheck: '[B] = T',
      },
      {
        ...
        variables: [
          { symbol: "δ'", meaning: 'Apparent dip', unit: 'degrees', typical_values: '> true dip' },
          { symbol: 'δ', meaning: 'True dip', unit: 'degrees', typical_values: 'Actual dip value' },
          { symbol: 'θ', meaning: 'Angle from magnetic meridian', unit: 'degrees', typical_values: '0-90°' },
        ],
        derivedFrom: 'earth-field-components',
        applications: [
          { name: 'In magnetic meridian', latex: "\\delta' = \\delta", context: 'θ = 0°, apparent = true', neet_frequency: 'high' },
          { name: 'Perpendicular to meridian', latex: "\\delta' = 90°", context: 'θ = 90°, dip appears vertical', neet_frequency: 'medium' },
        ],
        specialCases: [
          "Apparent dip always ≥ true dip",
          "True dip only measured in magnetic meridian plane",
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'δ', meaning: 'True dip', unit: 'degrees', typical_values: 'To be found' },
          { symbol: 'δ₁, δ₂', meaning: 'Apparent dips in perpendicular planes', unit: 'degrees', typical_values: 'Measured values' },
        ],
        derivedFrom: 'apparent-dip',
        applications: [
          { name: 'Finding true dip', latex: '\\delta = \\cot^{-1}\\sqrt{\\cot^2\\delta_1 + \\cot^2\\delta_2}', context: 'When two perpendicular measurements given', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Only valid for perpendicular planes',
          'Both δ₁ and δ₂ > δ',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Find BH and BV from B and dip', difficulty: 'easy' },
      { type: 'numerical', description: 'Find total field from components', difficulty: 'easy' },
      { type: 'numerical', description: 'Apparent dip problems', difficulty: 'medium' },
      { type: 'conceptual', description: 'Variation of dip from equator to poles', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Components of Earth\'s field', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'Dip at equator vs poles', frequency: 'medium', yearAsked: [2019, 2021] },
      { pattern: 'Apparent dip problems', frequency: 'medium', yearAsked: [2018, 2020, 2022] },
    ],
  ...
  // Topic 3: Magnetic Properties of Materials
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'χ', meaning: 'Magnetic susceptibility', unit: 'dimensionless', typical_values: '-10⁻⁵ to 10⁵' },
          { symbol: 'I', meaning: 'Intensity of magnetization', unit: 'A/m', typical_values: 'Varies widely' },
          { symbol: 'H', meaning: 'Magnetizing field intensity', unit: 'A/m', typical_values: '10-10⁶ A/m' },
          { symbol: 'μr', meaning: 'Relative permeability', unit: 'dimensionless', typical_values: '0.99-10⁵' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Diamagnetic', latex: '\\chi \\approx -10^{-5}', context: 'Small negative value', neet_frequency: 'high' },
          { name: 'Paramagnetic', latex: '\\chi \\approx 10^{-5} \\text{ to } 10^{-3}', context: 'Small positive value', neet_frequency: 'high' },
          { name: 'Ferromagnetic', latex: '\\chi \\approx 10^3 \\text{ to } 10^5', context: 'Very large positive', neet_frequency: 'high' },
        ],
        specialCases: [
          'χ = 0 for vacuum (μr = 1)',
          'χ > 0: material enhances field',
          'χ < 0: material opposes field',
        ],
        dimensionalCheck: 'Dimensionless',
      },
      {
        ...
        variables: [
          { symbol: 'C', meaning: 'Curie constant', unit: 'K', typical_values: 'Material specific' },
          { symbol: 'T', meaning: 'Absolute temperature', unit: 'K', typical_values: 'Above 0 K' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'At higher T', latex: '\\chi \\downarrow', context: 'Susceptibility decreases with temperature', neet_frequency: 'high' },
        ],
        specialCases: [
          'χ ∝ 1/T for paramagnetic materials',
      ...
      },
      {
        ...
        variables: [
          { symbol: 'Tc', meaning: 'Curie temperature', unit: 'K', typical_values: 'Fe: 1043K, Ni: 631K, Co: 1394K' },
        ],
        derivedFrom: 'curie-law',
        applications: [
          { name: 'Above Tc', latex: '\\text{Ferromagnetic} \\rightarrow \\text{Paramagnetic}', context: 'Loses permanent magnetism', neet_frequency: 'high' },
          { name: 'At T = Tc', latex: '\\chi \\rightarrow \\infty', context: 'Transition point', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Below Tc: material is ferromagnetic',
          'Above Tc: material becomes paramagnetic',
        ],
        dimensionalCheck: 'Dimensionless',
      },
    ],
    ...
    variations: [
      { type: 'conceptual', description: 'Classify materials as dia/para/ferromagnetic', difficulty: 'easy' },
      { type: 'numerical', description: 'Find μr from χ', difficulty: 'easy' },
      { type: 'conceptual', description: 'Effect of temperature on different materials', difficulty: 'medium' },
      { type: 'numerical', description: 'Curie law calculations', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Classification of magnetic materials', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'Curie temperature concept', frequency: 'high', yearAsked: [2019, 2020, 2021] },
      { pattern: 'χ and μr relationship', frequency: 'medium', yearAsked: [2018, 2021, 2023] },
    ],
  ...
  // Topic 4: Magnetization and Magnetic Intensity
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'I', meaning: 'Intensity of magnetization', unit: 'A/m', typical_values: '0 to 10⁶ A/m' },
          { symbol: 'M', meaning: 'Total magnetic moment', unit: 'A·m²', typical_values: 'Depends on sample' },
          { symbol: 'V', meaning: 'Volume of material', unit: 'm³', typical_values: 'Sample volume' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'In terms of pole strength', latex: 'I = \\frac{q_m}{A}', context: 'Pole strength per unit area', neet_frequency: 'medium' },
          { name: 'Maximum for ferromagnet', latex: 'I_{sat}', context: 'Saturation magnetization', neet_frequency: 'medium' },
        ],
        specialCases: [
          'I = 0 for unmagnetized material',
          'I = χH (linear relation for weak fields)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'B', meaning: 'Magnetic field (induction)', unit: 'T', typical_values: 'mT to T' },
          { symbol: 'H', meaning: 'Magnetic intensity', unit: 'A/m', typical_values: 'Depends on source' },
          { symbol: 'μ', meaning: 'Permeability of material', unit: 'H/m', typical_values: 'μ₀μr' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'In vacuum', latex: 'B = \\mu_0 H', context: 'I = 0', neet_frequency: 'high' },
          { name: 'Inside solenoid core', latex: 'B = \\mu_0\\mu_r nI', context: 'μr times vacuum field', neet_frequency: 'high' },
        ],
        specialCases: [
          'Diamagnetic: B < μ₀H (μr < 1)',
          'Paramagnetic: B > μ₀H slightly (μr > 1)',
          'Ferromagnetic: B >> μ₀H (μr >> 1)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'μ', meaning: 'Absolute permeability', unit: 'H/m', typical_values: '~μ₀ to 10⁵μ₀' },
          { symbol: 'μ₀', meaning: 'Permeability of free space', unit: 'H/m', typical_values: '4π × 10⁻⁷' },
          { symbol: 'μr', meaning: 'Relative permeability', unit: 'dimensionless', typical_values: '0.99 to 10⁵' },
        ],
        derivedFrom: 'b-h-relation',
        applications: [
          { name: 'From susceptibility', latex: '\\mu_r = 1 + \\chi', context: 'Relating μr and χ', neet_frequency: 'high' },
          { name: 'For iron core', latex: 'B = \\mu_r \\times B_0', context: 'Field enhancement in core', neet_frequency: 'high' },
        ],
        specialCases: [
          'Diamagnetic: μr ≈ 0.99999 (slightly less than 1)',
          'Paramagnetic: μr ≈ 1.00001 (slightly more than 1)',
          'Ferromagnetic: μr can be 10³ to 10⁵',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Find B from H and χ', difficulty: 'medium' },
      { type: 'numerical', description: 'Calculate μr from susceptibility', difficulty: 'easy' },
      { type: 'conceptual', description: 'Difference between B and H', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'B = μ₀(H + I) applications', frequency: 'high', yearAsked: [2018, 2019, 2021, 2022] },
      { pattern: 'μr and χ relationship', frequency: 'high', yearAsked: [2019, 2020, 2023] },
      { pattern: 'Field in solenoid with core', frequency: 'medium', yearAsked: [2018, 2020, 2022] },
    ],
  ...
  // Topic 5: Hysteresis
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'W', meaning: 'Energy loss per unit volume per cycle', unit: 'J/m³', typical_values: 'Depends on material' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Power loss', latex: 'P = W \\times f \\times V', context: 'f = frequency, V = volume', neet_frequency: 'medium' },
          { name: 'Minimize loss', latex: '\\text{Use soft iron (narrow loop)}', context: 'For transformers, motors', neet_frequency: 'high' },
        ],
        specialCases: [
          'Wider loop = more energy loss',
          'Loss ∝ frequency of AC',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'Br', meaning: 'Retentivity/Remanence', unit: 'T', typical_values: '0.1-1.5 T' },
          { symbol: 'Hc', meaning: 'Coercivity', unit: 'A/m', typical_values: '10-10⁶ A/m' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Permanent magnet', latex: 'B_r \\uparrow, H_c \\uparrow', context: 'High retentivity and coercivity', neet_frequency: 'high' },
          { name: 'Electromagnet core', latex: 'B_r \\downarrow, H_c \\downarrow', context: 'Low values for easy demagnetization', neet_frequency: 'high' },
        ],
        specialCases: [
          'Steel: Br ~ 1T, Hc ~ 5000 A/m (hard)',
          'Soft iron: Br ~ 1.4T, Hc ~ 100 A/m (soft)',
        ],
    ...
    variations: [
      { type: 'conceptual', description: 'Interpret B-H hysteresis curve', difficulty: 'medium' },
      { type: 'conceptual', description: 'Material selection for applications', difficulty: 'easy' },
      { type: 'conceptual', description: 'Compare soft and hard magnetic materials', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Material for permanent magnet vs electromagnet', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'Retentivity and coercivity definitions', frequency: 'high', yearAsked: [2019, 2021, 2022] },
      { pattern: 'Hysteresis loss minimization', frequency: 'medium', yearAsked: [2018, 2020] },
    ],
  ...
  // Topic 6: Permanent Magnets and Electromagnets
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'B', meaning: 'Magnetic field in core', unit: 'T', typical_values: '0.1-2 T' },
          { symbol: 'μr', meaning: 'Relative permeability of core', unit: 'dimensionless', typical_values: '1000-10000 for soft iron' },
          { symbol: 'n', meaning: 'Turns per unit length', unit: 'turns/m', typical_values: '100-10000' },
          { symbol: 'I', meaning: 'Current', unit: 'A', typical_values: '0.1-10 A' },
        ],
        derivedFrom: 'b-h-relation',
        applications: [
          { name: 'Field enhancement', latex: 'B_{core} = \\mu_r \\times B_{air}', context: 'Core multiplies field by μr', neet_frequency: 'high' },
          { name: 'Lifting electromagnet', latex: 'F \\propto B^2', context: 'Force increases with B²', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Without core: B = μ₀nI (much weaker)',
          'Soft iron core can give μr ~ 5000',
        ],
        dimensionalCheck: '[B] = T',
      },
    ],
    ...
    variations: [
      { type: 'conceptual', description: 'Material choice for different applications', difficulty: 'easy' },
      { type: 'conceptual', description: 'Advantages/disadvantages of permanent vs electromagnets', difficulty: 'easy' },
      { type: 'numerical', description: 'Field with and without core', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Material for permanent magnet', frequency: 'high', yearAsked: [2018, 2019, 2021, 2022] },
      { pattern: 'Material for electromagnet core', frequency: 'high', yearAsked: [2019, 2020, 2023] },
      { pattern: 'Comparing permanent and electromagnets', frequency: 'medium', yearAsked: [2018, 2020] },
    ],
