...
export const workEnergyPowerTopics = [
  // Topic 1: Work Done by a Force
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'W', meaning: 'Work done', unit: 'J (Joule)', typical_values: '1-1000 J typically' },
          { symbol: 'F', meaning: 'Force magnitude', unit: 'N', typical_values: '1-100 N' },
          { symbol: 'd', meaning: 'Displacement magnitude', unit: 'm', typical_values: '0.1-10 m' },
          { symbol: 'θ', meaning: 'Angle between F and d', unit: 'degrees', typical_values: '0° to 180°' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Same direction (θ=0°)', latex: 'W = Fd', context: 'Maximum positive work', neet_frequency: 'high' },
          { name: 'Opposite direction (θ=180°)', latex: 'W = -Fd', context: 'Maximum negative work', neet_frequency: 'high' },
          { name: 'Perpendicular (θ=90°)', latex: 'W = 0', context: 'No work done', neet_frequency: 'high' },
        ],
        specialCases: [
          '1 Joule = 1 N × 1 m',
          'Normal force does no work on horizontal surface (⊥ to motion)',
          'Centripetal force does no work (always ⊥ to velocity)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: '∫F dx', meaning: 'Area under F-x graph', unit: 'J', typical_values: 'Calculated from integral' },
        ],
        derivedFrom: 'work-constant-force',
        applications: [
          { name: 'Spring force', latex: 'W = \\frac{1}{2}kx^2', context: 'Work to stretch/compress spring by x', neet_frequency: 'high' },
          { name: 'From F-x graph', latex: 'W = \\text{Area under F-x curve}', context: 'Graphical method', neet_frequency: 'high' },
        ],
        specialCases: [
          'For spring: W = ½kx² (from equilibrium)',
          'Area positive above x-axis, negative below',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Work by constant force at angle', difficulty: 'easy' },
      { type: 'numerical', description: 'Work from F-x graph', difficulty: 'medium' },
      { type: 'conceptual', description: 'Sign of work done', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Work at angle to displacement', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022, 2023] },
      { pattern: 'Work from force-displacement graph', frequency: 'high', yearAsked: [2019, 2020, 2022] },
      { pattern: 'Work by various forces (gravity, friction, normal)', frequency: 'high', yearAsked: [2018, 2021, 2023] },
    ],
  ...
  // Topic 2: Kinetic Energy
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'KE', meaning: 'Kinetic energy', unit: 'J', typical_values: 'Always ≥ 0' },
          { symbol: 'm', meaning: 'Mass', unit: 'kg', typical_values: '0.1-100 kg' },
          { symbol: 'v', meaning: 'Speed', unit: 'm/s', typical_values: '1-100 m/s' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'In terms of momentum', latex: 'KE = \\frac{p^2}{2m}', context: 'Using p = mv', neet_frequency: 'high' },
          { name: 'Stopping distance', latex: 's \\propto v^2', context: 'From W = ΔKE = -μmgs', neet_frequency: 'high' },
        ],
        specialCases: [
          'KE = 0 when v = 0',
          'Same KE for same |v| regardless of direction',
          'Doubling v → 4× KE',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'p', meaning: 'Momentum', unit: 'kg⋅m/s', typical_values: 'mv' },
        ],
        derivedFrom: 'kinetic-energy-formula',
        applications: [
          { name: 'Comparison at same momentum', latex: 'KE \\propto \\frac{1}{m}', context: 'Lighter body has more KE for same p', neet_frequency: 'high' },
          { name: 'Comparison at same KE', latex: 'p \\propto \\sqrt{m}', context: 'Heavier body has more momentum for same KE', neet_frequency: 'high' },
        ],
        specialCases: [
          'At same p: lighter body has more KE',
          'At same KE: heavier body has more p',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Calculate KE from mass and velocity', difficulty: 'easy' },
      { type: 'numerical', description: 'KE-momentum problems', difficulty: 'medium' },
      { type: 'conceptual', description: 'Effect of changing v or m on KE', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'KE ratio problems', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022] },
      { pattern: 'KE-momentum relation', frequency: 'high', yearAsked: [2019, 2020, 2022, 2023] },
      { pattern: 'Stopping distance relation with KE', frequency: 'medium', yearAsked: [2018, 2021] },
    ],
  ...
  // Topic 3: Potential Energy
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'U', meaning: 'Gravitational PE', unit: 'J', typical_values: 'Can be +ve or -ve' },
          { symbol: 'h', meaning: 'Height above reference', unit: 'm', typical_values: 'Measured from chosen zero' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Change in PE', latex: '\\Delta U = mg(h_2 - h_1) = mg\\Delta h', context: 'Independent of path', neet_frequency: 'high' },
          { name: 'Work by gravity', latex: 'W_g = -\\Delta U = -mg\\Delta h', context: 'Negative of PE change', neet_frequency: 'high' },
        ],
        specialCases: [
          'Reference point arbitrary (usually ground = 0)',
          'PE can be negative (below reference)',
          'Only ΔU has physical significance',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'U', meaning: 'Elastic PE', unit: 'J', typical_values: 'Always ≥ 0' },
          { symbol: 'k', meaning: 'Spring constant', unit: 'N/m', typical_values: '10-1000 N/m' },
          { symbol: 'x', meaning: 'Extension/compression', unit: 'm', typical_values: '0.01-0.5 m' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Work by spring', latex: 'W_s = -\\Delta U = \\frac{1}{2}k(x_1^2 - x_2^2)', context: 'From x₁ to x₂', neet_frequency: 'high' },
          { name: 'Between two extensions', latex: 'W = \\frac{1}{2}k(x_1^2 - x_2^2)', context: 'Not ½k(x₁-x₂)²', neet_frequency: 'high' },
        ],
        specialCases: [
          'U = 0 at natural length (x = 0)',
          'Same PE for compression and extension of same |x|',
          'U ∝ x² (not x)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'F', meaning: 'Conservative force', unit: 'N', typical_values: 'Derived from U(x)' },
          { symbol: 'dU/dx', meaning: 'Rate of change of PE', unit: 'N', typical_values: 'Slope of U-x curve' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Spring force', latex: 'F = -\\frac{d}{dx}(\\frac{1}{2}kx^2) = -kx', context: 'Hooke\'s law from PE', neet_frequency: 'medium' },
          { name: 'Equilibrium', latex: '\\frac{dU}{dx} = 0', context: 'Force is zero at equilibrium', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Force points toward lower PE',
          'At equilibrium, F = 0, so dU/dx = 0',
          'Stable equilibrium: minimum PE',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Gravitational PE calculation', difficulty: 'easy' },
      { type: 'numerical', description: 'Spring PE problems', difficulty: 'medium' },
      { type: 'graphical', description: 'Force from U-x graph', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Spring PE calculations', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022, 2023] },
      { pattern: 'Gravitational PE change', frequency: 'high', yearAsked: [2019, 2020, 2022] },
      { pattern: 'Work done by/against spring', frequency: 'high', yearAsked: [2018, 2021, 2023] },
    ],
  ...
  // Topic 4: Work-Energy Theorem
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'W_net', meaning: 'Net work by all forces', unit: 'J', typical_values: 'Sum of all works' },
          { symbol: 'u', meaning: 'Initial speed', unit: 'm/s', typical_values: 'Given' },
          { symbol: 'v', meaning: 'Final speed', unit: 'm/s', typical_values: 'To find or given' },
        ],
        derivedFrom: 'second-law',
        applications: [
          { name: 'Finding final speed', latex: 'v = \\sqrt{u^2 + \\frac{2W_{net}}{m}}', context: 'From work and initial speed', neet_frequency: 'high' },
          { name: 'Stopping distance', latex: 's = \\frac{mu^2}{2F}', context: 'From u to rest by force F', neet_frequency: 'high' },
        ],
        specialCases: [
          'If starting from rest: v = √(2W/m)',
          'If coming to rest: W = -½mu²',
          'Works for any path (not just straight line)',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Find final velocity using W-E theorem', difficulty: 'medium' },
      { type: 'numerical', description: 'Stopping distance problems', difficulty: 'medium' },
      { type: 'numerical', description: 'Multiple forces problems', difficulty: 'hard' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Finding speed from work done', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'Stopping distance', frequency: 'high', yearAsked: [2019, 2021, 2022] },
    ],
  ...
  // Topic 5: Conservation of Mechanical Energy
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'KE', meaning: 'Kinetic energy', unit: 'J', typical_values: '½mv²' },
          { symbol: 'PE', meaning: 'Potential energy', unit: 'J', typical_values: 'mgh or ½kx²' },
        ],
        derivedFrom: 'work-energy-theorem',
        applications: [
          { name: 'Free fall from height h', latex: 'v = \\sqrt{2gh}', context: 'PE converts to KE', neet_frequency: 'high' },
          { name: 'Pendulum at lowest point', latex: 'v = \\sqrt{2gL(1-\\cos\\theta)}', context: 'Height = L(1-cos θ)', neet_frequency: 'high' },
          { name: 'Spring-block', latex: 'v_{max} = x_{max}\\sqrt{\\frac{k}{m}}', context: 'At equilibrium position', neet_frequency: 'high' },
        ],
        specialCases: [
          'Valid only for conservative forces',
          'Reference point must be consistent',
          'Mass cancels in free fall problems',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'W_nc', meaning: 'Work by non-conservative forces', unit: 'J', typical_values: 'Usually negative (friction)' },
        ],
        derivedFrom: 'energy-conservation',
        applications: [
          { name: 'With friction', latex: 'E_2 = E_1 - f \\cdot d', context: 'Energy lost to friction', neet_frequency: 'high' },
          { name: 'Work by friction', latex: 'W_f = -\\mu m g d', context: 'Negative work', neet_frequency: 'high' },
        ],
        specialCases: [
          'Friction always reduces mechanical energy',
          'Energy "lost" becomes heat',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Speed at different heights (free fall)', difficulty: 'easy' },
      { type: 'numerical', description: 'Spring-block oscillations', difficulty: 'medium' },
      { type: 'numerical', description: 'With friction (energy loss)', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Speed at height problems', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022, 2023] },
      { pattern: 'Pendulum problems', frequency: 'high', yearAsked: [2019, 2020, 2022] },
      { pattern: 'Spring energy problems', frequency: 'high', yearAsked: [2018, 2021, 2023] },
    ],
  ...
  // Topic 6: Power
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'P', meaning: 'Power', unit: 'W (Watt)', typical_values: '100-10000 W for machines' },
          { symbol: 'W', meaning: 'Work done', unit: 'J', typical_values: 'Energy transferred' },
          { symbol: 't', meaning: 'Time', unit: 's', typical_values: 'Duration' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'For constant force', latex: 'P = Fv', context: 'F parallel to v', neet_frequency: 'high' },
          { name: 'Maximum velocity', latex: 'v_{max} = \\frac{P}{F_{resist}}', context: 'When power equals resistance×v', neet_frequency: 'high' },
        ],
        specialCases: [
          'At max velocity, driving force = resistance',
          'P = Fv applies at any instant',
          '1 HP = 746 W ≈ 750 W',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'E', meaning: 'Energy', unit: 'J or kWh', typical_values: 'Work done' },
        ],
        derivedFrom: 'power-formula',
        applications: [
          { name: 'Electricity bill', latex: 'E(kWh) = P(kW) \\times t(h)', context: 'Commercial energy unit', neet_frequency: 'medium' },
          { name: 'Conversion', latex: '1 kWh = 3.6 \\times 10^6 J', context: 'kWh to Joules', neet_frequency: 'medium' },
        ],
        specialCases: [
    ...
    variations: [
      { type: 'numerical', description: 'Calculate power from force and velocity', difficulty: 'easy' },
      { type: 'numerical', description: 'Maximum velocity from power', difficulty: 'medium' },
      { type: 'numerical', description: 'Energy consumption problems', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Power from force and velocity', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022] },
      { pattern: 'Maximum velocity problems', frequency: 'medium', yearAsked: [2019, 2021] },
      { pattern: 'Unit conversions (HP, kWh)', frequency: 'medium', yearAsked: [2018, 2020, 2023] },
    ],
  ...
  // Topic 7: Collisions
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'u₁, u₂', meaning: 'Initial velocities', unit: 'm/s', typical_values: 'Before collision' },
          { symbol: 'v₁, v₂', meaning: 'Final velocities', unit: 'm/s', typical_values: 'After collision' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Perfectly inelastic', latex: 'v = \\frac{m_1u_1 + m_2u_2}{m_1 + m_2}', context: 'Bodies stick together', neet_frequency: 'high' },
        ],
        specialCases: [
          'Always valid regardless of collision type',
          'Vector equation - apply component-wise in 2D',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'v₁', meaning: 'Final velocity of mass 1', unit: 'm/s', typical_values: 'Calculated' },
        ],
        derivedFrom: 'momentum-conservation',
        applications: [
          { name: 'Equal masses', latex: 'v_1 = u_2, v_2 = u_1', context: 'Velocities exchange', neet_frequency: 'high' },
          { name: 'Target at rest (m₂=m₁)', latex: 'v_1 = 0, v_2 = u_1', context: 'Complete momentum transfer', neet_frequency: 'high' },
          { name: 'Heavy hits light', latex: 'v_2 \\approx 2u_1', context: 'm₁ >> m₂', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Equal masses at rest: complete exchange',
          'Heavy → light: light moves at ~2u₁',
          'Light → heavy: bounces back',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'e', meaning: 'Coefficient of restitution', unit: 'dimensionless', typical_values: '0 ≤ e ≤ 1' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Elastic collision', latex: 'e = 1', context: 'Perfect bounce', neet_frequency: 'high' },
          { name: 'Perfectly inelastic', latex: 'e = 0', context: 'No bounce, stick together', neet_frequency: 'high' },
          { name: 'Ball bouncing on floor', latex: 'e = \\sqrt{\\frac{h_2}{h_1}}', context: 'Heights after and before', neet_frequency: 'high' },
        ],
        specialCases: [
          'e = 1: elastic (no KE loss)',
          'e = 0: perfectly inelastic (max KE loss)',
      ...
      },
      {
        ...
        variables: [
          { symbol: 'μ', meaning: 'Reduced mass', unit: 'kg', typical_values: 'm₁m₂/(m₁+m₂)' },
          { symbol: 'ΔKE', meaning: 'Energy lost', unit: 'J', typical_values: '0 for elastic' },
        ],
        derivedFrom: 'coefficient-restitution',
        applications: [
          { name: 'Perfectly inelastic', latex: '\\Delta KE = \\frac{1}{2}\\mu(u_1-u_2)^2', context: 'e = 0, maximum loss', neet_frequency: 'high' },
          { name: 'Fraction lost', latex: '\\frac{\\Delta KE}{KE_i} = 1 - e^2', context: 'In CM frame', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Elastic: ΔKE = 0',
    ...
    variations: [
      { type: 'numerical', description: 'Elastic collision between two bodies', difficulty: 'medium' },
      { type: 'numerical', description: 'Perfectly inelastic collision', difficulty: 'medium' },
      { type: 'numerical', description: 'KE loss calculations', difficulty: 'medium' },
      { type: 'numerical', description: 'Coefficient of restitution problems', difficulty: 'hard' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Velocity after elastic collision', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022, 2023] },
      { pattern: 'Perfectly inelastic collision', frequency: 'high', yearAsked: [2019, 2020, 2022] },
      { pattern: 'KE loss in collision', frequency: 'high', yearAsked: [2018, 2021, 2023] },
      { pattern: 'Ball bouncing (e from heights)', frequency: 'medium', yearAsked: [2019, 2022] },
    ],
