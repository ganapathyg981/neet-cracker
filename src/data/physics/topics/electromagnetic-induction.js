...
export const electromagneticInductionTopics = [
  // Topic 1: Faraday's Laws of Electromagnetic Induction
  {
    id: 'faradays-laws',
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'Φ', meaning: 'Magnetic flux', unit: 'Wb (Weber)', typical_values: 'mWb to Wb' },
          { symbol: 'B', meaning: 'Magnetic field', unit: 'T', typical_values: '0.01-1 T' },
          { symbol: 'A', meaning: 'Area of surface', unit: 'm²', typical_values: '10⁻⁴ to 1 m²' },
          { symbol: 'θ', meaning: 'Angle between B and area normal', unit: 'rad', typical_values: '0 to π' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Perpendicular field', latex: '\\Phi = BA', context: 'θ = 0°, maximum flux', neet_frequency: 'high' },
          { name: 'Parallel field', latex: '\\Phi = 0', context: 'θ = 90°, zero flux', neet_frequency: 'medium' },
        ],
        specialCases: [
          '1 Wb = 1 T·m² = 1 V·s',
          'Flux is scalar (dot product of vectors)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'ε', meaning: 'Induced EMF', unit: 'V', typical_values: 'mV to kV' },
          { symbol: 'N', meaning: 'Number of turns', unit: 'dimensionless', typical_values: '1-10000' },
          { symbol: 'dΦ/dt', meaning: 'Rate of change of flux', unit: 'Wb/s', typical_values: 'Varies' },
        ],
        derivedFrom: 'magnetic-flux',
        applications: [
          { name: 'Average EMF', latex: '\\varepsilon_{avg} = -N\\frac{\\Delta\\Phi}{\\Delta t}', context: 'For finite time interval', neet_frequency: 'high' },
          { name: 'Flux changing uniformly', latex: '\\varepsilon = -N\\frac{\\Phi_2 - \\Phi_1}{t}', context: 'Constant rate of change', neet_frequency: 'high' },
        ],
        specialCases: [
          'ε = 0 if Φ is constant (no change)',
      ...
      },
      {
        ...
        variables: [
          { symbol: 'q', meaning: 'Induced charge', unit: 'C', typical_values: 'μC to mC' },
          { symbol: 'R', meaning: 'Resistance of circuit', unit: 'Ω', typical_values: '1-1000 Ω' },
          { symbol: 'ΔΦ', meaning: 'Change in flux', unit: 'Wb', typical_values: 'Depends on change' },
        ],
        derivedFrom: 'faraday-law-emf',
        applications: [
          { name: 'Ballistic galvanometer', latex: 'q = \\frac{N(\\Phi_f - \\Phi_i)}{R}', context: 'Measures total charge, not current', neet_frequency: 'high' },
        ],
        specialCases: [
          'q is independent of time taken for change',
          'Same ΔΦ gives same q regardless of speed',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Calculate induced EMF from flux change', difficulty: 'medium' },
      { type: 'numerical', description: 'Find induced charge', difficulty: 'medium' },
      { type: 'conceptual', description: 'Conditions for EMF induction', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'EMF from rate of flux change', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'Induced charge calculation', frequency: 'medium', yearAsked: [2019, 2021, 2022] },
      { pattern: 'Flux calculation through coil', frequency: 'high', yearAsked: [2018, 2020, 2023] },
    ],
  ...
  // Topic 2: Lenz's Law
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: '-', meaning: 'Opposition to change', unit: 'N/A', typical_values: 'Direction indicator' },
        ],
        derivedFrom: 'faraday-law-emf',
        applications: [
          { name: 'Flux increasing', latex: 'B_{induced} \\text{ opposes } B_{external}', context: 'Creates field to reduce net flux', neet_frequency: 'high' },
          { name: 'Flux decreasing', latex: 'B_{induced} \\text{ supports } B_{external}', context: 'Creates field to maintain flux', neet_frequency: 'high' },
        ],
        specialCases: [
          'Use right-hand rule to find current direction',
          'Induced current always acts to maintain status quo',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'W', meaning: 'Work done', unit: 'J', typical_values: 'mJ to J' },
        ],
        derivedFrom: 'lenz-direction',
        applications: [
          { name: 'Generator work', latex: 'W_{mechanical} = W_{electrical}', context: 'Mechanical input → electrical output', neet_frequency: 'medium' },
        ],
        specialCases: [
          'No free energy - must do work to generate EMF',
    ...
    variations: [
      { type: 'conceptual', description: 'Direction of induced current', difficulty: 'medium' },
      { type: 'conceptual', description: 'Lenz\'s law as conservation of energy', difficulty: 'easy' },
      { type: 'application', description: 'Magnet approaching/leaving coil', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Direction of induced current', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022, 2023] },
      { pattern: 'Lenz\'s law and energy conservation', frequency: 'medium', yearAsked: [2019, 2021] },
    ],
  ...
  // Topic 3: Motional EMF
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'ε', meaning: 'Induced EMF', unit: 'V', typical_values: 'mV to V' },
          { symbol: 'B', meaning: 'Magnetic field', unit: 'T', typical_values: '0.1-1 T' },
          { symbol: 'l', meaning: 'Length of rod', unit: 'm', typical_values: '0.1-1 m' },
          { symbol: 'v', meaning: 'Velocity of rod', unit: 'm/s', typical_values: '1-10 m/s' },
        ],
        derivedFrom: 'faraday-law-emf',
        applications: [
          { name: 'General case', latex: '\\varepsilon = Blv\\sin\\theta', context: 'v at angle θ to B', neet_frequency: 'high' },
          { name: 'Rate of flux cutting', latex: '\\varepsilon = B\\frac{dA}{dt} = Blv', context: 'Area swept per unit time', neet_frequency: 'high' },
        ],
        specialCases: [
          'ε = 0 if v ∥ B or v ∥ l',
          'Maximum when v ⊥ B ⊥ l (mutually perpendicular)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'ω', meaning: 'Angular velocity', unit: 'rad/s', typical_values: '10-100 rad/s' },
          { symbol: 'l', meaning: 'Length of rod', unit: 'm', typical_values: '0.1-1 m' },
          { symbol: 'f', meaning: 'Frequency of rotation', unit: 'Hz', typical_values: '1-50 Hz' },
        ],
        derivedFrom: 'motional-emf-rod',
        applications: [
          { name: 'Rotating disc', latex: '\\varepsilon = \\frac{1}{2}B\\omega R^2', context: 'Disc of radius R', neet_frequency: 'high' },
        ],
        specialCases: [
          'EMF is DC (constant) for uniform rotation',
          'Center of rod can be used as pivot too',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'F', meaning: 'Magnetic force', unit: 'N', typical_values: 'mN to N' },
          { symbol: 'I', meaning: 'Induced current = ε/R', unit: 'A', typical_values: 'mA to A' },
          { symbol: 'R', meaning: 'Resistance of circuit', unit: 'Ω', typical_values: '1-100 Ω' },
        ],
        derivedFrom: 'motional-emf-rod',
        applications: [
          { name: 'Power dissipated', latex: 'P = Fv = \\frac{B^2l^2v^2}{R}', context: 'Mechanical power → electrical', neet_frequency: 'high' },
          { name: 'Terminal velocity', latex: 'v_t = \\frac{mgR}{B^2l^2}', context: 'When gravity balances magnetic force', neet_frequency: 'high' },
        ],
        specialCases: [
          'Force opposes motion (Lenz\'s law)',
          'External force needed to maintain constant v',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'EMF in rod moving in magnetic field', difficulty: 'medium' },
      { type: 'numerical', description: 'Rotating rod/disc EMF', difficulty: 'medium' },
      { type: 'numerical', description: 'Terminal velocity of falling rod', difficulty: 'hard' },
      { type: 'conceptual', description: 'Direction of EMF using hand rules', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'EMF = Blv calculations', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'Rotating rod EMF', frequency: 'high', yearAsked: [2019, 2020, 2021, 2022] },
      { pattern: 'Power and force in moving rod', frequency: 'medium', yearAsked: [2018, 2021, 2023] },
    ],
  ...
  // Topic 4: Self-Induction and Inductance
  {
    id: 'self-induction',
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'L', meaning: 'Self-inductance', unit: 'H (Henry)', typical_values: 'μH to H' },
          { symbol: 'N', meaning: 'Number of turns', unit: 'dimensionless', typical_values: '10-10000' },
          { symbol: 'Φ', meaning: 'Flux through each turn', unit: 'Wb', typical_values: 'μWb to mWb' },
          { symbol: 'I', meaning: 'Current', unit: 'A', typical_values: '0.1-10 A' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Solenoid', latex: 'L = \\mu_0 n^2 Al = \\frac{\\mu_0 N^2 A}{l}', context: 'n = N/l', neet_frequency: 'high' },
          { name: 'With core', latex: 'L = \\mu_0\\mu_r n^2 Al', context: 'μr times air-core value', neet_frequency: 'high' },
        ],
        specialCases: [
          'L depends only on geometry and medium',
          'Adding core: L increases by factor μr',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'ε', meaning: 'Self-induced EMF (back-EMF)', unit: 'V', typical_values: 'mV to kV' },
          { symbol: 'dI/dt', meaning: 'Rate of change of current', unit: 'A/s', typical_values: '1-10⁶ A/s' },
        ],
        derivedFrom: 'self-inductance',
        applications: [
          { name: 'DC steady state', latex: '\\varepsilon = 0', context: 'dI/dt = 0, no back-EMF', neet_frequency: 'medium' },
          { name: 'Sudden change', latex: '\\varepsilon = -L\\frac{\\Delta I}{\\Delta t}', context: 'Can be very large for fast changes', neet_frequency: 'high' },
        ],
        specialCases: [
          'Back-EMF opposes current change',
          'Large L or fast change → large back-EMF (sparks when switching off)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'U', meaning: 'Stored energy', unit: 'J', typical_values: 'mJ to J' },
        ],
        derivedFrom: 'self-inductance',
        applications: [
          { name: 'Energy density', latex: 'u = \\frac{B^2}{2\\mu_0}', context: 'Energy per unit volume', neet_frequency: 'high' },
          { name: 'In terms of B', latex: 'U = \\frac{B^2}{2\\mu_0} \\times \\text{Volume}', context: 'For uniform field', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Energy stored in magnetic field, not in coil itself',
          'Compare with capacitor: U = ½CV²',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Calculate inductance of solenoid', difficulty: 'medium' },
      { type: 'numerical', description: 'Self-induced EMF', difficulty: 'medium' },
      { type: 'numerical', description: 'Energy stored in inductor', difficulty: 'easy' },
      { type: 'conceptual', description: 'Effect of core on inductance', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Inductance of solenoid', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'Energy stored in inductor', frequency: 'high', yearAsked: [2019, 2020, 2021] },
      { pattern: 'Back-EMF calculation', frequency: 'medium', yearAsked: [2018, 2021, 2022] },
    ],
  ...
  // Topic 5: Mutual Induction
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'M', meaning: 'Mutual inductance', unit: 'H', typical_values: 'μH to H' },
          { symbol: 'Φ₂₁', meaning: 'Flux through coil 2 due to coil 1', unit: 'Wb', typical_values: 'μWb to mWb' },
          { symbol: 'N₂', meaning: 'Turns in secondary coil', unit: 'dimensionless', typical_values: '10-10000' },
          { symbol: 'I₁', meaning: 'Current in primary coil', unit: 'A', typical_values: '0.1-10 A' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Two coaxial solenoids', latex: 'M = \\mu_0 \\frac{N_1 N_2 A}{l}', context: 'A = common area, l = length', neet_frequency: 'high' },
          { name: 'With core', latex: 'M = \\mu_0\\mu_r \\frac{N_1 N_2 A}{l}', context: 'Core increases M', neet_frequency: 'medium' },
        ],
        specialCases: [
          'M depends on geometry and relative position',
          'M = 0 if no flux links the two coils',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'ε₂', meaning: 'EMF induced in secondary', unit: 'V', typical_values: 'mV to kV' },
          { symbol: 'dI₁/dt', meaning: 'Rate of change of primary current', unit: 'A/s', typical_values: '1-10⁶ A/s' },
        ],
        derivedFrom: 'mutual-inductance',
        applications: [
          { name: 'Reciprocity', latex: '\\varepsilon_1 = -M\\frac{dI_2}{dt}', context: 'Same M in both directions', neet_frequency: 'high' },
        ],
        specialCases: [
          'Negative sign: opposes change (Lenz\'s law)',
          'Used in transformers, induction coils',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'k', meaning: 'Coupling coefficient', unit: 'dimensionless', typical_values: '0 to 1' },
          { symbol: 'L₁, L₂', meaning: 'Self-inductances of coils', unit: 'H', typical_values: 'μH to H' },
        ],
        derivedFrom: 'mutual-inductance',
        applications: [
          { name: 'Perfect coupling', latex: 'M = \\sqrt{L_1 L_2}', context: 'k = 1, all flux links both coils', neet_frequency: 'high' },
          { name: 'No coupling', latex: 'M = 0', context: 'k = 0, coils magnetically isolated', neet_frequency: 'medium' },
        ],
        specialCases: [
          'k = 1 for ideal transformer',
          'k < 1 in practice due to flux leakage',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Calculate mutual inductance', difficulty: 'medium' },
      { type: 'numerical', description: 'EMF induced in secondary', difficulty: 'medium' },
      { type: 'numerical', description: 'Coupling coefficient', difficulty: 'medium' },
      { type: 'conceptual', description: 'Factors affecting mutual inductance', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Mutual inductance of coaxial coils', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022] },
      { pattern: 'EMF in secondary coil', frequency: 'high', yearAsked: [2019, 2021, 2023] },
      { pattern: 'Coupling coefficient', frequency: 'medium', yearAsked: [2018, 2020] },
    ],
  ...
  // Topic 6: Eddy Currents and Applications
  {
    id: 'eddy-currents',
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'P', meaning: 'Power loss', unit: 'W', typical_values: 'Watts to kW' },
          { symbol: 'B', meaning: 'Magnetic field', unit: 'T', typical_values: '0.1-1 T' },
          { symbol: 'f', meaning: 'Frequency of field change', unit: 'Hz', typical_values: '50-60 Hz mains' },
          { symbol: 't', meaning: 'Thickness of conductor', unit: 'm', typical_values: 'mm for laminations' },
        ],
        derivedFrom: 'faraday-law-emf',
        applications: [
          { name: 'Reducing losses', latex: 'P \\propto t^2', context: 'Thinner laminations → lower loss', neet_frequency: 'high' },
          { name: 'Transformer cores', latex: '\\text{Use laminated iron}', context: 'Each sheet isolated', neet_frequency: 'high' },
        ],
        specialCases: [
          'Solid core: high eddy current losses',
          'Laminated core: losses greatly reduced',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'F', meaning: 'Braking force', unit: 'N', typical_values: 'Depends on system' },
          { symbol: 'v', meaning: 'Velocity of conductor', unit: 'm/s', typical_values: 'Moving object speed' },
        ],
        derivedFrom: 'lenz-direction',
        applications: [
          { name: 'Train brakes', latex: 'F = \\frac{B^2A^2v}{R}', context: 'Effective at high speed', neet_frequency: 'medium' },
          { name: 'Galvanometer damping', latex: '\\text{Critical damping}', context: 'Prevents oscillations', neet_frequency: 'medium' },
        ],
        specialCases: [
          'F = 0 when v = 0 (no braking when stopped)',
          'Smoother than mechanical braking',
        ],
        dimensionalCheck: '[F] = N',
      },
    ],
    ...
    variations: [
      { type: 'conceptual', description: 'Applications of eddy currents', difficulty: 'easy' },
      { type: 'conceptual', description: 'Why laminate transformer cores', difficulty: 'easy' },
      { type: 'conceptual', description: 'Electromagnetic damping mechanism', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Applications of eddy currents', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'Reducing eddy current losses', frequency: 'high', yearAsked: [2019, 2021, 2022] },
      { pattern: 'Magnetic braking principle', frequency: 'medium', yearAsked: [2018, 2020] },
    ],
