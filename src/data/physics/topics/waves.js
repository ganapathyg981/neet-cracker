...
export const wavesTopics = [
  // Topic 1: Wave Motion Basics
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'v', meaning: 'Wave speed', unit: 'm/s', typical_values: '340 m/s (sound), 3×10⁸ m/s (light)' },
          { symbol: 'f', meaning: 'Frequency', unit: 'Hz', typical_values: '20-20000 Hz (audible)' },
          { symbol: 'λ', meaning: 'Wavelength', unit: 'm', typical_values: 'mm to km' },
          { symbol: 'T', meaning: 'Time period', unit: 's', typical_values: 'T = 1/f' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Find wavelength', latex: '\\lambda = \\frac{v}{f}', context: 'If v and f known', neet_frequency: 'high' },
          { name: 'Find frequency', latex: 'f = \\frac{v}{\\lambda}', context: 'If v and λ known', neet_frequency: 'high' },
        ],
        specialCases: [
          'v depends on medium, not frequency',
          'When wave enters new medium: f constant, λ and v change',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'y', meaning: 'Displacement', unit: 'm', typical_values: '-A to +A' },
          { symbol: 'A', meaning: 'Amplitude', unit: 'm', typical_values: 'mm to cm' },
          { symbol: 'k', meaning: 'Wave number', unit: 'rad/m', typical_values: 'k = 2π/λ' },
          { symbol: 'ω', meaning: 'Angular frequency', unit: 'rad/s', typical_values: 'ω = 2πf' },
          { symbol: 'φ', meaning: 'Initial phase', unit: 'rad', typical_values: '0 to 2π' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Wave velocity from equation', latex: 'v = \\frac{\\omega}{k} = \\frac{\\lambda}{T}', context: 'Phase velocity', neet_frequency: 'high' },
          { name: 'Direction of travel', latex: 'kx - \\omega t: +x \\text{ dir}, \\quad kx + \\omega t: -x \\text{ dir}', context: 'Sign determines direction', neet_frequency: 'high' },
        ],
        specialCases: [
      ...
      },
      {
        ...
        variables: [
          { symbol: 'k', meaning: 'Wave number', unit: 'rad/m', typical_values: 'Depends on λ' },
          { symbol: 'ω', meaning: 'Angular frequency', unit: 'rad/s', typical_values: 'Depends on f' },
        ],
        derivedFrom: 'wave-equation',
        applications: [
          { name: 'Velocity relation', latex: 'v = \\frac{\\omega}{k}', context: 'From wave equation', neet_frequency: 'high' },
        ],
        specialCases: [
          'k tells how many radians of phase change per meter',
          'ω tells how many radians of phase change per second',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Calculate v, f, or λ', difficulty: 'easy' },
      { type: 'conceptual', description: 'Identify wave type (transverse/longitudinal)', difficulty: 'easy' },
      { type: 'numerical', description: 'Wave equation interpretation', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'v = fλ calculations', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022] },
      { pattern: 'Wave direction from equation', frequency: 'medium', yearAsked: [2019, 2021, 2023] },
    ],
  ...
  // Topic 2: Speed of Wave in Different Media
  {
    id: 'wave-speed-media',
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'v', meaning: 'Wave speed', unit: 'm/s', typical_values: '10-1000 m/s' },
          { symbol: 'T', meaning: 'Tension in string', unit: 'N', typical_values: '1-1000 N' },
          { symbol: 'μ', meaning: 'Linear mass density', unit: 'kg/m', typical_values: '0.001-0.1 kg/m' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Effect of tension', latex: 'v \\propto \\sqrt{T}', context: 'Double T → v increases by √2', neet_frequency: 'high' },
          { name: 'Effect of μ', latex: 'v \\propto \\frac{1}{\\sqrt{\\mu}}', context: 'Thicker string → slower', neet_frequency: 'high' },
          { name: 'In terms of mass and length', latex: 'v = \\sqrt{\\frac{TL}{m}}', context: 'μ = m/L', neet_frequency: 'medium' },
        ],
        specialCases: [
          'For same material: v ∝ 1/√(cross-section area)',
          'Tighter string → higher pitch (music)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'v', meaning: 'Sound speed', unit: 'm/s', typical_values: '340 m/s in air at 20°C' },
          { symbol: 'γ', meaning: 'Ratio Cp/Cv', unit: 'dimensionless', typical_values: '1.4 for air' },
          { symbol: 'P', meaning: 'Pressure', unit: 'Pa', typical_values: '10⁵ Pa' },
          { symbol: 'ρ', meaning: 'Density', unit: 'kg/m³', typical_values: '1.2 kg/m³ for air' },
          { symbol: 'M', meaning: 'Molar mass', unit: 'kg/mol', typical_values: '0.029 kg/mol for air' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Temperature effect', latex: 'v \\propto \\sqrt{T}', context: 'At constant P, ρ changes with T', neet_frequency: 'high' },
          { name: 'Effect of humidity', latex: 'v_{moist} > v_{dry}', context: 'Moist air is less dense', neet_frequency: 'medium' },
          { name: 'Compare gases', latex: '\\frac{v_1}{v_2} = \\sqrt{\\frac{\\gamma_1 M_2}{\\gamma_2 M_1}}', context: 'At same T', neet_frequency: 'high' },
        ],
        specialCases: [
          'v in air at 0°C ≈ 331 m/s',
          'v increases by ~0.6 m/s per °C rise',
          'v is independent of pressure (P/ρ = RT/M = constant)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'v_T', meaning: 'Speed at temperature T (K)', unit: 'm/s', typical_values: '331-360 m/s' },
          { symbol: 'v_0', meaning: 'Speed at 0°C = 273K', unit: 'm/s', typical_values: '331 m/s' },
          { symbol: 't', meaning: 'Temperature in °C', unit: '°C', typical_values: '0-50°C' },
        ],
        derivedFrom: 'sound-speed-gas',
        applications: [
          { name: 'At 20°C', latex: 'v = 331 + 0.6(20) = 343 \\text{ m/s}', context: 'Room temperature', neet_frequency: 'high' },
          { name: 'At 27°C', latex: 'v = 331 + 0.6(27) \\approx 347 \\text{ m/s}', context: 'Common exam temperature', neet_frequency: 'high' },
        ],
        specialCases: [
          'Linear approximation valid for small temperature changes',
          'For precise: use √(T) relationship',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Wave speed in string', difficulty: 'easy' },
      { type: 'numerical', description: 'Sound speed in gas', difficulty: 'medium' },
      { type: 'numerical', description: 'Temperature effect on sound speed', difficulty: 'medium' },
      { type: 'conceptual', description: 'Compare speeds in different media', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'v = √(T/μ) for string', frequency: 'high', yearAsked: [2018, 2019, 2021, 2022] },
      { pattern: 'Sound speed vs temperature', frequency: 'high', yearAsked: [2019, 2020, 2022, 2023] },
      { pattern: 'Compare v in different gases', frequency: 'medium', yearAsked: [2018, 2021, 2023] },
    ],
  ...
  // Topic 3: Superposition and Interference
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'A', meaning: 'Resultant amplitude', unit: 'm', typical_values: '0 to A₁+A₂' },
          { symbol: 'A₁, A₂', meaning: 'Individual amplitudes', unit: 'm', typical_values: 'Given' },
          { symbol: 'φ', meaning: 'Phase difference', unit: 'rad', typical_values: '0 to 2π' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Maximum (constructive)', latex: 'A_{max} = A_1 + A_2 \\text{ when } \\phi = 0, 2\\pi...', context: 'In phase', neet_frequency: 'high' },
          { name: 'Minimum (destructive)', latex: 'A_{min} = |A_1 - A_2| \\text{ when } \\phi = \\pi, 3\\pi...', context: 'Out of phase', neet_frequency: 'high' },
          { name: 'Equal amplitudes', latex: 'A = 2A_0\\cos(\\phi/2)', context: 'When A₁ = A₂ = A₀', neet_frequency: 'high' },
        ],
        specialCases: [
          'For A₁ = A₂: A ranges from 0 to 2A₀',
          'Intensity ∝ A², so I_max/I_min = ((A₁+A₂)/(A₁-A₂))²',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'φ', meaning: 'Phase difference', unit: 'rad', typical_values: '0 to 2π per wavelength' },
          { symbol: 'Δx', meaning: 'Path difference', unit: 'm', typical_values: 'Fraction of λ' },
          { symbol: 'λ', meaning: 'Wavelength', unit: 'm', typical_values: 'Given' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Constructive', latex: '\\Delta x = n\\lambda \\Rightarrow \\phi = 2n\\pi', context: 'n = 0, 1, 2...', neet_frequency: 'high' },
          { name: 'Destructive', latex: '\\Delta x = (n+\\frac{1}{2})\\lambda \\Rightarrow \\phi = (2n+1)\\pi', context: 'n = 0, 1, 2...', neet_frequency: 'high' },
        ],
        specialCases: [
          'Path diff of λ → phase diff of 2π (full cycle)',
          'Path diff of λ/2 → phase diff of π (half cycle)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'I', meaning: 'Resultant intensity', unit: 'W/m²', typical_values: '0 to I_max' },
          { symbol: 'I₁, I₂', meaning: 'Individual intensities', unit: 'W/m²', typical_values: 'Given' },
        ],
        derivedFrom: 'resultant-amplitude',
        applications: [
          { name: 'Maximum intensity', latex: 'I_{max} = (\\sqrt{I_1} + \\sqrt{I_2})^2', context: 'When φ = 0', neet_frequency: 'high' },
          { name: 'Minimum intensity', latex: 'I_{min} = (\\sqrt{I_1} - \\sqrt{I_2})^2', context: 'When φ = π', neet_frequency: 'high' },
          { name: 'Equal intensities', latex: 'I = 4I_0\\cos^2(\\phi/2)', context: 'When I₁ = I₂ = I₀', neet_frequency: 'high' },
        ],
        specialCases: [
          'I ∝ A²',
          'For equal I₀: I_max = 4I₀, I_min = 0',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Resultant amplitude calculation', difficulty: 'medium' },
      { type: 'numerical', description: 'Path difference for constructive/destructive', difficulty: 'easy' },
      { type: 'numerical', description: 'Intensity ratio problems', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Resultant amplitude from A₁, A₂, φ', frequency: 'high', yearAsked: [2018, 2019, 2021, 2022] },
      { pattern: 'Constructive/destructive conditions', frequency: 'high', yearAsked: [2019, 2020, 2022, 2023] },
      { pattern: 'I_max/I_min ratio', frequency: 'medium', yearAsked: [2018, 2021, 2023] },
    ],
  ...
  // Topic 4: Standing Waves
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'f_n', meaning: 'Frequency of nth harmonic', unit: 'Hz', typical_values: '100-1000 Hz' },
          { symbol: 'n', meaning: 'Harmonic number', unit: 'dimensionless', typical_values: '1, 2, 3...' },
          { symbol: 'L', meaning: 'Length of string', unit: 'm', typical_values: '0.1-2 m' },
          { symbol: 'v', meaning: 'Wave speed', unit: 'm/s', typical_values: '√(T/μ)' },
        ],
        derivedFrom: 'string-wave-speed',
        applications: [
          { name: 'Fundamental frequency', latex: 'f_1 = \\frac{v}{2L} = \\frac{1}{2L}\\sqrt{\\frac{T}{\\mu}}', context: 'First harmonic (n=1)', neet_frequency: 'high' },
          { name: 'Wavelength', latex: '\\lambda_n = \\frac{2L}{n}', context: 'nth harmonic wavelength', neet_frequency: 'high' },
          { name: 'Ratio', latex: 'f_1 : f_2 : f_3 = 1 : 2 : 3', context: 'All harmonics present', neet_frequency: 'high' },
        ],
        specialCases: [
          'Fundamental has 1 antinode, 2 nodes (at ends)',
          'nth harmonic has n antinodes, (n+1) nodes',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'f_n', meaning: 'Frequency of nth harmonic', unit: 'Hz', typical_values: 'Odd multiples of f₁' },
          { symbol: 'n', meaning: 'Harmonic number (odd)', unit: 'dimensionless', typical_values: '1, 3, 5, 7...' },
          { symbol: 'L', meaning: 'Length of pipe', unit: 'm', typical_values: '0.1-2 m' },
        ],
        derivedFrom: 'wave-equation',
        applications: [
          { name: 'Fundamental', latex: 'f_1 = \\frac{v}{4L}', context: 'Lowest frequency', neet_frequency: 'high' },
          { name: 'Next harmonic', latex: 'f_3 = \\frac{3v}{4L} = 3f_1', context: 'Third harmonic (no second!)', neet_frequency: 'high' },
          { name: 'Wavelength', latex: '\\lambda_n = \\frac{4L}{n}', context: 'n = 1, 3, 5...', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Node at closed end, antinode at open end',
          'Only odd harmonics: 1, 3, 5, 7...',
          'No even harmonics possible',
        ],
        dimensionalCheck: '[f] = Hz',
      },
      {
        ...
        variables: [
          { symbol: 'f_n', meaning: 'Frequency of nth harmonic', unit: 'Hz', typical_values: 'All multiples of f₁' },
          { symbol: 'n', meaning: 'Harmonic number', unit: 'dimensionless', typical_values: '1, 2, 3, 4...' },
        ],
        derivedFrom: 'wave-equation',
        applications: [
          { name: 'Fundamental', latex: 'f_1 = \\frac{v}{2L}', context: 'Same formula as string', neet_frequency: 'high' },
          { name: 'Compare to closed pipe', latex: 'f_{open} = 2f_{closed}', context: 'Same length, fundamental', neet_frequency: 'high' },
          { name: 'Wavelength', latex: '\\lambda_n = \\frac{2L}{n}', context: 'Same as string', neet_frequency: 'medium' },
        ],
        specialCases: [
      ...
      },
      {
        ...
        applications: [
          { name: 'Law of length', latex: 'f \\propto \\frac{1}{L}', context: 'At constant T, μ', neet_frequency: 'high' },
          { name: 'Law of tension', latex: 'f \\propto \\sqrt{T}', context: 'At constant L, μ', neet_frequency: 'high' },
          { name: 'Law of mass', latex: 'f \\propto \\frac{1}{\\sqrt{\\mu}}', context: 'At constant L, T', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Used in sonometer experiments',
          'Explains guitar string tuning',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Fundamental frequency of string/pipe', difficulty: 'easy' },
      { type: 'numerical', description: 'Overtone frequencies', difficulty: 'medium' },
      { type: 'numerical', description: 'Compare open and closed pipes', difficulty: 'medium' },
      { type: 'conceptual', description: 'Node and antinode positions', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Closed vs open pipe frequencies', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'String harmonics calculation', frequency: 'high', yearAsked: [2019, 2020, 2021, 2022] },
      { pattern: 'Overtone identification', frequency: 'medium', yearAsked: [2018, 2021, 2023] },
    ],
  ...
  // Topic 5: Beats
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'f_beat', meaning: 'Beat frequency', unit: 'Hz', typical_values: '1-10 Hz (audible)' },
          { symbol: 'f₁, f₂', meaning: 'Frequencies of two sources', unit: 'Hz', typical_values: 'Close values' },
        ],
        derivedFrom: 'superposition-interference',
        applications: [
          { name: 'Find unknown frequency', latex: 'f_2 = f_1 \\pm f_{beat}', context: 'Two possible values', neet_frequency: 'high' },
          { name: 'Tuning', latex: 'f_{beat} = 0 \\Rightarrow f_1 = f_2', context: 'Perfect tune when beats vanish', neet_frequency: 'medium' },
        ],
        specialCases: [
          'f_beat = 0 when frequencies are equal',
          'Only distinguishable if f_beat < ~10 Hz',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'y', meaning: 'Resultant displacement', unit: 'm', typical_values: '-2A to 2A' },
          { symbol: '(f₁+f₂)/2', meaning: 'Carrier frequency', unit: 'Hz', typical_values: 'Average frequency' },
        ],
        derivedFrom: 'superposition-interference',
        applications: [
          { name: 'Apparent frequency heard', latex: 'f = \\frac{f_1 + f_2}{2}', context: 'Average of two', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Amplitude varies with cos((f₁-f₂)πt)',
          'Sound frequency is (f₁+f₂)/2',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Calculate beat frequency', difficulty: 'easy' },
      { type: 'numerical', description: 'Find unknown frequency from beats', difficulty: 'medium' },
      { type: 'conceptual', description: 'Effect of waxing/loading on tuning fork', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Beat frequency calculation', frequency: 'high', yearAsked: [2018, 2019, 2021, 2022, 2023] },
      { pattern: 'Unknown frequency with two possibilities', frequency: 'high', yearAsked: [2019, 2020, 2022] },
      { pattern: 'Loading/waxing effect on frequency', frequency: 'medium', yearAsked: [2018, 2020, 2023] },
    ],
  ...
  // Topic 6: Doppler Effect
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: "f'", meaning: 'Observed/apparent frequency', unit: 'Hz', typical_values: 'Higher or lower than f' },
          { symbol: 'f', meaning: 'Source frequency', unit: 'Hz', typical_values: 'Given' },
          { symbol: 'v', meaning: 'Speed of sound in medium', unit: 'm/s', typical_values: '340 m/s in air' },
          { symbol: 'v_o', meaning: 'Observer velocity', unit: 'm/s', typical_values: '0-100 m/s' },
          { symbol: 'v_s', meaning: 'Source velocity', unit: 'm/s', typical_values: '0-100 m/s' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Source approaching, observer stationary', latex: "f' = f\\frac{v}{v - v_s}", context: 'f\' > f', neet_frequency: 'high' },
          { name: 'Source receding, observer stationary', latex: "f' = f\\frac{v}{v + v_s}", context: 'f\' < f', neet_frequency: 'high' },
          { name: 'Observer approaching, source stationary', latex: "f' = f\\frac{v + v_o}{v}", context: 'f\' > f', neet_frequency: 'high' },
          { name: 'Observer receding, source stationary', latex: "f' = f\\frac{v - v_o}{v}", context: 'f\' < f', neet_frequency: 'high' },
        ],
        specialCases: [
          'Numerator: + for observer moving toward source',
          'Denominator: - for source moving toward observer',
          'v_s < v always (source slower than sound)',
        ],
        dimensionalCheck: "[f'] = Hz",
      },
      {
        ...
        applications: [
          { name: 'Maximum shift', latex: "f'_{max} \\text{ when both approach}", context: 'Highest observed frequency', neet_frequency: 'medium' },
        ],
        specialCases: [
          'f\' > f (apparent frequency higher)',
          'If v_s = v_o approaching: f\' = f(v+v_o)/(v-v_o)',
        ],
        dimensionalCheck: "[f'] = Hz",
      },
      {
        ...
        derivedFrom: 'doppler-general',
        applications: [
          { name: 'Minimum shift', latex: "f'_{min} \\text{ when both recede}", context: 'Lowest observed frequency', neet_frequency: 'medium' },
        ],
        specialCases: [
          'f\' < f (apparent frequency lower)',
        ],
        dimensionalCheck: "[f'] = Hz",
      },
      {
        ...
        variables: [
          { symbol: "λ'", meaning: 'Apparent wavelength', unit: 'm', typical_values: 'Shorter or longer than λ' },
        ],
        derivedFrom: 'doppler-general',
        applications: [
          { name: 'Source approaching', latex: "\\lambda' = \\frac{v - v_s}{f}", context: 'Wavelength decreases', neet_frequency: 'medium' },
          { name: 'Source receding', latex: "\\lambda' = \\frac{v + v_s}{f}", context: 'Wavelength increases', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Observer motion does NOT change wavelength in medium',
          'Only source motion changes λ',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Source moving, observer stationary', difficulty: 'easy' },
      { type: 'numerical', description: 'Observer moving, source stationary', difficulty: 'easy' },
      { type: 'numerical', description: 'Both source and observer moving', difficulty: 'medium' },
      { type: 'conceptual', description: 'Echo/reflection problems', difficulty: 'hard' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Source approaching/receding', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'Observer approaching/receding', frequency: 'high', yearAsked: [2019, 2020, 2021, 2022] },
      { pattern: 'Both moving same/opposite directions', frequency: 'medium', yearAsked: [2018, 2021, 2023] },
    ],
