...
export const dualNatureRadiationTopics = [
      {
        ...
        formulas: [
            ...
            variables: [
              {
                ...
                unit: "J·s",
                typical_values: "6.63 × 10⁻³⁴ J·s"
              },
              {
                symbol: "ν",
                meaning: "Frequency of incident light",
                unit: "Hz",
                typical_values: "10¹⁴ - 10¹⁵ Hz (visible to UV)"
              },
              {
                symbol: "φ",
                meaning: "Work function of metal",
                unit: "eV or J",
                typical_values: "2-5 eV (metals)"
              },
              {
                symbol: "KE_max",
                meaning: "Maximum kinetic energy of photoelectron",
                unit: "eV or J",
                typical_values: "0-10 eV"
              }
            ],
            derivedFrom: null,
            applications: [],
          ...
          },
          {
            ...
            variables: [
              {
                symbol: "i_sat",
                meaning: "Saturation current",
                unit: "A",
                typical_values: "μA to mA"
              },
              {
                symbol: "I",
                meaning: "Light intensity",
                unit: "W/m²",
                typical_values: "Varies"
              },
              {
                symbol: "P",
                meaning: "Power of light source",
                unit: "W",
                typical_values: "mW to W"
              }
            ],
            derivedFrom: null,
            applications: [],
            specialCases: ["Saturation current ∝ intensity", "Saturation current independent of frequency (for ν > ν₀)", "All emitted electrons reach anode at saturation"],
          ...
          },
          {
            ...
            variables: [
              {
                symbol: "hc",
                meaning: "Planck constant × speed of light",
                unit: "eV·nm",
                typical_values: "1240 eV·nm"
              }
            ],
            derivedFrom: null,
            applications: [],
            specialCases: ["400 nm (violet): E = 3.1 eV", "500 nm (green): E = 2.48 eV", "700 nm (red): E = 1.77 eV"],
            dimensionalCheck: "[hc] = [E][λ] = eV·nm",
          },
          {
            id: "in-terms-of-wavelength",
            name: "In terms of wavelength",
            category: "derived",
            formula: "\\frac{hc}{\\lambda} = \\phi + KE_{max}",
            latex: "\\frac{hc}{\\lambda} = \\phi + KE_{max}",
            description: "Using c = νλ",
            variables: [],
            derivedFrom: "einstein-photoelectric",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            formula: "\\nu_0 = \\frac{\\phi}{h}",
            latex: "\\nu_0 = \\frac{\\phi}{h}",
            description: "Minimum frequency for emission (KE=0)",
            variables: [],
            derivedFrom: "einstein-photoelectric",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Threshold wavelength",
            category: "derived",
            formula: "\\lambda_0 = \\frac{hc}{\\phi}",
            latex: "\\lambda_0 = \\frac{hc}{\\phi}",
            description: "Maximum wavelength for emission",
            variables: [],
            derivedFrom: "einstein-photoelectric",
            applications: [],
            specialCases: [],
          ...
          {
            id: "in-terms-of-threshold",
            name: "In terms of threshold",
            category: "derived",
          ...
          },
          {
            ...
            name: "V₀ vs ν graph",
            category: "derived",
            formula: "V_0 = \\frac{h}{e}\\nu - \\frac{\\phi}{e}",
            latex: "V_0 = \\frac{h}{e}\\nu - \\frac{\\phi}{e}",
            description: "Linear graph, slope = h/e",
            variables: [],
            derivedFrom: "stopping-potential",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[eV₀] = C × V = J",
            neet_frequency: "high",
          ...
          {
            id: "slope-of-v-vs",
            name: "Slope of V₀ vs ν",
            category: "derived",
            formula: "\\text{Slope} = \\frac{h}{e} = 4.14 \\times 10^{-15} \\text{ V·s}",
            latex: "\\text{Slope} = \\frac{h}{e} = 4.14 \\times 10^{-15} \\text{ V·s}",
            description: "Same for all metals",
            variables: [],
            derivedFrom: "stopping-potential",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Y-intercept",
            category: "derived",
            formula: "\\text{Intercept} = -\\frac{\\phi}{e} = -V_0",
            latex: "\\text{Intercept} = -\\frac{\\phi}{e} = -V_0",
            description: "At ν = 0 (extrapolated)",
            variables: [],
            derivedFrom: "stopping-potential",
            applications: [],
            specialCases: [],
          ...
          {
            id: "doubling-intensity",
            name: "Doubling intensity",
            category: "derived",
            formula: "i_{sat} \\rightarrow 2i_{sat}",
            latex: "i_{sat} \\rightarrow 2i_{sat}",
            description: "Current doubles",
            variables: [],
            derivedFrom: "saturation-current",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[i] = A",
            neet_frequency: "high",
          ...
          {
            id: "number-of-photoelectrons",
            name: "Number of photoelectrons",
            category: "derived",
            formula: "n = \\frac{i_{sat}}{e}",
            latex: "n = \\frac{i_{sat}}{e}",
            description: "Electrons per second",
            variables: [],
            derivedFrom: "saturation-current",
            applications: [],
            specialCases: [],
          ...
          {
            id: "energy-from-wavelength",
            name: "Energy from wavelength",
            category: "derived",
            formula: "E(eV) = \\frac{1240}{\\lambda(nm)} = \\frac{12400}{\\lambda(Å)}",
            latex: "E(eV) = \\frac{1240}{\\lambda(nm)} = \\frac{12400}{\\lambda(Å)}",
            description: "Quick conversion",
            variables: [],
            derivedFrom: "useful-values",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[hc] = [E][λ] = eV·nm",
            neet_frequency: "high",
          ...
          {
            id: "visible-light-energy",
            name: "Visible light energy",
            category: "derived",
            formula: "E \\approx 1.8-3.1 \\text{ eV} \\text{ (700-400 nm)}",
            latex: "E \\approx 1.8-3.1 \\text{ eV} \\text{ (700-400 nm)}",
            description: "Red to violet",
            variables: [],
            derivedFrom: "useful-values",
            applications: [],
            specialCases: [],
        ...
        variations: [
          {
            type: "numerical",
            description: "Calculate KE from frequency and work function",
            difficulty: "medium"
          },
          {
            type: "numerical",
            description: "Find threshold frequency/wavelength from work function",
            difficulty: "easy"
          },
          {
            type: "numerical",
            description: "Stopping potential problems",
            difficulty: "medium"
          },
          {
            type: "graphical",
            description: "V₀ vs ν graph interpretation",
            difficulty: "medium"
          },
          {
            type: "conceptual",
            description: "Effect of changing intensity/frequency",
            difficulty: "easy"
          },
          {
            type: "numerical",
            description: "Compare two metals with different work functions",
            difficulty: "medium"
          },
          {
            type: "numerical",
            description: "Photocurrent and saturation current",
            difficulty: "medium"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "Einstein equation numerical",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "Threshold frequency/wavelength",
            frequency: "high",
            yearAsked: [
              2019,
              2020,
          ...
          {
            pattern: "Effect of intensity vs frequency",
            frequency: "high",
            yearAsked: [
              2018,
              2020,
          ...
          {
            pattern: "Stopping potential calculation",
            frequency: "medium",
      ...
      },
      {
        ...
        formulas: [
            ...
            variables: [
              {
                ...
                unit: "m",
                typical_values: "10⁻¹⁰ to 10⁻¹² m (electrons)"
              },
              {
                symbol: "p",
                meaning: "Momentum",
                unit: "kg·m/s",
                typical_values: "Depends on particle"
              },
              {
                symbol: "m",
            ...
            variables: [
              {
                ...
                meaning: "de Broglie wavelength",
                unit: "Å or nm",
                typical_values: "0.1-10 Å"
              },
              {
                symbol: "V",
                meaning: "Accelerating potential",
                unit: "V",
                typical_values: "10-10000 V"
              }
            ],
            derivedFrom: "de-broglie-wavelength",
            applications: [],
            specialCases: ["Derivation: eV = ½mv² → v = √(2eV/m) → λ = h/mv", "λ decreases with increasing V", "For proton: λ = 0.286/√V Å (due to larger mass)"],
          ...
          },
          {
            ...
            variables: [
              {
                symbol: "λ₁, λ₂",
                meaning: "de Broglie wavelengths",
                unit: "m",
                typical_values: "Ratio compared"
              },
              {
                symbol: "m₁, m₂",
                meaning: "Masses",
                unit: "kg",
                typical_values: "e, p, α, etc."
              },
              {
                symbol: "K₁, K₂",
                meaning: "Kinetic energies",
                unit: "J",
                typical_values: "eV usually"
              }
            ],
            derivedFrom: "de-broglie-wavelength",
            applications: [],
            specialCases: ["For same KE: λ ∝ 1/√m (lighter particle has longer λ)", "For same velocity: λ ∝ 1/m", "For same momentum: λ is same for all particles"],
          ...
          },
          {
            ...
            derivedFrom: null,
            applications: [],
            specialCases: ["For same wavelength: photon energy >> electron energy", "Photon has zero rest mass but has momentum", "For electron: E = ½mv² (non-relativistic)"],
          ...
          },
          {
            ...
            latex: "\\lambda = \\frac{h}{\\sqrt{2mK}}",
            description: "When kinetic energy K is given",
            variables: [],
            derivedFrom: "de-broglie-wavelength",
            applications: [],
            specialCases: [],
          ...
          {
            id: "for-accelerated-electron",
            name: "For accelerated electron",
            category: "derived",
            formula: "\\lambda = \\frac{h}{\\sqrt{2meV}} = \\frac{12.27}{\\sqrt{V}} \\text{ Å}",
            latex: "\\lambda = \\frac{h}{\\sqrt{2meV}} = \\frac{12.27}{\\sqrt{V}} \\text{ Å}",
            description: "V in volts",
            variables: [],
            derivedFrom: "de-broglie-wavelength",
            applications: [],
            specialCases: [],
          ...
          {
            id: "thermal-de-broglie",
            name: "Thermal de Broglie",
            category: "derived",
            formula: "\\lambda = \\frac{h}{\\sqrt{3mkT}}",
            latex: "\\lambda = \\frac{h}{\\sqrt{3mkT}}",
            description: "For thermal particles at temperature T",
            variables: [],
            derivedFrom: "de-broglie-wavelength",
            applications: [],
            specialCases: [],
          ...
          {
            id: "ratio-for-same-ke",
            name: "Ratio for same KE",
            category: "derived",
            formula: "\\frac{\\lambda_1}{\\lambda_2} = \\sqrt{\\frac{m_2}{m_1}}",
            latex: "\\frac{\\lambda_1}{\\lambda_2} = \\sqrt{\\frac{m_2}{m_1}}",
            description: "For different particles with same KE",
            variables: [],
            derivedFrom: "de-broglie-wavelength",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "At V = 100 V",
            category: "derived",
            formula: "\\lambda = \\frac{12.27}{\\sqrt{100}} = 1.227 \\text{ Å}",
            latex: "\\lambda = \\frac{12.27}{\\sqrt{100}} = 1.227 \\text{ Å}",
            description: "Common calculation",
            variables: [],
            derivedFrom: "electron-accelerated",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[λ] = Å (10⁻¹⁰ m)",
            neet_frequency: "high",
          },
          {
            ...
            name: "At V = 54 V",
            category: "derived",
            formula: "\\lambda = \\frac{12.27}{\\sqrt{54}} = 1.67 \\text{ Å}",
            latex: "\\lambda = \\frac{12.27}{\\sqrt{54}} = 1.67 \\text{ Å}",
            description: "Davisson-Germer value",
            variables: [],
            derivedFrom: "electron-accelerated",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            category: "derived",
            formula: "V = 10^4 \\text{ V} \\Rightarrow \\lambda \\approx 0.12 \\text{ Å}",
            latex: "V = 10^4 \\text{ V} \\Rightarrow \\lambda \\approx 0.12 \\text{ Å}",
            description: "Very short wavelength for imaging",
            variables: [],
            derivedFrom: "electron-accelerated",
            applications: [],
            specialCases: [],
          ...
          {
            id: "same-ke-different-mass",
            name: "Same KE, different mass",
            category: "derived",
            formula: "\\frac{\\lambda_e}{\\lambda_p} = \\sqrt{\\frac{m_p}{m_e}} \\approx 43",
            latex: "\\frac{\\lambda_e}{\\lambda_p} = \\sqrt{\\frac{m_p}{m_e}} \\approx 43",
            description: "Electron vs proton",
            variables: [],
            derivedFrom: "comparing-particles",
            applications: [],
            specialCases: [],
            dimensionalCheck: "Dimensionless ratio",
            neet_frequency: "high",
          },
          {
            ...
            latex: "\\lambda_1 = \\lambda_2",
            description: "λ depends only on p",
            variables: [],
            derivedFrom: "comparing-particles",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "Same velocity",
            category: "derived",
            formula: "\\frac{\\lambda_1}{\\lambda_2} = \\frac{m_2}{m_1}",
            latex: "\\frac{\\lambda_1}{\\lambda_2} = \\frac{m_2}{m_1}",
            description: "Heavier has shorter λ",
            variables: [],
            derivedFrom: "comparing-particles",
            applications: [],
            specialCases: [],
          ...
          },
          {
            ...
            name: "For same λ",
            category: "derived",
            formula: "E_{photon} = pc = \\frac{hc}{\\lambda}, \\quad E_{particle} = \\frac{h^2}{2m\\lambda^2}",
            latex: "E_{photon} = pc = \\frac{hc}{\\lambda}, \\quad E_{particle} = \\frac{h^2}{2m\\lambda^2}",
            description: "Photon energy >> particle energy",
            variables: [],
            derivedFrom: "photon-vs-particle",
            applications: [],
            specialCases: [],
            dimensionalCheck: "[E] = J or eV",
            neet_frequency: "high",
          ...
          {
            id: "ratio-for-same",
            name: "Ratio for same λ",
            category: "derived",
            formula: "\\frac{E_{photon}}{E_{electron}} = \\frac{2mc\\lambda}{h}",
            latex: "\\frac{E_{photon}}{E_{electron}} = \\frac{2mc\\lambda}{h}",
            description: "Photon has much more energy",
            variables: [],
            derivedFrom: "photon-vs-particle",
            applications: [],
            specialCases: [],
        ...
        variations: [
          {
            type: "numerical",
            description: "de Broglie wavelength from velocity/momentum",
            difficulty: "easy"
          },
          {
            type: "numerical",
            description: "Wavelength of electron accelerated through V volts",
            difficulty: "medium"
          },
          {
            type: "numerical",
            description: "Compare wavelengths of different particles",
            difficulty: "medium"
          },
          {
            type: "conceptual",
            description: "Davisson-Germer experiment significance",
            difficulty: "easy"
          },
          {
            type: "numerical",
            description: "Photon vs electron wavelength comparison",
            difficulty: "medium"
          },
          {
            type: "conceptual",
            description: "Wave-particle duality explanation",
            difficulty: "easy"
          }
        ],
        mostAskedPatterns: [
          {
            pattern: "de Broglie wavelength calculation",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "Electron accelerated through potential",
            frequency: "high",
            yearAsked: [
              2018,
              2019,
          ...
          {
            pattern: "Compare λ of electron, proton, alpha",
            frequency: "high",
            yearAsked: [
              2019,
              2020,
          ...
          {
            pattern: "Effect of changing V on wavelength",
            frequency: "medium",
            yearAsked: [2018, 2020, 2022]
          },
          {
            pattern: "Davisson-Germer experiment",
            frequency: "medium",
