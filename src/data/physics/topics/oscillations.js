...
export const oscillationsTopics = [
  // Topic 1: Simple Harmonic Motion
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'x', meaning: 'Displacement from mean', unit: 'm', typical_values: '-A to +A' },
          { symbol: 'A', meaning: 'Amplitude', unit: 'm', typical_values: 'cm to m' },
          { symbol: 'ω', meaning: 'Angular frequency', unit: 'rad/s', typical_values: '1-100 rad/s' },
          { symbol: 'φ', meaning: 'Initial phase', unit: 'rad', typical_values: '0 to 2π' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'From mean position', latex: 'x = A\\sin(\\omega t)', context: 'φ = 0, starts from center moving +ve', neet_frequency: 'high' },
          { name: 'From extreme', latex: 'x = A\\cos(\\omega t)', context: 'φ = π/2, starts from +A', neet_frequency: 'high' },
        ],
        specialCases: [
          'At t = 0: x = A sin φ',
          'At t = T/4: x = A (if φ = 0)',
      ...
      },
      {
        ...
        variables: [
          { symbol: 'v', meaning: 'Velocity', unit: 'm/s', typical_values: '-v_max to +v_max' },
          { symbol: 'v_max', meaning: 'Maximum velocity', unit: 'm/s', typical_values: 'Aω' },
        ],
        derivedFrom: 'displacement-shm',
        applications: [
          { name: 'Maximum velocity', latex: 'v_{max} = A\\omega', context: 'At mean position (x = 0)', neet_frequency: 'high' },
          { name: 'At half amplitude', latex: 'v = \\omega\\sqrt{A^2 - A^2/4} = \\frac{\\sqrt{3}}{2}A\\omega', context: 'When x = A/2', neet_frequency: 'medium' },
        ],
        specialCases: [
          'v = 0 at x = ±A (extremes)',
          'v = ±v_max at x = 0 (mean)',
      ...
      },
      {
        ...
        variables: [
          { symbol: 'a', meaning: 'Acceleration', unit: 'm/s²', typical_values: '-a_max to +a_max' },
          { symbol: 'a_max', meaning: 'Maximum acceleration', unit: 'm/s²', typical_values: 'Aω²' },
        ],
        derivedFrom: 'velocity-shm',
        applications: [
          { name: 'Maximum acceleration', latex: 'a_{max} = A\\omega^2', context: 'At extremes (x = ±A)', neet_frequency: 'high' },
          { name: 'At x = A/2', latex: 'a = -\\frac{A\\omega^2}{2}', context: 'Half of maximum', neet_frequency: 'medium' },
        ],
        specialCases: [
          'a = 0 at x = 0 (mean position)',
          'a and x always opposite in sign',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'T', meaning: 'Time period', unit: 's', typical_values: '0.1-10 s' },
          { symbol: 'm', meaning: 'Mass', unit: 'kg', typical_values: '0.01-10 kg' },
          { symbol: 'k', meaning: 'Spring constant', unit: 'N/m', typical_values: '1-1000 N/m' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Frequency', latex: 'f = \\frac{1}{T} = \\frac{\\omega}{2\\pi}', context: 'Oscillations per second', neet_frequency: 'high' },
          { name: 'Angular frequency', latex: '\\omega = \\sqrt{\\frac{k}{m}}', context: 'From spring constant and mass', neet_frequency: 'high' },
        ],
        specialCases: [
          'T independent of amplitude A',
          'T ∝ √m, T ∝ 1/√k',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'E', meaning: 'Total energy', unit: 'J', typical_values: 'Constant' },
          { symbol: 'KE', meaning: 'Kinetic energy', unit: 'J', typical_values: '0 to E' },
          { symbol: 'PE', meaning: 'Potential energy', unit: 'J', typical_values: '0 to E' },
        ],
        derivedFrom: 'displacement-shm',
        applications: [
          { name: 'KE at position x', latex: 'KE = \\frac{1}{2}m\\omega^2(A^2 - x^2)', context: 'Kinetic energy', neet_frequency: 'high' },
          { name: 'PE at position x', latex: 'PE = \\frac{1}{2}m\\omega^2 x^2 = \\frac{1}{2}kx^2', context: 'Potential energy', neet_frequency: 'high' },
          { name: 'At x = A/√2', latex: 'KE = PE = \\frac{E}{2}', context: 'Energy equally divided', neet_frequency: 'high' },
        ],
        specialCases: [
          'At x = 0: KE = max, PE = 0',
          'At x = ±A: KE = 0, PE = max',
    ...
    variations: [
      { type: 'numerical', description: 'Find v, a at given x or t', difficulty: 'medium' },
      { type: 'numerical', description: 'Energy at different positions', difficulty: 'medium' },
      { type: 'numerical', description: 'Time to reach certain position', difficulty: 'hard' },
      { type: 'graphical', description: 'x-t, v-t, a-t graphs', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Velocity at given position', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022, 2023] },
      { pattern: 'Energy problems in SHM', frequency: 'high', yearAsked: [2019, 2020, 2022, 2023] },
      { pattern: 'Phase and initial conditions', frequency: 'medium', yearAsked: [2018, 2021, 2022] },
    ],
  ...
  // Topic 2: Spring-Block System
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'T', meaning: 'Time period', unit: 's', typical_values: '0.1-5 s' },
          { symbol: 'm', meaning: 'Mass attached', unit: 'kg', typical_values: '0.01-10 kg' },
          { symbol: 'k', meaning: 'Spring constant', unit: 'N/m', typical_values: '1-1000 N/m' },
        ],
        derivedFrom: 'time-period-shm',
        applications: [
          { name: 'Angular frequency', latex: '\\omega = \\sqrt{\\frac{k}{m}}', context: 'Derived quantity', neet_frequency: 'high' },
        ],
        specialCases: [
          'T independent of amplitude',
          'T independent of g (same in space)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'k_eq', meaning: 'Equivalent spring constant', unit: 'N/m', typical_values: 'Less than smallest k' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Two springs', latex: 'k_{eq} = \\frac{k_1 k_2}{k_1 + k_2}', context: 'Product over sum', neet_frequency: 'high' },
          { name: 'n identical springs', latex: 'k_{eq} = \\frac{k}{n}', context: 'Each spring k', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Series makes system softer (lower k, longer T)',
      ...
      },
      {
        ...
        variables: [
          { symbol: 'k_eq', meaning: 'Equivalent spring constant', unit: 'N/m', typical_values: 'Sum of all k' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'n identical springs', latex: 'k_{eq} = nk', context: 'Each spring k', neet_frequency: 'high' },
        ],
        specialCases: [
          'Parallel makes system stiffer (higher k, shorter T)',
          'Same extension in all springs',
        ],
        dimensionalCheck: '[k] = N/m',
      },
    ],
    ...
    variations: [
      { type: 'numerical', description: 'T for spring-mass system', difficulty: 'easy' },
      { type: 'numerical', description: 'Springs in series/parallel', difficulty: 'medium' },
      { type: 'numerical', description: 'Cut spring problems', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Time period of spring-mass', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'Springs in series/parallel', frequency: 'high', yearAsked: [2019, 2021, 2022] },
    ],
  ...
  // Topic 3: Simple Pendulum
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'T', meaning: 'Time period', unit: 's', typical_values: '1-5 s' },
          { symbol: 'L', meaning: 'Length of pendulum', unit: 'm', typical_values: '0.1-2 m' },
          { symbol: 'g', meaning: 'Acceleration due to gravity', unit: 'm/s²', typical_values: '9.8 m/s²' },
        ],
        derivedFrom: 'time-period-shm',
        applications: [
          { name: "Second's pendulum", latex: 'L = \\frac{gT^2}{4\\pi^2} \\approx 1m', context: 'T = 2s pendulum', neet_frequency: 'high' },
          { name: 'In elevator (up)', latex: 'g_{eff} = g + a, T \\downarrow', context: 'Accelerating upward', neet_frequency: 'high' },
          { name: 'In elevator (down)', latex: 'g_{eff} = g - a, T \\uparrow', context: 'Accelerating downward', neet_frequency: 'high' },
        ],
        specialCases: [
          'In free fall: g_eff = 0, T → ∞ (no oscillation)',
          'T ∝ √L, T ∝ 1/√g',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'g_eff', meaning: 'Effective gravity', unit: 'm/s²', typical_values: '0 to 20 m/s²' },
          { symbol: 'a', meaning: 'Acceleration of frame', unit: 'm/s²', typical_values: '1-10 m/s²' },
        ],
        derivedFrom: 'pendulum-time-period',
        applications: [
          { name: 'Horizontal acceleration', latex: 'g_{eff} = \\sqrt{g^2 + a^2}', context: 'Car/train accelerating', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Up acceleration: +, Down acceleration: -',
          'Free fall: g_eff = 0',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Calculate T for given L', difficulty: 'easy' },
      { type: 'numerical', description: 'Pendulum in accelerating frame', difficulty: 'medium' },
      { type: 'numerical', description: 'Change in T with L or g', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Simple pendulum time period', frequency: 'high', yearAsked: [2018, 2019, 2021, 2022, 2023] },
      { pattern: 'Effective g problems', frequency: 'medium', yearAsked: [2019, 2020, 2022] },
    ],
  ...
  // Topic 4: SHM Graphs and Phase Relations
  {
    id: 'shm-graphs',
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'φ_x', meaning: 'Phase of displacement', unit: 'rad', typical_values: 'Reference' },
          { symbol: 'φ_v', meaning: 'Phase of velocity', unit: 'rad', typical_values: 'φ_x + π/2' },
          { symbol: 'φ_a', meaning: 'Phase of acceleration', unit: 'rad', typical_values: 'φ_x + π' },
        ],
        derivedFrom: 'displacement-shm',
        applications: [
          { name: 'When x = 0', latex: 'v = \\pm v_{max}, a = 0', context: 'At mean position', neet_frequency: 'high' },
          { name: 'When x = ±A', latex: 'v = 0, a = \\mp a_{max}', context: 'At extreme positions', neet_frequency: 'high' },
        ],
        specialCases: [
          'x and a are 180° out of phase (opposite)',
          'v is 90° ahead of x',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'v', meaning: 'Velocity', unit: 'm/s', typical_values: '-Aω to +Aω' },
          { symbol: 'x', meaning: 'Displacement', unit: 'm', typical_values: '-A to +A' },
        ],
        derivedFrom: 'velocity-shm',
        applications: [
          { name: 'Semi-major axis', latex: 'v_{max} = A\\omega', context: 'Along v-axis', neet_frequency: 'high' },
          { name: 'Semi-minor axis', latex: 'x_{max} = A', context: 'Along x-axis', neet_frequency: 'high' },
        ],
        specialCases: [
          'Ellipse shape (not circle unless ω = 1)',
          'Clockwise motion if x = A sin(ωt)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'a', meaning: 'Acceleration', unit: 'm/s²', typical_values: '-Aω² to +Aω²' },
        ],
        derivedFrom: 'acceleration-shm',
        applications: [
          { name: 'Slope', latex: '\\text{slope} = -\\omega^2 = -\\frac{4\\pi^2}{T^2}', context: 'Find ω from graph', neet_frequency: 'high' },
        ],
        specialCases: [
    ...
    variations: [
      { type: 'graphical', description: 'Identify correct x-t, v-t, a-t graph', difficulty: 'medium' },
      { type: 'graphical', description: 'Find ω from a-x graph slope', difficulty: 'medium' },
      { type: 'conceptual', description: 'Phase difference between quantities', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Identify SHM from graphs', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022] },
      { pattern: 'Phase relations', frequency: 'high', yearAsked: [2019, 2020, 2021, 2023] },
      { pattern: 'a-x graph analysis', frequency: 'medium', yearAsked: [2018, 2021, 2022] },
    ],
  ...
  // Topic 5: Physical/Compound Pendulum
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'T', meaning: 'Time period', unit: 's', typical_values: '0.5-5 s' },
          { symbol: 'I', meaning: 'Moment of inertia about pivot', unit: 'kg·m²', typical_values: 'Depends on shape' },
          { symbol: 'm', meaning: 'Mass of pendulum', unit: 'kg', typical_values: '0.1-10 kg' },
          { symbol: 'd', meaning: 'Distance from pivot to CM', unit: 'm', typical_values: '0.1-1 m' },
        ],
        derivedFrom: 'time-period-shm',
        applications: [
          { name: 'Using parallel axis', latex: 'I = I_{cm} + md^2', context: 'Find I about pivot', neet_frequency: 'high' },
          { name: 'Equivalent length', latex: 'L_{eq} = \\frac{I}{md}', context: 'Compare to simple pendulum', neet_frequency: 'high' },
        ],
        specialCases: [
          'For simple pendulum: I = mL², d = L, so T = 2π√(L/g)',
          'T depends on axis position',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'L', meaning: 'Length of rod', unit: 'm', typical_values: '0.5-2 m' },
        ],
        derivedFrom: 'physical-pendulum-period',
        applications: [
          { name: 'I for rod at end', latex: 'I = \\frac{mL^2}{3}', context: 'Using parallel axis theorem', neet_frequency: 'high' },
          { name: 'Equivalent length', latex: 'L_{eq} = \\frac{2L}{3}', context: 'Less than actual length', neet_frequency: 'medium' },
        ],
        specialCases: [
          'd = L/2 for rod pivoted at end',
          'L_eq = 2L/3 < L',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'R', meaning: 'Radius', unit: 'm', typical_values: '0.1-0.5 m' },
        ],
        derivedFrom: 'physical-pendulum-period',
        applications: [
          { name: 'Ring (I = 2mR²)', latex: 'L_{eq} = 2R', context: 'Pivoted at rim', neet_frequency: 'medium' },
          { name: 'Disc (I = 3mR²/2)', latex: 'L_{eq} = \\frac{3R}{2}', context: 'Pivoted at rim', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Ring pivoted at rim: I = mR² + mR² = 2mR²',
          'Disc pivoted at rim: I = mR²/2 + mR² = 3mR²/2',
        ],
        dimensionalCheck: '[T] = s',
      },
    ],
    ...
    variations: [
      { type: 'numerical', description: 'Time period of rod pendulum', difficulty: 'medium' },
      { type: 'numerical', description: 'Equivalent length calculation', difficulty: 'medium' },
      { type: 'numerical', description: 'Ring/disc pendulum', difficulty: 'hard' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Rod pendulum time period', frequency: 'high', yearAsked: [2018, 2019, 2021, 2022] },
      { pattern: 'Equivalent simple pendulum length', frequency: 'medium', yearAsked: [2019, 2020, 2023] },
    ],
  ...
  // Topic 6: Damped Oscillations
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'A(t)', meaning: 'Amplitude at time t', unit: 'm', typical_values: 'Decreasing' },
          { symbol: 'A₀', meaning: 'Initial amplitude', unit: 'm', typical_values: 'Given' },
          { symbol: 'b', meaning: 'Damping coefficient', unit: 'kg/s', typical_values: 'Depends on medium' },
          { symbol: 'γ', meaning: 'Damping constant = b/2m', unit: 's⁻¹', typical_values: 'γ = b/2m' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Half-life of amplitude', latex: 't_{1/2} = \\frac{2m\\ln 2}{b}', context: 'Time for A to halve', neet_frequency: 'medium' },
          { name: 'Relaxation time', latex: '\\tau = \\frac{2m}{b}', context: 'Time for A to become A₀/e', neet_frequency: 'medium' },
        ],
        specialCases: [
          'For no damping (b = 0): A = A₀ (constant)',
          'Amplitude never becomes exactly zero',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'E(t)', meaning: 'Energy at time t', unit: 'J', typical_values: 'Decreasing' },
          { symbol: 'E₀', meaning: 'Initial energy', unit: 'J', typical_values: '½kA₀²' },
        ],
        derivedFrom: 'damped-amplitude',
        applications: [
          { name: 'Since E ∝ A²', latex: 'E(t) = E_0 e^{-2\\gamma t}', context: 'Energy decays twice as fast as amplitude', neet_frequency: 'medium' },
        ],
        specialCases: [
      ...
      },
      {
        ...
        variables: [
          { symbol: 'Q', meaning: 'Quality factor', unit: 'dimensionless', typical_values: '10-1000 for mechanical' },
          { symbol: 'ω₀', meaning: 'Natural angular frequency', unit: 'rad/s', typical_values: '√(k/m)' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Energy loss per cycle', latex: '\\frac{\\Delta E}{E} = \\frac{2\\pi}{Q}', context: 'Fraction of energy lost per cycle', neet_frequency: 'low' },
        ],
        specialCases: [
    ...
    variations: [
      { type: 'numerical', description: 'Amplitude after n oscillations', difficulty: 'medium' },
      { type: 'conceptual', description: 'Types of damping', difficulty: 'easy' },
      { type: 'numerical', description: 'Energy decay calculation', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Amplitude decay', frequency: 'medium', yearAsked: [2018, 2020, 2022] },
      { pattern: 'Types of damping', frequency: 'medium', yearAsked: [2019, 2021, 2023] },
    ],
  ...
  // Topic 7: Forced Oscillations and Resonance
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'A', meaning: 'Steady-state amplitude', unit: 'm', typical_values: 'Depends on conditions' },
          { symbol: 'F₀', meaning: 'Amplitude of driving force', unit: 'N', typical_values: 'Given' },
          { symbol: 'ω_d', meaning: 'Driving angular frequency', unit: 'rad/s', typical_values: 'Given' },
          { symbol: 'ω₀', meaning: 'Natural angular frequency', unit: 'rad/s', typical_values: '√(k/m)' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'At resonance (ω_d = ω₀)', latex: 'A_{res} = \\frac{F_0}{b\\omega_0}', context: 'Maximum amplitude', neet_frequency: 'high' },
        ],
        specialCases: [
          'A → ∞ as b → 0 at resonance (undamped)',
          'A decreases as ω_d moves away from ω₀',
        ],
        dimensionalCheck: '[A] = m',
      },
      {
        ...
        variables: [
          { symbol: 'ω_d', meaning: 'Driving frequency for resonance', unit: 'rad/s', typical_values: 'Equal to ω₀' },
        ],
        derivedFrom: 'resonance-amplitude',
        applications: [
          { name: 'Frequency form', latex: 'f_d = f_0 = \\frac{1}{2\\pi}\\sqrt{\\frac{k}{m}}', context: 'In Hz', neet_frequency: 'high' },
          { name: 'Maximum energy transfer', latex: '\\text{Power } \\propto A^2 \\omega_d^2', context: 'At resonance', neet_frequency: 'medium' },
        ],
        specialCases: [
      ...
      },
      {
        ...
        variables: [
          { symbol: 'Δω', meaning: 'Bandwidth', unit: 'rad/s', typical_values: 'Small for high Q' },
          { symbol: 'Q', meaning: 'Quality factor', unit: 'dimensionless', typical_values: '10-1000' },
        ],
        derivedFrom: 'quality-factor',
        applications: [
          { name: 'High Q system', latex: '\\text{Sharp peak, narrow } \\Delta\\omega', context: 'Low damping', neet_frequency: 'medium' },
          { name: 'Low Q system', latex: '\\text{Broad peak, large } \\Delta\\omega', context: 'High damping', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Q = ω₀/Δω (can find Q from resonance curve)',
          'Higher Q means more selective resonance',
        ],
    ...
    variations: [
      { type: 'conceptual', description: 'Resonance conditions and effects', difficulty: 'easy' },
      { type: 'numerical', description: 'Resonance frequency calculation', difficulty: 'medium' },
      { type: 'graphical', description: 'Resonance curve interpretation', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Resonance condition', frequency: 'high', yearAsked: [2018, 2019, 2021, 2022, 2023] },
      { pattern: 'Effect of damping on resonance', frequency: 'medium', yearAsked: [2019, 2020, 2022] },
    ],
  ...
  // Topic 8: Angular SHM and Torsional Pendulum
  {
    id: 'angular-shm',
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'T', meaning: 'Time period', unit: 's', typical_values: '0.5-5 s' },
          { symbol: 'I', meaning: 'Moment of inertia about axis', unit: 'kg·m²', typical_values: '10⁻⁴ to 10⁻¹ kg·m²' },
          { symbol: 'κ', meaning: 'Torsional constant', unit: 'N·m/rad', typical_values: 'Depends on wire' },
        ],
        derivedFrom: 'time-period-shm',
        applications: [
          { name: 'Angular frequency', latex: '\\omega = \\sqrt{\\frac{\\kappa}{I}}', context: 'Analogous to √(k/m)', neet_frequency: 'high' },
          { name: 'Find I', latex: 'I = \\frac{\\kappa T^2}{4\\pi^2}', context: 'Determine moment of inertia', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Analogous to spring: κ ↔ k, I ↔ m',
          'Used to measure I experimentally',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'θ', meaning: 'Angular displacement', unit: 'rad', typical_values: '-θ₀ to +θ₀' },
          { symbol: 'θ₀', meaning: 'Angular amplitude', unit: 'rad', typical_values: 'Small angles' },
        ],
        derivedFrom: 'displacement-shm',
        applications: [
          { name: 'Angular velocity', latex: '\\Omega = \\theta_0 \\omega \\cos(\\omega t + \\phi)', context: 'dθ/dt', neet_frequency: 'medium' },
          { name: 'Angular acceleration', latex: '\\alpha = -\\theta_0 \\omega^2 \\sin(\\omega t + \\phi) = -\\omega^2 \\theta', context: 'd²θ/dt²', neet_frequency: 'medium' },
        ],
        specialCases: [
          'All linear SHM formulas apply with angular quantities',
          'Ω_max = θ₀ω at θ = 0',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'E', meaning: 'Total energy', unit: 'J', typical_values: 'Constant' },
          { symbol: 'θ₀', meaning: 'Angular amplitude', unit: 'rad', typical_values: 'Given' },
        ],
        derivedFrom: 'energy-shm',
        applications: [
          { name: 'KE in angular SHM', latex: 'KE = \\frac{1}{2}I\\Omega^2', context: 'Rotational kinetic energy', neet_frequency: 'medium' },
          { name: 'PE in angular SHM', latex: 'PE = \\frac{1}{2}\\kappa\\theta^2', context: 'Elastic potential energy', neet_frequency: 'medium' },
        ],
        specialCases: [
          'E ∝ θ₀² (like E ∝ A²)',
          'KE + PE = constant',
    ...
    variations: [
      { type: 'numerical', description: 'Time period of torsional pendulum', difficulty: 'medium' },
      { type: 'numerical', description: 'Find moment of inertia from oscillation', difficulty: 'medium' },
      { type: 'conceptual', description: 'Linear vs angular SHM analogy', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Torsional pendulum time period', frequency: 'medium', yearAsked: [2018, 2020, 2022] },
      { pattern: 'Angular SHM analogy', frequency: 'medium', yearAsked: [2019, 2021, 2023] },
    ],
