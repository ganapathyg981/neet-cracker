...
export const centreOfMassTopics = [
  // Topic 1: Centre of Mass Position
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'x_cm', meaning: 'x-coordinate of COM', unit: 'm', typical_values: 'Weighted average' },
          { symbol: 'mᵢ', meaning: 'Individual masses', unit: 'kg', typical_values: 'Given' },
          { symbol: 'xᵢ', meaning: 'x-coordinates of masses', unit: 'm', typical_values: 'Given' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Two masses', latex: 'x_{cm} = \\frac{m_1x_1 + m_2x_2}{m_1 + m_2}', context: 'Divides line in ratio m₂:m₁', neet_frequency: 'high' },
          { name: 'Distance from masses', latex: 'r_1:r_2 = m_2:m_1', context: 'COM closer to heavier mass', neet_frequency: 'high' },
          { name: 'In 2D', latex: 'y_{cm} = \\frac{\\sum m_iy_i}{\\sum m_i}', context: 'Apply separately for x, y', neet_frequency: 'high' },
        ],
        specialCases: [
          'For two masses: COM divides distance in inverse ratio of masses',
          'For equal masses: COM is at midpoint',
          'COM is closer to heavier mass',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'dm', meaning: 'Mass element', unit: 'kg', typical_values: 'λdx or σdA or ρdV' },
          { symbol: 'M', meaning: 'Total mass', unit: 'kg', typical_values: '∫dm' },
        ],
        derivedFrom: 'com-discrete',
        applications: [
          { name: 'Uniform rod', latex: 'x_{cm} = L/2', context: 'At center', neet_frequency: 'high' },
          { name: 'Semicircular ring', latex: 'y_{cm} = \\frac{2R}{\\pi}', context: 'From center, on axis of symmetry', neet_frequency: 'high' },
          { name: 'Semicircular disc', latex: 'y_{cm} = \\frac{4R}{3\\pi}', context: 'From center, on axis of symmetry', neet_frequency: 'high' },
        ],
        specialCases: [
      ...
      },
      {
        ...
        variables: [
          { symbol: 'x₁, x₂', meaning: 'COM positions of individual bodies', unit: 'm', typical_values: 'Known from geometry' },
        ],
        derivedFrom: 'com-discrete',
        applications: [
          { name: 'Cavity in body', latex: 'x_{cm} = \\frac{Mx_1 - m_{cavity}x_2}{M - m_{cavity}}', context: 'Subtract cavity contribution', neet_frequency: 'high' },
          { name: 'Two connected bodies', latex: 'x_{cm} = \\frac{m_1x_1 + m_2x_2}{m_1 + m_2}', context: 'Treat each body as point mass at its COM', neet_frequency: 'high' },
        ],
        specialCases: [
          'For cavity: treat as negative mass at cavity position',
          'COM shifts away from removed portion',
        ],
        dimensionalCheck: '[x_cm] = m',
      },
    ],
    ...
    variations: [
      { type: 'numerical', description: 'COM of two or more particles', difficulty: 'easy' },
      { type: 'numerical', description: 'COM of standard shapes (semicircle, hemisphere)', difficulty: 'medium' },
      { type: 'numerical', description: 'COM of body with cavity', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'COM of discrete masses', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022] },
      { pattern: 'COM of standard continuous bodies', frequency: 'high', yearAsked: [2019, 2020, 2022, 2023] },
      { pattern: 'COM with cavity problems', frequency: 'medium', yearAsked: [2018, 2021, 2023] },
    ],
  ...
  // Topic 2: Motion of Centre of Mass
  {
    id: 'motion-of-com',
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'v_cm', meaning: 'Velocity of COM', unit: 'm/s', typical_values: 'Weighted average' },
          { symbol: 'vᵢ', meaning: 'Velocities of particles', unit: 'm/s', typical_values: 'Given' },
          { symbol: 'M', meaning: 'Total mass', unit: 'kg', typical_values: 'Σmᵢ' },
        ],
        derivedFrom: 'com-discrete',
        applications: [
          { name: 'Two body system', latex: 'v_{cm} = \\frac{m_1v_1 + m_2v_2}{m_1 + m_2}', context: 'Two particles', neet_frequency: 'high' },
          { name: 'Momentum relation', latex: 'Mv_{cm} = p_{total}', context: 'Total momentum', neet_frequency: 'high' },
        ],
        specialCases: [
          'If system at rest initially: Σmᵢvᵢ = 0 always',
          'v_cm constant if F_ext = 0',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'a_cm', meaning: 'Acceleration of COM', unit: 'm/s²', typical_values: 'Depends on F_ext' },
          { symbol: 'F_ext', meaning: 'Net external force', unit: 'N', typical_values: 'Sum of all external forces' },
        ],
        derivedFrom: 'com-velocity',
        applications: [
          { name: 'No external force', latex: 'a_{cm} = 0, v_{cm} = const', context: 'COM moves uniformly', neet_frequency: 'high' },
          { name: 'Only gravity', latex: 'a_{cm} = g', context: 'COM follows projectile path', neet_frequency: 'high' },
        ],
        specialCases: [
          'Internal forces (explosion, collision) don\'t affect a_cm',
          'Only external forces count',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'Δx₁, Δx₂', meaning: 'Displacements of masses', unit: 'm', typical_values: 'Opposite signs' },
        ],
        derivedFrom: 'com-velocity',
        applications: [
          { name: 'Man on boat', latex: 'm_1d_1 = m_2d_2', context: 'Distances moved in opposite directions', neet_frequency: 'high' },
          { name: 'Recoil of gun', latex: 'm_{bullet}v_{bullet} = m_{gun}v_{gun}', context: 'Momentum conservation', neet_frequency: 'high' },
        ],
        specialCases: [
          'If initially at rest, COM stays at initial position',
    ...
    variations: [
      { type: 'numerical', description: 'COM velocity of two-body system', difficulty: 'easy' },
      { type: 'numerical', description: 'Man-boat/plank problems', difficulty: 'medium' },
      { type: 'numerical', description: 'Explosion and recoil problems', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'COM after explosion', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022] },
      { pattern: 'Man-boat problems', frequency: 'high', yearAsked: [2019, 2021, 2022, 2023] },
      { pattern: 'Recoil problems', frequency: 'medium', yearAsked: [2018, 2020, 2023] },
    ],
  ...
  // Topic 3: Linear Momentum and Impulse
  {
    id: 'momentum-impulse',
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'p', meaning: 'Momentum', unit: 'kg⋅m/s', typical_values: '0.1-1000 kg⋅m/s' },
          { symbol: 'm', meaning: 'Mass', unit: 'kg', typical_values: '0.1-100 kg' },
          { symbol: 'v', meaning: 'Velocity', unit: 'm/s', typical_values: '1-100 m/s' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Momentum conservation', latex: 'm_1u_1 + m_2u_2 = m_1v_1 + m_2v_2', context: 'If F_ext = 0', neet_frequency: 'high' },
          { name: 'Relation with KE', latex: 'p = \\sqrt{2mKE}', context: 'Connecting momentum and energy', neet_frequency: 'high' },
        ],
        specialCases: [
          'Momentum is vector (has direction)',
      ...
      },
      {
        ...
        variables: [
          { symbol: 'J', meaning: 'Impulse', unit: 'N⋅s = kg⋅m/s', typical_values: 'Equals Δp' },
          { symbol: 'Δp', meaning: 'Change in momentum', unit: 'kg⋅m/s', typical_values: 'p_f - p_i' },
        ],
        derivedFrom: 'momentum-formula',
        applications: [
          { name: 'Constant force', latex: 'J = F\\Delta t', context: 'Force × time', neet_frequency: 'high' },
          { name: 'Ball hitting wall', latex: 'J = 2mv', context: 'If velocity reverses', neet_frequency: 'high' },
          { name: 'Average force', latex: 'F_{avg} = \\frac{\\Delta p}{\\Delta t}', context: 'From impulse-momentum', neet_frequency: 'high' },
        ],
        specialCases: [
          'J = area under F-t curve',
          'Impulse and momentum have same units',
          'For ball bouncing: J = m(v₂ - v₁) with proper signs',
        ],
      ...
      },
      {
        ...
        applications: [
          { name: 'Collision', latex: 'm_1u_1 + m_2u_2 = m_1v_1 + m_2v_2', context: 'Before = after', neet_frequency: 'high' },
          { name: 'Explosion/recoil', latex: '0 = m_1v_1 + m_2v_2', context: 'If initially at rest', neet_frequency: 'high' },
        ],
        specialCases: [
          'Valid in all collisions (elastic or inelastic)',
          'Apply component-wise in 2D',
          'Valid even during collision when internal forces are large',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Impulse from force-time data', difficulty: 'easy' },
      { type: 'numerical', description: 'Average force from momentum change', difficulty: 'medium' },
      { type: 'numerical', description: 'Momentum conservation problems', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Impulse calculation', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022] },
      { pattern: 'Average force from momentum change', frequency: 'high', yearAsked: [2019, 2020, 2022, 2023] },
      { pattern: 'Ball bouncing (impulse)', frequency: 'high', yearAsked: [2018, 2021, 2023] },
    ],
