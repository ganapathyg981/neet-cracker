...
export const unitsAndMeasurementsTopics = [
  // Topic 1: Significant Figures
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'SF', meaning: 'Significant figures', unit: 'count', typical_values: '1-6 typically' },
        ],
        derivedFrom: null,
        applications: [
          { id: 'sf-nonzero', name: 'Non-zero digits', latex: '123 \\text{ has 3 SF}', context: 'All non-zero are significant', neet_frequency: 'high' },
          { id: 'sf-sandwiched', name: 'Sandwiched zeros', latex: '1002 \\text{ has 4 SF}', context: 'Zeros between non-zero count', neet_frequency: 'high' },
          { id: 'sf-leading', name: 'Leading zeros', latex: '0.005 \\text{ has 1 SF}', context: 'Leading zeros don\'t count', neet_frequency: 'high' },
          { id: 'sf-trailing', name: 'Trailing zeros after decimal', latex: '3.500 \\text{ has 4 SF}', context: 'After decimal, trailing zeros count', neet_frequency: 'high' },
        ],
        specialCases: [
          'Scientific notation removes ambiguity: 5.0 × 10³ has 2 SF',
          'Exact numbers (like counting) have infinite SF',
        ],
      ...
      },
      {
        ...
        applications: [
          { id: 'sf-multiply', name: 'Multiplication', latex: '3.2 \\times 2.1 = 6.72 \\rightarrow 6.7', context: '2 SF in each, result has 2 SF', neet_frequency: 'high' },
          { id: 'sf-addition', name: 'Addition', latex: '3.25 + 2.1 = 5.35 \\rightarrow 5.4', context: 'Match decimal places, not SF', neet_frequency: 'high' },
        ],
        specialCases: [
          'For +/- : match decimal places',
          'For ×/÷ : match significant figures',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Count significant figures', difficulty: 'easy' },
      { type: 'numerical', description: 'Arithmetic with significant figures', difficulty: 'medium' },
      { type: 'conceptual', description: 'Identify rules for SF', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Count SF in given numbers', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022, 2023] },
      { pattern: 'Round result to correct SF', frequency: 'high', yearAsked: [2019, 2020, 2022] },
    ],
  ...
  // Topic 2: Errors in Measurement
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'Δa', meaning: 'Absolute error', unit: 'Same as quantity', typical_values: 'Small compared to value' },
          { symbol: 'a', meaning: 'True value', unit: 'Varies', typical_values: 'Best estimate' },
        ],
        derivedFrom: null,
        applications: [
          { id: 'err-mean-abs', name: 'Mean absolute error', latex: '\\Delta a_{mean} = \\frac{\\sum |a_i - a_{mean}|}{n}', context: 'Average of absolute errors', neet_frequency: 'high' },
        ],
        specialCases: [
          'Always positive (magnitude)',
          'Has same units as the measured quantity',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'Δa/a', meaning: 'Relative error', unit: 'dimensionless', typical_values: '0.001 to 0.1' },
          { symbol: '% error', meaning: 'Percentage error', unit: '%', typical_values: '0.1% to 10%' },
        ],
        derivedFrom: 'absolute-error',
        applications: [
          { id: 'err-percent', name: 'Percentage error calculation', latex: '\\text{\\% error} = \\frac{\\Delta a}{a} \\times 100\\%', context: 'Convert relative to percentage', neet_frequency: 'high' },
          { id: 'err-compare', name: 'Comparing precision', latex: '\\text{Lower } \\frac{\\Delta a}{a} \\Rightarrow \\text{more precise}', context: 'Relative error for comparison', neet_frequency: 'high' },
        ],
        specialCases: [
          'Dimensionless (ratio)',
          'Useful for comparing errors of different quantities',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'a, b', meaning: 'Exponents in formula', unit: 'dimensionless', typical_values: 'Powers of x, y' },
        ],
        derivedFrom: 'relative-error',
        applications: [
          { id: 'err-sum', name: 'For A = x + y', latex: '\\Delta A = \\Delta x + \\Delta y', context: 'Absolute errors add', neet_frequency: 'high' },
          { id: 'err-product', name: 'For A = x × y', latex: '\\frac{\\Delta A}{A} = \\frac{\\Delta x}{x} + \\frac{\\Delta y}{y}', context: 'Relative errors add', neet_frequency: 'high' },
          { id: 'err-power', name: 'For A = x^n', latex: '\\frac{\\Delta A}{A} = n\\frac{\\Delta x}{x}', context: 'Power multiplies relative error', neet_frequency: 'high' },
        ],
        specialCases: [
          'Higher power → larger error contribution',
          'Use absolute value of exponents',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Calculate percentage error', difficulty: 'easy' },
      { type: 'numerical', description: 'Error propagation in formulas', difficulty: 'medium' },
      { type: 'conceptual', description: 'Types of errors', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Percentage error calculation', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022, 2023] },
      { pattern: 'Error in derived quantity', frequency: 'high', yearAsked: [2019, 2020, 2022, 2023] },
      { pattern: 'Maximum error from formula', frequency: 'medium', yearAsked: [2018, 2021, 2022] },
    ],
  ...
  // Topic 3: Measuring Instruments
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'LC', meaning: 'Least count', unit: 'cm or mm', typical_values: '0.01 cm = 0.1 mm' },
          { symbol: 'MSD', meaning: 'Main scale division', unit: 'cm or mm', typical_values: '1 mm' },
          { symbol: 'VSD', meaning: 'Vernier scale division', unit: 'cm or mm', typical_values: '0.9 mm' },
          { symbol: 'n', meaning: 'Number of VSD in (n-1) MSD', unit: 'dimensionless', typical_values: '10' },
        ],
        derivedFrom: null,
        applications: [
          { id: 'vernier-standard', name: 'Standard vernier', latex: 'LC = \\frac{1 \\text{ mm}}{10} = 0.1 \\text{ mm}', context: '10 VSD = 9 MSD', neet_frequency: 'high' },
          { id: 'vernier-reading', name: 'Reading', latex: '\\text{Reading} = \\text{MSR} + (n \\times LC)', context: 'n is coinciding vernier division', neet_frequency: 'high' },
        ],
        specialCases: [
          'MSR is main scale reading just before vernier zero',
          'n is the vernier division coinciding with main scale',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'LC', meaning: 'Least count', unit: 'mm', typical_values: '0.01 mm' },
          { symbol: 'Pitch', meaning: 'Linear distance per full rotation', unit: 'mm', typical_values: '0.5 or 1 mm' },
          { symbol: 'N', meaning: 'Number of circular scale divisions', unit: 'dimensionless', typical_values: '50 or 100' },
        ],
        derivedFrom: null,
        applications: [
          { id: 'sg-standard', name: 'Standard screw gauge', latex: 'LC = \\frac{1 \\text{ mm}}{100} = 0.01 \\text{ mm}', context: 'Pitch 1mm, 100 divisions', neet_frequency: 'high' },
          { id: 'sg-reading', name: 'Reading', latex: '\\text{Reading} = \\text{PSR} + (n \\times LC)', context: 'n is circular scale reading', neet_frequency: 'high' },
          { id: 'sg-lc-calc', name: 'LC calculation', latex: 'LC = \\frac{\\text{Pitch}}{N}', context: 'For any pitch and divisions', neet_frequency: 'high' },
        ],
        specialCases: [
          'PSR is pitch scale reading',
          'More precise than vernier caliper',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'Zero error', meaning: 'Reading when jaws touch', unit: 'mm', typical_values: '+ve or -ve' },
        ],
        derivedFrom: null,
        applications: [
          { id: 'ze-positive', name: 'Positive zero error', latex: '\\text{True} = \\text{Obs} - (+\\text{ZE})', context: 'Zero on right of reference', neet_frequency: 'high' },
          { id: 'ze-negative', name: 'Negative zero error', latex: '\\text{True} = \\text{Obs} - (-\\text{ZE}) = \\text{Obs} + |\\text{ZE}|', context: 'Zero on left of reference', neet_frequency: 'high' },
        ],
        specialCases: [
          '+ve ZE: subtract from reading',
          '-ve ZE: add to reading',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Calculate least count', difficulty: 'easy' },
      { type: 'numerical', description: 'Find reading with zero error correction', difficulty: 'medium' },
      { type: 'conceptual', description: 'Compare precision of instruments', difficulty: 'easy' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Least count calculation', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022, 2023] },
      { pattern: 'Zero error correction', frequency: 'high', yearAsked: [2019, 2020, 2022, 2023] },
      { pattern: 'Reading from given scale position', frequency: 'medium', yearAsked: [2018, 2021, 2022] },
    ],
