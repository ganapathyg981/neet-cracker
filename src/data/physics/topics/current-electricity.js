...
export const currentElectricityTopics = [
  // Topic 1: Kirchhoff's Laws and Combination of Resistances
  {
    id: 'kirchhoffs-laws',
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'I', meaning: 'Electric current', unit: 'A (Ampere)', typical_values: 'mA to A in circuits' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Junction current distribution', latex: 'I_1 = I_2 + I_3', context: 'When current splits at a junction', neet_frequency: 'high' },
          { name: 'Parallel current calculation', latex: 'I_{total} = I_1 + I_2 + ... + I_n', context: 'Finding total current in parallel branches', neet_frequency: 'high' },
        ],
        specialCases: [
          'At a simple junction with 2 branches: I_in = I_out',
          'For n branches meeting: I₁ + I₂ + ... = Iₙ',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'V', meaning: 'Potential difference', unit: 'V (Volt)', typical_values: '1-12V in typical circuits' },
          { symbol: 'ε', meaning: 'EMF of cell', unit: 'V', typical_values: '1.5V (dry cell), 2V (lead-acid)' },
          { symbol: 'IR', meaning: 'Voltage drop across resistor', unit: 'V', typical_values: 'Depends on circuit' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Single loop circuit', latex: '\\varepsilon - IR_1 - IR_2 = 0', context: 'EMF equals sum of voltage drops', neet_frequency: 'high' },
          { name: 'Two cell circuit', latex: '\\varepsilon_1 - \\varepsilon_2 = I(R_1 + R_2 + r_1 + r_2)', context: 'Cells in series with internal resistance', neet_frequency: 'medium' },
        ],
        specialCases: [
          'For ideal cell (no internal resistance): ε = IR',
          'For real cell: ε = IR + Ir (where r is internal resistance)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'R_eq', meaning: 'Equivalent resistance', unit: 'Ω (Ohm)', typical_values: 'Sum of individual resistances' },
          { symbol: 'R₁, R₂...', meaning: 'Individual resistances', unit: 'Ω', typical_values: '1Ω to MΩ range' },
        ],
        derivedFrom: 'kvl',
        applications: [
          { name: 'Two resistors in series', latex: 'R_{eq} = R_1 + R_2', context: 'Simplest series combination', neet_frequency: 'high' },
          { name: 'n identical resistors', latex: 'R_{eq} = nR', context: 'When all resistors have same value R', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Current is same through all resistors: I₁ = I₂ = I₃ = I',
      ...
      },
      {
        ...
        variables: [
          { symbol: 'R_eq', meaning: 'Equivalent resistance', unit: 'Ω', typical_values: 'Less than smallest R' },
          { symbol: 'R₁, R₂...', meaning: 'Individual resistances', unit: 'Ω', typical_values: '1Ω to MΩ' },
        ],
        derivedFrom: 'kcl',
        applications: [
          { name: 'Two resistors in parallel', latex: 'R_{eq} = \\frac{R_1 R_2}{R_1 + R_2}', context: 'Product over sum formula', neet_frequency: 'high' },
          { name: 'n identical resistors', latex: 'R_{eq} = \\frac{R}{n}', context: 'When all resistors have same value R', neet_frequency: 'high' },
        ],
        specialCases: [
          'Voltage is same across all resistors: V₁ = V₂ = V₃ = V',
          'Current divides: I₁/I₂ = R₂/R₁ (inversely proportional)',
      ...
      },
      {
        ...
        variables: [
          { symbol: 'V', meaning: 'Potential difference', unit: 'V (Volt)', typical_values: '1-220V' },
          { symbol: 'I', meaning: 'Electric current', unit: 'A (Ampere)', typical_values: 'mA to A' },
          { symbol: 'R', meaning: 'Resistance', unit: 'Ω (Ohm)', typical_values: '1Ω to MΩ' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Current calculation', latex: 'I = \\frac{V}{R}', context: 'Finding current when V and R are known', neet_frequency: 'high' },
          { name: 'Resistance calculation', latex: 'R = \\frac{V}{I}', context: 'Finding resistance from V-I data', neet_frequency: 'high' },
          { name: 'Power forms', latex: 'P = I^2R = \\frac{V^2}{R} = VI', context: 'Power dissipation in resistor', neet_frequency: 'high' },
        ],
        specialCases: [
          'Valid only for ohmic conductors at constant temperature',
          'Not valid for semiconductors, electrolytes, discharge tubes',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'V', meaning: 'Terminal voltage', unit: 'V', typical_values: 'Less than EMF' },
          { symbol: 'ε', meaning: 'EMF of cell', unit: 'V', typical_values: '1.5V, 2V, 9V typical' },
          { symbol: 'I', meaning: 'Current drawn', unit: 'A', typical_values: 'mA to A' },
          { symbol: 'r', meaning: 'Internal resistance', unit: 'Ω', typical_values: '0.1Ω to few Ω' },
        ],
        derivedFrom: 'kvl',
        applications: [
          { name: 'Current from cell', latex: 'I = \\frac{\\varepsilon}{R + r}', context: 'Total current in circuit with external R', neet_frequency: 'high' },
          { name: 'Maximum current', latex: 'I_{max} = \\frac{\\varepsilon}{r}', context: 'When external resistance is zero (short circuit)', neet_frequency: 'medium' },
          { name: 'Open circuit', latex: 'V = \\varepsilon', context: 'When no current flows, terminal voltage equals EMF', neet_frequency: 'medium' },
        ],
        specialCases: [
          'For ideal cell: r = 0, so V = ε always',
      ...
      },
      {
        ...
        variables: [
          { symbol: 'ε_eq', meaning: 'Equivalent EMF', unit: 'V', typical_values: 'Sum of individual EMFs' },
          { symbol: 'r_eq', meaning: 'Equivalent internal resistance', unit: 'Ω', typical_values: 'Sum of individual r' },
        ],
        derivedFrom: 'kvl',
        applications: [
          { name: 'n identical cells in series', latex: '\\varepsilon_{eq} = n\\varepsilon, \\quad r_{eq} = nr', context: 'All cells same EMF and internal resistance', neet_frequency: 'high' },
          { name: 'Current with external R', latex: 'I = \\frac{n\\varepsilon}{R + nr}', context: 'n identical cells with external resistance R', neet_frequency: 'high' },
        ],
        specialCases: [
          'Cells must be connected correctly (+ to -)',
          'If one cell is reversed: ε_eq = ε₁ - ε₂ (for 2 cells)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'ε_eq', meaning: 'Equivalent EMF', unit: 'V', typical_values: 'Same as single cell EMF' },
          { symbol: 'r_eq', meaning: 'Equivalent internal resistance', unit: 'Ω', typical_values: 'r/n for n identical cells' },
        ],
        derivedFrom: 'kcl',
        applications: [
          { name: 'n identical cells in parallel', latex: '\\varepsilon_{eq} = \\varepsilon, \\quad r_{eq} = \\frac{r}{n}', context: 'Same EMF, reduced internal resistance', neet_frequency: 'high' },
          { name: 'Current with external R', latex: 'I = \\frac{\\varepsilon}{R + r/n}', context: 'n identical cells parallel with external R', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Only works for identical cells',
          'Used when internal resistance is high compared to external R',
        ],
        dimensionalCheck: '[ε] = V, [r] = Ω',
      },
    ],
    ...
    variations: [
      { type: 'numerical', description: 'Finding equivalent resistance in series-parallel combinations', difficulty: 'medium' },
      { type: 'numerical', description: 'Multi-loop circuits using Kirchhoff\'s laws', difficulty: 'hard' },
      { type: 'conceptual', description: 'Maximum power transfer theorem applications', difficulty: 'hard' },
      { type: 'graphical', description: 'V-I characteristic interpretation for cells', difficulty: 'medium' },
      { type: 'application', description: 'Calculating current distribution in parallel branches', difficulty: 'medium' },
      { type: 'numerical', description: 'Mixed grouping of cells (series-parallel)', difficulty: 'hard' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Find equivalent resistance in series-parallel network', frequency: 'high', yearAsked: [2019, 2020, 2021, 2022, 2023] },
      { pattern: 'Current through specific resistor using Kirchhoff\'s laws', frequency: 'high', yearAsked: [2018, 2019, 2021, 2023] },
      { pattern: 'Terminal voltage vs EMF problems', frequency: 'medium', yearAsked: [2018, 2020, 2022] },
      { pattern: 'Cells in series/parallel - find current', frequency: 'high', yearAsked: [2017, 2019, 2020, 2021] },
      { pattern: 'Power dissipated in resistor', frequency: 'medium', yearAsked: [2018, 2019, 2022] },
    ],
    ...
    questions: [], // Questions handled separately
  },

  // Topic 2: Wheatstone Bridge and Symmetric Circuits
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'P, Q', meaning: 'Resistances in ratio arms', unit: 'Ω', typical_values: '1Ω to 1000Ω' },
          { symbol: 'R', meaning: 'Known standard resistance', unit: 'Ω', typical_values: 'Standard resistance box' },
          { symbol: 'S', meaning: 'Unknown resistance', unit: 'Ω', typical_values: 'To be determined' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Finding unknown resistance', latex: 'S = \\frac{Q \\cdot R}{P}', context: 'When P, Q, R are known and bridge is balanced', neet_frequency: 'high' },
          { name: 'Cross multiplication form', latex: 'PS = QR', context: 'Product of opposite arms are equal', neet_frequency: 'high' },
        ],
        specialCases: [
          'If P = Q, then R = S (equal ratio arms)',
          'Galvanometer can be replaced by any detector at balance',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'S', meaning: 'Unknown resistance', unit: 'Ω', typical_values: 'To be determined' },
          { symbol: 'R', meaning: 'Known resistance', unit: 'Ω', typical_values: 'From resistance box' },
          { symbol: 'l', meaning: 'Balance length from R side', unit: 'cm', typical_values: '30-70 cm ideal' },
          { symbol: '100-l', meaning: 'Remaining length', unit: 'cm', typical_values: 'Complementary length' },
        ],
        derivedFrom: 'wheatstone-balance',
        applications: [
          { name: 'Direct calculation', latex: 'S = R \\times \\frac{100-l}{l}', context: 'Finding unknown from balance point', neet_frequency: 'high' },
          { name: 'Ratio form', latex: '\\frac{R}{S} = \\frac{l}{100-l}', context: 'Ratio equals length ratio', neet_frequency: 'high' },
        ],
        specialCases: [
          'For l = 50 cm: R = S (equal resistances)',
          'End corrections may be needed for accurate measurements',
          'Best accuracy when l is around 50 cm',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'I_G', meaning: 'Galvanometer current', unit: 'A', typical_values: 'μA to mA' },
          { symbol: 'G', meaning: 'Galvanometer resistance', unit: 'Ω', typical_values: '10-1000Ω' },
          { symbol: 'E', meaning: 'EMF of cell', unit: 'V', typical_values: '1-10V' },
        ],
        derivedFrom: 'kvl',
        applications: [
          { name: 'Check balance', latex: 'I_G = 0 \\Rightarrow PS = QR', context: 'At balance, numerator becomes zero', neet_frequency: 'low' },
        ],
        specialCases: [
          'Usually problems involve balanced bridge only',
          'For unbalanced, apply KVL to each loop',
        ],
        dimensionalCheck: '[I] = A',
      },
      {
        ...
        variables: [
          { symbol: 'V_A, V_B', meaning: 'Potentials at symmetric points', unit: 'V', typical_values: 'Equal by symmetry' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Cube resistance (face diagonal)', latex: 'R_{eq} = \\frac{3R}{4}', context: 'Between adjacent corners of resistor cube', neet_frequency: 'medium' },
          { name: 'Cube resistance (body diagonal)', latex: 'R_{eq} = \\frac{5R}{6}', context: 'Between opposite corners of resistor cube', neet_frequency: 'medium' },
          { name: 'Cube resistance (edge)', latex: 'R_{eq} = \\frac{7R}{12}', context: 'Between corners of same edge', neet_frequency: 'low' },
        ],
        specialCases: [
          'Look for mirror symmetry about input-output axis',
          'Equal resistors from same node to symmetric points are in parallel',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Find unknown resistance using Wheatstone bridge', difficulty: 'easy' },
      { type: 'numerical', description: 'Meter bridge null point problems', difficulty: 'medium' },
      { type: 'numerical', description: 'Equivalent resistance of balanced bridge', difficulty: 'medium' },
      { type: 'application', description: 'Cube or complex symmetric network resistance', difficulty: 'hard' },
      { type: 'conceptual', description: 'Effect of interchanging resistances on balance', difficulty: 'medium' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Meter bridge null point calculation', frequency: 'high', yearAsked: [2018, 2019, 2020, 2021, 2022] },
      { pattern: 'Find unknown using balance condition', frequency: 'high', yearAsked: [2017, 2019, 2021, 2023] },
      { pattern: 'Equivalent resistance of balanced bridge', frequency: 'medium', yearAsked: [2018, 2020, 2022] },
      { pattern: 'Symmetric circuit (cube) problems', frequency: 'low', yearAsked: [2019, 2022] },
    ],
  ...
  // Topic 3: Electrical Measuring Instruments
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'V', meaning: 'Potential drop', unit: 'V', typical_values: '0 to E' },
          { symbol: 'φ', meaning: 'Potential gradient', unit: 'V/m', typical_values: 'E/L' },
          { symbol: 'l', meaning: 'Length of wire', unit: 'm', typical_values: '0 to L' },
          { symbol: 'E', meaning: 'EMF of driver cell', unit: 'V', typical_values: '2-10V' },
          { symbol: 'L', meaning: 'Total length of wire', unit: 'm', typical_values: '1-10m' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Potential gradient', latex: '\\phi = \\frac{E}{L + \\frac{Rr}{R+r}}', context: 'When rheostat R is in circuit', neet_frequency: 'medium' },
          { name: 'Balance length', latex: '\\varepsilon = \\phi \\times l', context: 'EMF of cell equals potential drop at balance', neet_frequency: 'high' },
        ],
        specialCases: [
          'Wire must be uniform (constant cross-section and material)',
          'Driver cell EMF must be greater than EMF being measured',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'ε₁, ε₂', meaning: 'EMFs of cells', unit: 'V', typical_values: '1-3V typical' },
          { symbol: 'l₁, l₂', meaning: 'Balancing lengths', unit: 'cm', typical_values: '20-100 cm' },
        ],
        derivedFrom: 'potentiometer-principle',
        applications: [
          { name: 'Find unknown EMF', latex: '\\varepsilon_2 = \\varepsilon_1 \\times \\frac{l_2}{l_1}', context: 'When one EMF is known', neet_frequency: 'high' },
        ],
        specialCases: [
          'Same potential gradient for both measurements',
          'No current drawn from cells being compared',
        ],
        dimensionalCheck: 'Dimensionless ratio on both sides',
      },
      {
        ...
        variables: [
          { symbol: 'r', meaning: 'Internal resistance of cell', unit: 'Ω', typical_values: '0.1-5Ω' },
          { symbol: 'R', meaning: 'External resistance', unit: 'Ω', typical_values: '1-100Ω' },
          { symbol: 'l₁', meaning: 'Balance length (open circuit)', unit: 'cm', typical_values: 'For EMF' },
          { symbol: 'l₂', meaning: 'Balance length (closed circuit)', unit: 'cm', typical_values: 'For terminal voltage' },
        ],
        derivedFrom: 'potentiometer-principle',
        applications: [
          { name: 'Direct formula', latex: 'r = R\\left(\\frac{l_1}{l_2} - 1\\right)', context: 'Alternative form', neet_frequency: 'high' },
        ],
        specialCases: [
          'l₁ > l₂ always (EMF > terminal voltage)',
          'l₁ corresponds to EMF, l₂ to terminal voltage V = ε - Ir',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'S', meaning: 'Shunt resistance', unit: 'Ω', typical_values: 'Very small, mΩ to Ω' },
          { symbol: 'G', meaning: 'Galvanometer resistance', unit: 'Ω', typical_values: '10-1000Ω' },
          { symbol: 'I_g', meaning: 'Full scale deflection current', unit: 'A', typical_values: 'μA to mA' },
          { symbol: 'I', meaning: 'Desired ammeter range', unit: 'A', typical_values: '1-10A typical' },
        ],
        derivedFrom: 'kcl',
        applications: [
          { name: 'Multiplication factor', latex: 'n = \\frac{I}{I_g} = 1 + \\frac{G}{S}', context: 'Range extension factor', neet_frequency: 'high' },
          { name: 'Shunt from n', latex: 'S = \\frac{G}{n-1}', context: 'When n is given', neet_frequency: 'high' },
        ],
        specialCases: [
          'S << G for good ammeter',
          'Most current bypasses through shunt',
          'Effective resistance = SG/(S+G) ≈ S',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'R', meaning: 'Multiplier resistance', unit: 'Ω', typical_values: 'kΩ to MΩ' },
          { symbol: 'V', meaning: 'Desired voltmeter range', unit: 'V', typical_values: '1-300V' },
          { symbol: 'I_g', meaning: 'Full scale deflection current', unit: 'A', typical_values: 'μA to mA' },
          { symbol: 'G', meaning: 'Galvanometer resistance', unit: 'Ω', typical_values: '10-1000Ω' },
        ],
        derivedFrom: 'ohms-law',
        applications: [
          { name: 'Multiplication factor', latex: 'n = \\frac{V}{I_g \\cdot G} = 1 + \\frac{R}{G}', context: 'Voltage range extension factor', neet_frequency: 'medium' },
          { name: 'Total resistance', latex: 'R_{total} = R + G = \\frac{V}{I_g}', context: 'Voltmeter resistance', neet_frequency: 'high' },
        ],
        specialCases: [
          'R >> G for good voltmeter',
          'Voltmeter resistance should be very high',
          'Draws minimum current from circuit',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Calculate shunt resistance for ammeter conversion', difficulty: 'easy' },
      { type: 'numerical', description: 'Calculate multiplier for voltmeter conversion', difficulty: 'easy' },
      { type: 'numerical', description: 'Compare EMFs using potentiometer', difficulty: 'medium' },
      { type: 'numerical', description: 'Find internal resistance using potentiometer', difficulty: 'medium' },
      { type: 'conceptual', description: 'Why potentiometer is better than voltmeter for EMF measurement', difficulty: 'easy' },
      { type: 'application', description: 'Effect of non-ideal meters on circuit readings', difficulty: 'hard' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Shunt calculation for ammeter', frequency: 'high', yearAsked: [2018, 2019, 2020, 2022, 2023] },
      { pattern: 'Multiplier calculation for voltmeter', frequency: 'high', yearAsked: [2017, 2019, 2021, 2023] },
      { pattern: 'EMF comparison by potentiometer', frequency: 'medium', yearAsked: [2018, 2020, 2022] },
      { pattern: 'Internal resistance by potentiometer', frequency: 'medium', yearAsked: [2019, 2021, 2023] },
    ],
  ...
  // Topic 4: RC Circuit
  {
    ...
    formulas: [
      {
        ...
        variables: [
          { symbol: 'τ', meaning: 'Time constant', unit: 's', typical_values: 'ms to s for typical circuits' },
          { symbol: 'R', meaning: 'Resistance', unit: 'Ω', typical_values: 'kΩ to MΩ' },
          { symbol: 'C', meaning: 'Capacitance', unit: 'F', typical_values: 'μF to mF' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'Physical meaning', latex: '\\tau = \\text{time to reach } 63.2\\% \\text{ of final value}', context: 'During charging', neet_frequency: 'high' },
          { name: 'During discharge', latex: '\\tau = \\text{time for } 36.8\\% \\text{ to remain}', context: 'Charge drops to 1/e of initial', neet_frequency: 'medium' },
        ],
        specialCases: [
          'After t = τ: charge = 0.632 × final charge',
          'After t = 5τ: charge ≈ 0.993 × final charge (practically full)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'q', meaning: 'Instantaneous charge', unit: 'C', typical_values: 'μC to mC' },
          { symbol: 'q₀', meaning: 'Final charge = CE', unit: 'C', typical_values: 'CE' },
          { symbol: 't', meaning: 'Time elapsed', unit: 's', typical_values: '0 to several τ' },
          { symbol: 'E', meaning: 'EMF of source', unit: 'V', typical_values: '1-12V' },
        ],
        derivedFrom: 'kvl',
        applications: [
          { name: 'At t = τ', latex: 'q = CE(1 - e^{-1}) = 0.632 \\times CE', context: '63.2% charged after one time constant', neet_frequency: 'high' },
          { name: 'At t = 2τ', latex: 'q = CE(1 - e^{-2}) = 0.865 \\times CE', context: '86.5% charged after 2τ', neet_frequency: 'medium' },
        ],
        specialCases: [
          'At t = 0: q = 0 (capacitor uncharged)',
          'At t → ∞: q = CE (fully charged)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'i', meaning: 'Instantaneous current', unit: 'A', typical_values: 'mA' },
          { symbol: 'I₀', meaning: 'Initial current = E/R', unit: 'A', typical_values: 'E/R' },
          { symbol: 't', meaning: 'Time elapsed', unit: 's', typical_values: '0 to several τ' },
        ],
        derivedFrom: 'kvl',
        applications: [
          { name: 'At t = τ', latex: 'i = I_0 e^{-1} = 0.368 \\times I_0', context: 'Current drops to 36.8% after τ', neet_frequency: 'high' },
          { name: 'Initial current', latex: 'i_0 = \\frac{E}{R}', context: 'At t=0, capacitor acts as short circuit', neet_frequency: 'high' },
        ],
        specialCases: [
          'At t = 0: i = E/R (maximum)',
          'At t → ∞: i = 0 (no current, fully charged)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'V_C', meaning: 'Voltage across capacitor', unit: 'V', typical_values: '0 to E' },
          { symbol: 'E', meaning: 'EMF of source', unit: 'V', typical_values: '1-12V' },
        ],
        derivedFrom: 'charging-charge',
        applications: [
          { name: 'At t = τ', latex: 'V_C = 0.632E', context: '63.2% of final voltage', neet_frequency: 'high' },
          { name: 'Voltage across R', latex: 'V_R = E \\cdot e^{-t/RC}', context: 'Drops exponentially from E to 0', neet_frequency: 'medium' },
        ],
        specialCases: [
          'At t = 0: V_C = 0, V_R = E',
          'At t → ∞: V_C = E, V_R = 0',
          'At any time: V_R + V_C = E (KVL)',
        ],
      ...
      },
      {
        ...
        variables: [
          { symbol: 'q', meaning: 'Instantaneous charge', unit: 'C', typical_values: 'Decreasing' },
          { symbol: 'q₀', meaning: 'Initial charge', unit: 'C', typical_values: 'CE if fully charged' },
        ],
        derivedFrom: 'kvl',
        applications: [
          { name: 'At t = τ', latex: 'q = q_0 e^{-1} = 0.368 q_0', context: '36.8% of initial charge remains', neet_frequency: 'high' },
          { name: 'Half-life', latex: 't_{1/2} = \\tau \\ln 2 = 0.693 RC', context: 'Time for charge to halve', neet_frequency: 'medium' },
        ],
        specialCases: [
          'At t = 0: q = q₀ (fully charged)',
      ...
      },
      {
        ...
        variables: [
          { symbol: 'i', meaning: 'Discharge current', unit: 'A', typical_values: 'Opposite to charging' },
          { symbol: 'I₀', meaning: 'Initial discharge current = q₀/RC', unit: 'A', typical_values: 'V₀/R' },
        ],
        derivedFrom: 'kvl',
        applications: [
          { name: 'Magnitude at t = τ', latex: '|i| = I_0 e^{-1} = 0.368 I_0', context: 'Current magnitude at τ', neet_frequency: 'medium' },
        ],
        specialCases: [
          'Negative sign indicates opposite direction to charging',
          'Magnitude same formula as charging current',
        ],
        dimensionalCheck: '[i] = A',
      },
      {
        ...
        variables: [
          { symbol: 'U', meaning: 'Stored energy', unit: 'J (Joule)', typical_values: 'μJ to mJ' },
          { symbol: 'C', meaning: 'Capacitance', unit: 'F', typical_values: 'μF to mF' },
          { symbol: 'V', meaning: 'Voltage across capacitor', unit: 'V', typical_values: '1-100V' },
          { symbol: 'q', meaning: 'Charge on capacitor', unit: 'C', typical_values: 'μC to mC' },
        ],
        derivedFrom: null,
        applications: [
          { name: 'During charging', latex: 'U = \\frac{1}{2}CE^2\\left(1-e^{-t/RC}\\right)^2', context: 'Energy as function of time', neet_frequency: 'medium' },
          { name: 'Energy dissipated in R', latex: 'E_{dissipated} = \\frac{1}{2}CE^2', context: 'Half of supplied energy is lost in R during charging', neet_frequency: 'high' },
        ],
        specialCases: [
          'When fully charged from EMF E: U = ½CE²',
          'Energy supplied by source = CE², half goes to capacitor, half to resistor',
        ],
    ...
    variations: [
      { type: 'numerical', description: 'Find charge/current at given time during charging', difficulty: 'medium' },
      { type: 'numerical', description: 'Time constant and time for specific percentage charge', difficulty: 'medium' },
      { type: 'graphical', description: 'Sketch charge/current vs time graphs', difficulty: 'easy' },
      { type: 'numerical', description: 'Energy stored and dissipated in RC circuit', difficulty: 'hard' },
      { type: 'conceptual', description: 'Initial and final behavior of capacitor in circuit', difficulty: 'easy' },
      { type: 'numerical', description: 'Discharging problems with initial conditions', difficulty: 'hard' },
    ],
    
    mostAskedPatterns: [
      { pattern: 'Time constant calculation and meaning', frequency: 'high', yearAsked: [2018, 2019, 2021, 2022] },
      { pattern: 'Charge at specific time during charging/discharging', frequency: 'high', yearAsked: [2019, 2020, 2022, 2023] },
      { pattern: 'Initial current when switch closes', frequency: 'medium', yearAsked: [2018, 2020, 2021] },
      { pattern: 'Energy stored and energy dissipated', frequency: 'medium', yearAsked: [2019, 2021, 2023] },
    ],
